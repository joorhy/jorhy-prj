...
DLLAPI struct json_tokener* json_tokener_new()
{
...
DLLAPI void json_tokener_free(struct json_tokener *tok)
{
  json_tokener_reset(tok);
...
DLLAPI void json_tokener_reset(struct json_tokener *tok)
{
  int i;
...
DLLAPI struct json_object* json_tokener_parse(char *str)
{
...
DLLAPI struct json_object* json_tokener_parse_ex(struct json_tokener *tok,
					  char *str, int len)
{
