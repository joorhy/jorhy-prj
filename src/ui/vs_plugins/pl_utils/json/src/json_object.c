...
/*extern */DLLAPI struct json_object* json_object_get(struct json_object *this)
{
  if(this) {
    this->_ref_count++;
  }
...
/*extern*/ DLLAPI void json_object_put(struct json_object *this)
{
  if(this) {
    this->_ref_count--;
...
DLLAPI int json_object_is_type(struct json_object *this, enum json_type type)
{
  return (this->o_type == type);
}

DLLAPI enum json_type json_object_get_type(struct json_object *this)
{
  return this->o_type;
}
...
DLLAPI char* json_object_to_json_string(struct json_object *this)
{
  if(!this) return "null";
  if(!this->_pb) {
...
DLLAPI struct json_object* json_object_new_object()
{
...
DLLAPI struct lh_table* json_object_get_object(struct json_object *this)
{
  if(!this) return NULL;
  switch(this->o_type) {
...
DLLAPI void json_object_object_add(struct json_object* this, char *key,
...
DLLAPI struct json_object* json_object_object_get(struct json_object* this, char *key)
{
  return (struct json_object*) lh_table_lookup(this->o.c_object, key);
}

DLLAPI void json_object_object_del(struct json_object* this, char *key)
{
  lh_table_delete(this->o.c_object, key);
}
...
DLLAPI struct json_object* json_object_new_boolean(boolean b)
{
...
DLLAPI boolean json_object_get_boolean(struct json_object *this)
{
...
DLLAPI struct json_object* json_object_new_int(int i)
{
...
DLLAPI int json_object_get_int(struct json_object *this)
{
  int cint;
...
DLLAPI struct json_object* json_object_new_double(double d)
{
...
DLLAPI double json_object_get_double(struct json_object *this)
{
  double cdouble;
...
DLLAPI struct json_object* json_object_new_string(char *s)
{
...
DLLAPI struct json_object* json_object_new_string_len(char *s, int len)
{
  struct json_object *this = json_object_new(json_type_string);
  if(!this) return NULL;
  this->_delete = &json_object_string_delete;
...
DLLAPI char* json_object_get_string(struct json_object *this)
{
  if(!this) return NULL;
  switch(this->o_type) {
  case json_type_string:
...
DLLAPI struct json_object* json_object_new_array()
{
...
DLLAPI struct array_list* json_object_get_array(struct json_object *this)
{
  if(!this) return NULL;
  switch(this->o_type) {
...
DLLAPI int json_object_array_length(struct json_object *this)
{
  return array_list_length(this->o.c_array);
}

DLLAPI int json_object_array_add(struct json_object *this,struct json_object *val)
{
  return array_list_add(this->o.c_array, val);
}

DLLAPI int json_object_array_put_idx(struct json_object *this, int idx,
			      struct json_object *val)
{
  return array_list_put_idx(this->o.c_array, idx, val);
}

DLLAPI struct json_object* json_object_array_get_idx(struct json_object *this,
					      int idx)
{
