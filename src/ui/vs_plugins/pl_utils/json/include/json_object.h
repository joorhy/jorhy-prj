 ...
 */
/*extern */DLLAPI struct json_object* json_object_new_boolean(boolean b);
 ...
 * @returns a boolean
 */
/*extern */DLLAPI boolean json_object_get_boolean(struct json_object *obj);
