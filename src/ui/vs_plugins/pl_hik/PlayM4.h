...
#define  PLAYM4_DECODE_KEYFRAME_ERROR  30   //add by hy 200903018
...
//add by wp 090512
//创建缓冲；
PLAYM4_API BYTE*  __stdcall PlayM4_InitLastKeyBuf(LONG nPort,DWORD nBufSize);
//释放缓冲
PLAYM4_API BOOL  __stdcall PlayM4_ReleaseLastKeyBuf(LONG nPort);
//得到有效数据长
PLAYM4_API DWORD  __stdcall PlayM4_GetLastKeyDataSize(LONG nPort);

PLAYM4_API DWORD  __stdcall PlayM4_LockLastKeyBuf(LONG nPort,DWORD nTimeOut);
//解锁
PLAYM4_API DWORD  __stdcall PlayM4_UnlockLastKeyBuf(LONG nPort);
