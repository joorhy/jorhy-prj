...
#define TMCC_INITTYPE_VIDEORENDER			0x07//初始化为视频显示SDK
#define TMCC_INITTYPE_VOICERENDER			0x08//初始化为语音对讲数据解码SDK
#define TMCC_INITTYPE_LISTENDEVICE			0x09//初始化为主动监听设备上传SDK
