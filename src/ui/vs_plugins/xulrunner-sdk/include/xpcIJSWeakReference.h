/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/js/xpconnect/idl/xpcIJSWeakReference.idl
 */
...
class NS_NO_VTABLE xpcIJSWeakReference : public nsISupports {
 public: 
  ...
  NS_IMETHOD Get(JSContext* cx, JS::Value *_retval) = 0;
...
#define NS_DECL_XPCIJSWEAKREFERENCE \
  NS_IMETHOD Get(JSContext* cx, JS::Value *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_XPCIJSWEAKREFERENCE(_to) \
  NS_IMETHOD Get(JSContext* cx, JS::Value *_retval) { return _to Get(cx, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_XPCIJSWEAKREFERENCE(_to) \
  NS_IMETHOD Get(JSContext* cx, JS::Value *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(cx, _retval); } 
...
/* [implicit_jscontext] jsval get (); */
NS_IMETHODIMP _MYCLASS_::Get(JSContext* cx, JS::Value *_retval)
{
