/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMWindowCollection.idl
 */
...
class NS_NO_VTABLE nsIDOMWindowCollection : public nsISupports {
 public: 
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval) = 0;
...
#define NS_DECL_NSIDOMWINDOWCOLLECTION \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval); \
...
#define NS_FORWARD_NSIDOMWINDOWCOLLECTION(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval) { return _to Item(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWCOLLECTION(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMWindow * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } \
...
/* nsIDOMWindow item (in unsigned long index); */
NS_IMETHODIMP nsDOMWindowCollection::Item(uint32_t index, nsIDOMWindow * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
