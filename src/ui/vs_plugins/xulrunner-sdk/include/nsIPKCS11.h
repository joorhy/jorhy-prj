/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsIPKCS11.idl
 */
...
#define NS_DECL_NSIPKCS11 \
  NS_IMETHOD DeleteModule(const nsAString & moduleName); \
  NS_IMETHOD AddModule(const nsAString & moduleName, const nsAString & libraryFullPath, int32_t cryptoMechanismFlags, int32_t cipherFlags); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPKCS11(_to) \
  NS_IMETHOD DeleteModule(const nsAString & moduleName) { return _to DeleteModule(moduleName); } \
  NS_IMETHOD AddModule(const nsAString & moduleName, const nsAString & libraryFullPath, int32_t cryptoMechanismFlags, int32_t cipherFlags) { return _to AddModule(moduleName, libraryFullPath, cryptoMechanismFlags, cipherFlags); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPKCS11(_to) \
  NS_IMETHOD DeleteModule(const nsAString & moduleName) { return !_to ? NS_ERROR_NULL_POINTER : _to->DeleteModule(moduleName); } \
  NS_IMETHOD AddModule(const nsAString & moduleName, const nsAString & libraryFullPath, int32_t cryptoMechanismFlags, int32_t cipherFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddModule(moduleName, libraryFullPath, cryptoMechanismFlags, cipherFlags); } 
