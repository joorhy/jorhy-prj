/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/oji/public/nsIJVMConfigManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJVMConfigManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJVMConfigList(nsIArray **_retval) = 0;
...
#define NS_DECL_NSIJVMCONFIGMANAGER \
  NS_SCRIPTABLE NS_IMETHOD GetJVMConfigList(nsIArray **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetCurrentJVMConfig(nsIJVMConfig *jvmConfig); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJVMCONFIGMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetJVMConfigList(nsIArray **_retval) { return _to GetJVMConfigList(_retval); } \
...
#define NS_FORWARD_SAFE_NSIJVMCONFIGMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetJVMConfigList(nsIArray **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJVMConfigList(_retval); } \
...
/* nsIArray getJVMConfigList (); */
NS_IMETHODIMP nsJVMConfigManager::GetJVMConfigList(nsIArray **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
