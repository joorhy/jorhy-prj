/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/oji/public/nsIJVMAuthTools.idl
 */
...
class NS_NO_VTABLE nsIJVMAuthTools : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetAuthenticationInfo(const char *protocol, const char *host, PRInt32 port, const char *scheme, const char *realm, nsIAuthenticationInfo **_retval) = 0;
...
#define NS_DECL_NSIJVMAUTHTOOLS \
  NS_IMETHOD GetAuthenticationInfo(const char *protocol, const char *host, PRInt32 port, const char *scheme, const char *realm, nsIAuthenticationInfo **_retval); \
...
#define NS_FORWARD_NSIJVMAUTHTOOLS(_to) \
  NS_IMETHOD GetAuthenticationInfo(const char *protocol, const char *host, PRInt32 port, const char *scheme, const char *realm, nsIAuthenticationInfo **_retval) { return _to GetAuthenticationInfo(protocol, host, port, scheme, realm, _retval); } \
...
#define NS_FORWARD_SAFE_NSIJVMAUTHTOOLS(_to) \
  NS_IMETHOD GetAuthenticationInfo(const char *protocol, const char *host, PRInt32 port, const char *scheme, const char *realm, nsIAuthenticationInfo **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAuthenticationInfo(protocol, host, port, scheme, realm, _retval); } \
...
/* nsIAuthenticationInfo GetAuthenticationInfo (in string protocol, in string host, in PRInt32 port, in string scheme, in string realm); */
NS_IMETHODIMP nsJVMAuthTools::GetAuthenticationInfo(const char *protocol, const char *host, PRInt32 port, const char *scheme, const char *realm, nsIAuthenticationInfo **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
