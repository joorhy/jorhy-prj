/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/oji/public/nsIJVMPluginInstance.idl
 */
...
#define NS_FORWARD_SAFE_NSIJVMPLUGININSTANCE(_to) \
  NS_IMETHOD GetJavaObject(jobject *result) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJavaObject(result); } \
...
/* [noscript] void GetJavaObject (out jobject result); */
NS_IMETHODIMP nsJVMPluginInstance::GetJavaObject(jobject *result)
{
