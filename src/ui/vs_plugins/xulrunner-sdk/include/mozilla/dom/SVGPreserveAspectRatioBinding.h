...
#ifndef mozilla_dom_SVGPreserveAspectRatioBinding_h__
#define mozilla_dom_SVGPreserveAspectRatioBinding_h__
...
template <>
struct PrototypeIDMap<mozilla::dom::DOMSVGPreserveAspectRatio>
{
  enum
  {
    PrototypeID = prototypes::id::SVGPreserveAspectRatio
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SVGPreserveAspectRatioBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SVGPreserveAspectRatio];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SVGPreserveAspectRatio];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SVGPreserveAspectRatio];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SVGPreserveAspectRatio];
    }
...
#endif // mozilla_dom_SVGPreserveAspectRatioBinding_h__
