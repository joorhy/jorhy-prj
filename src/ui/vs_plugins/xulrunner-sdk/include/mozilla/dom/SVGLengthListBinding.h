...
#ifndef mozilla_dom_SVGLengthListBinding_h__
#define mozilla_dom_SVGLengthListBinding_h__
...
struct PrototypeTraits<prototypes::id::SVGLengthList>
{
  ...
  typedef mozilla::DOMSVGLengthList NativeType;
};
template <>
struct PrototypeIDMap<mozilla::DOMSVGLengthList>
{
  enum
  {
    PrototypeID = prototypes::id::SVGLengthList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SVGLengthListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SVGLengthList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SVGLengthList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SVGLengthList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SVGLengthList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::DOMSVGLengthList* aObject, nsWrapperCache* aCache, bool* aTriedToWrap);
...
#endif // mozilla_dom_SVGLengthListBinding_h__
