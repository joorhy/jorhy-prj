...
#ifndef mozilla_dom_FormDataBinding_h__
#define mozilla_dom_FormDataBinding_h__
...
template <>
struct PrototypeIDMap<nsFormData>
{
  enum
  {
    PrototypeID = prototypes::id::FormData
  };
};
} // namespace dom
} // namespace mozilla
...
namespace FormDataBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::FormData];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::FormData];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::FormData];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::FormData];
    }
...
#endif // mozilla_dom_FormDataBinding_h__
