...
#ifndef mozilla_dom_SVGTransformListBinding_h__
#define mozilla_dom_SVGTransformListBinding_h__
...
struct PrototypeTraits<prototypes::id::SVGTransformList>
{
  ...
  typedef mozilla::DOMSVGTransformList NativeType;
};
template <>
struct PrototypeIDMap<mozilla::DOMSVGTransformList>
{
  enum
  {
    PrototypeID = prototypes::id::SVGTransformList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SVGTransformListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SVGTransformList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SVGTransformList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SVGTransformList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SVGTransformList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::DOMSVGTransformList* aObject, nsWrapperCache* aCache, bool* aTriedToWrap);
...
#endif // mozilla_dom_SVGTransformListBinding_h__
