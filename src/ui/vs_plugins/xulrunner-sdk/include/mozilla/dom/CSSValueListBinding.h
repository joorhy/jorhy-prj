...
#ifndef mozilla_dom_CSSValueListBinding_h__
#define mozilla_dom_CSSValueListBinding_h__
...
struct PrototypeTraits<prototypes::id::CSSValueList>
{
  ...
  typedef nsDOMCSSValueList NativeType;
};
template <>
struct PrototypeIDMap<nsDOMCSSValueList>
{
  enum
  {
    PrototypeID = prototypes::id::CSSValueList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace CSSValueListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::CSSValueList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::CSSValueList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::CSSValueList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::CSSValueList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, nsDOMCSSValueList* aObject, nsWrapperCache* aCache, bool* aTriedToWrap);
...
#endif // mozilla_dom_CSSValueListBinding_h__
