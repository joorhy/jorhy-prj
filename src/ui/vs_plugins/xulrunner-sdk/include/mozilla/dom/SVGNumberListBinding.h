...
#ifndef mozilla_dom_SVGNumberListBinding_h__
#define mozilla_dom_SVGNumberListBinding_h__
...
struct PrototypeTraits<prototypes::id::SVGNumberList>
{
  ...
  typedef mozilla::DOMSVGNumberList NativeType;
};
template <>
struct PrototypeIDMap<mozilla::DOMSVGNumberList>
{
  enum
  {
    PrototypeID = prototypes::id::SVGNumberList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SVGNumberListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SVGNumberList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SVGNumberList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SVGNumberList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SVGNumberList];
    }
...
#endif // mozilla_dom_SVGNumberListBinding_h__
