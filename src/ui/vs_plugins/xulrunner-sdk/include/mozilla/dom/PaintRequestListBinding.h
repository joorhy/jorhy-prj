...
#ifndef mozilla_dom_PaintRequestListBinding_h__
#define mozilla_dom_PaintRequestListBinding_h__
...
struct PrototypeTraits<prototypes::id::PaintRequestList>
{
  ...
  typedef nsPaintRequestList NativeType;
};
template <>
struct PrototypeIDMap<nsPaintRequestList>
{
  enum
  {
    PrototypeID = prototypes::id::PaintRequestList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace PaintRequestListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::PaintRequestList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::PaintRequestList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::PaintRequestList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::PaintRequestList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, nsPaintRequestList* aObject, nsWrapperCache* aCache, bool* aTriedToWrap);
...
#endif // mozilla_dom_PaintRequestListBinding_h__
