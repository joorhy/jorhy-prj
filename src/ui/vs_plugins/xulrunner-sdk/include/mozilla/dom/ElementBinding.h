...
#ifndef mozilla_dom_ElementBinding_h__
#define mozilla_dom_ElementBinding_h__
...
template <>
struct PrototypeIDMap<mozilla::dom::Element>
{
  enum
  {
    PrototypeID = prototypes::id::Element
  };
};
} // namespace dom
} // namespace mozilla
...
namespace ElementBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::Element];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::Element];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::Element];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::Element];
    }
...
#endif // mozilla_dom_ElementBinding_h__
