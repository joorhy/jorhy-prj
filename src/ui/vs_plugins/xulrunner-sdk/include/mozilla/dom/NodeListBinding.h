...
#ifndef mozilla_dom_NodeListBinding_h__
#define mozilla_dom_NodeListBinding_h__
...
struct PrototypeTraits<prototypes::id::NodeList>
{
  ...
  typedef nsINodeList NativeType;
};
template <>
struct PrototypeIDMap<nsINodeList>
{
  enum
  {
    PrototypeID = prototypes::id::NodeList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace NodeListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::NodeList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::NodeList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::NodeList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::NodeList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, nsINodeList* aObject, nsWrapperCache* aCache, bool* aTriedToWrap);
...
#endif // mozilla_dom_NodeListBinding_h__
