...
#ifndef mozilla_dom_FileListBinding_h__
#define mozilla_dom_FileListBinding_h__
...
struct PrototypeTraits<prototypes::id::FileList>
{
  ...
  typedef nsDOMFileList NativeType;
};
template <>
struct PrototypeIDMap<nsDOMFileList>
{
  enum
  {
    PrototypeID = prototypes::id::FileList
  };
};
} // namespace dom
} // namespace mozilla
...
#endif // mozilla_dom_FileListBinding_h__
