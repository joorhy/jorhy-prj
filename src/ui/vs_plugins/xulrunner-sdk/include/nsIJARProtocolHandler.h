/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/modules/libjar/nsIJARProtocolHandler.idl
 */
...
class NS_NO_VTABLE nsIJARProtocolHandler : public nsIProtocolHandler {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IJARPROTOCOLHANDLER_IID)

  /* readonly attribute nsIZipReaderCache JARCache; */
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache) = 0;
...
#define NS_DECL_NSIJARPROTOCOLHANDLER \
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJARPROTOCOLHANDLER(_to) \
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache) { return _to GetJARCache(aJARCache); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJARPROTOCOLHANDLER(_to) \
  NS_IMETHOD GetJARCache(nsIZipReaderCache * *aJARCache) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJARCache(aJARCache); } 
