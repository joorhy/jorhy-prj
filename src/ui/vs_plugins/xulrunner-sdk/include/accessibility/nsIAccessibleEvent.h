/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/accessible/public/nsIAccessibleEvent.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleStateChangeEvent : public nsIAccessibleEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(PRBool *_retval) = 0;

  /**
   * Returns true if the state is turned on.
   */
  /* boolean isEnabled (); */
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(PRBool *_retval) = 0;
...
#define NS_DECL_NSIACCESSIBLESTATECHANGEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(PRBool *_retval); 
...
#define NS_FORWARD_NSIACCESSIBLESTATECHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(PRBool *_retval) { return _to IsExtraState(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(PRBool *_retval) { return _to IsEnabled(_retval); } 
...
#define NS_FORWARD_SAFE_NSIACCESSIBLESTATECHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsExtraState(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsExtraState(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEnabled(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEnabled(_retval); } 
...
/* boolean isExtraState (); */
NS_IMETHODIMP nsAccessibleStateChangeEvent::IsExtraState(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isEnabled (); */
NS_IMETHODIMP nsAccessibleStateChangeEvent::IsEnabled(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleTextChangeEvent : public nsIAccessibleEvent {
 public: 
   ...
   */
  /* boolean isInserted (); */
  NS_SCRIPTABLE NS_IMETHOD IsInserted(PRBool *_retval) = 0;
...
#define NS_DECL_NSIACCESSIBLETEXTCHANGEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsInserted(PRBool *_retval); \
...
#define NS_FORWARD_NSIACCESSIBLETEXTCHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsInserted(PRBool *_retval) { return _to IsInserted(_retval); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLETEXTCHANGEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsInserted(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsInserted(_retval); } \
...
/* boolean isInserted (); */
NS_IMETHODIMP nsAccessibleTextChangeEvent::IsInserted(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
