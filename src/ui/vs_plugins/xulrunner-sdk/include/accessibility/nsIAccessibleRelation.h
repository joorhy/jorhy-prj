/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/accessible/public/nsIAccessibleRelation.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleRelation : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTarget(PRUint32 index, nsIAccessible **_retval) = 0;

  /**
   * Returns multiple accessible relation targets.
   */
  /* nsIArray getTargets (); */
  NS_SCRIPTABLE NS_IMETHOD GetTargets(nsIArray **_retval) = 0;
...
#define NS_DECL_NSIACCESSIBLERELATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTarget(PRUint32 index, nsIAccessible **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetTargets(nsIArray **_retval); 
...
#define NS_FORWARD_NSIACCESSIBLERELATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTarget(PRUint32 index, nsIAccessible **_retval) { return _to GetTarget(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTargets(nsIArray **_retval) { return _to GetTargets(_retval); } 
...
#define NS_FORWARD_SAFE_NSIACCESSIBLERELATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTarget(PRUint32 index, nsIAccessible **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTarget(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTargets(nsIArray **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTargets(_retval); } 
...
/* nsIAccessible getTarget (in unsigned long index); */
NS_IMETHODIMP nsAccessibleRelation::GetTarget(PRUint32 index, nsIAccessible **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
