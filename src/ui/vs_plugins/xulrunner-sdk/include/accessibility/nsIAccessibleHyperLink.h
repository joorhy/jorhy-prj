/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/accessible/public/nsIAccessibleHyperLink.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleHyperLink : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURI(PRInt32 index, nsIURI **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAnchor(PRInt32 index, nsIAccessible **_retval) = 0;
...
#define NS_DECL_NSIACCESSIBLEHYPERLINK \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURI(PRInt32 index, nsIURI **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetAnchor(PRInt32 index, nsIAccessible **_retval); 
...
#define NS_FORWARD_NSIACCESSIBLEHYPERLINK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURI(PRInt32 index, nsIURI **_retval) { return _to GetURI(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnchor(PRInt32 index, nsIAccessible **_retval) { return _to GetAnchor(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIACCESSIBLEHYPERLINK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURI(PRInt32 index, nsIURI **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURI(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnchor(PRInt32 index, nsIAccessible **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnchor(index, _retval); } 
...
/* nsIURI getURI (in long index); */
NS_IMETHODIMP nsAccessibleHyperLink::GetURI(PRInt32 index, nsIURI **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIAccessible getAnchor (in long index); */
NS_IMETHODIMP nsAccessibleHyperLink::GetAnchor(PRInt32 index, nsIAccessible **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
