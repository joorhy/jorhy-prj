/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/accessible/public/nsIAccessibleHyperText.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleHyperText : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkIndex(PRInt32 charIndex, PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLink(PRInt32 linkIndex, nsIAccessibleHyperLink **_retval) = 0;
...
#define NS_DECL_NSIACCESSIBLEHYPERTEXT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkIndex(PRInt32 charIndex, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetLink(PRInt32 linkIndex, nsIAccessibleHyperLink **_retval); 
...
#define NS_FORWARD_NSIACCESSIBLEHYPERTEXT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkIndex(PRInt32 charIndex, PRInt32 *_retval) { return _to GetLinkIndex(charIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLink(PRInt32 linkIndex, nsIAccessibleHyperLink **_retval) { return _to GetLink(linkIndex, _retval); } 
...
#define NS_FORWARD_SAFE_NSIACCESSIBLEHYPERTEXT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkIndex(PRInt32 charIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLinkIndex(charIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLink(PRInt32 linkIndex, nsIAccessibleHyperLink **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLink(linkIndex, _retval); } 
...
/* nsIAccessibleHyperLink getLink (in long linkIndex); */
NS_IMETHODIMP nsAccessibleHyperText::GetLink(PRInt32 linkIndex, nsIAccessibleHyperLink **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
