/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/accessible/public/msaa/nsIWinAccessNode.idl
 */
...
class NS_NO_VTABLE nsIWinAccessNode : public nsISupports {
 public: 
  ...
  NS_IMETHOD QueryNativeInterface(const IID & aIID, void * *_retval) = 0;
...
#define NS_DECL_NSIWINACCESSNODE \
  NS_IMETHOD QueryNativeInterface(const IID & aIID, void * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINACCESSNODE(_to) \
  NS_IMETHOD QueryNativeInterface(const IID & aIID, void * *_retval) { return _to QueryNativeInterface(aIID, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINACCESSNODE(_to) \
  NS_IMETHOD QueryNativeInterface(const IID & aIID, void * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryNativeInterface(aIID, _retval); } 
...
/* voidPtr queryNativeInterface ([const] in MSCOMIIDRef aIID); */
NS_IMETHODIMP nsWinAccessNode::QueryNativeInterface(const IID & aIID, void * *_retval)
{
