/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/geolocation/nsIDOMGeoPositionErrorCallback.idl
 */
...
#define NS_DECL_NSIDOMGEOPOSITIONERRORCALLBACK \
  NS_IMETHOD HandleEvent(nsIDOMGeoPositionError *positionError); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGEOPOSITIONERRORCALLBACK(_to) \
  NS_IMETHOD HandleEvent(nsIDOMGeoPositionError *positionError) { return _to HandleEvent(positionError); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGEOPOSITIONERRORCALLBACK(_to) \
  NS_IMETHOD HandleEvent(nsIDOMGeoPositionError *positionError) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEvent(positionError); } 
