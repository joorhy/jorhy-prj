/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/content/base/public/nsIDOMFormData.idl
 */
...
class NS_NO_VTABLE nsIDOMFormData : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMFORMDATA_IID)

  /* void append (in DOMString name, in nsIVariant value); */
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value) = 0;
...
#define NS_DECL_NSIDOMFORMDATA \
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMFORMDATA(_to) \
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value) { return _to Append(name, value); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMFORMDATA(_to) \
  NS_IMETHOD Append(const nsAString & name, nsIVariant *value) { return !_to ? NS_ERROR_NULL_POINTER : _to->Append(name, value); } 
