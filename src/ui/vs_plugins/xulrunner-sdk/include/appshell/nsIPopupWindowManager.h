/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpfe/appshell/public/nsIPopupWindowManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPopupWindowManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSIPOPUPWINDOWMANAGER \
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, PRUint32 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPOPUPWINDOWMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, PRUint32 *_retval) { return _to TestPermission(uri, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPOPUPWINDOWMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->TestPermission(uri, _retval); } 
