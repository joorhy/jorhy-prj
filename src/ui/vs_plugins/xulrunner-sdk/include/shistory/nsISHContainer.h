/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/shistory/public/nsISHContainer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISHContainer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval) = 0;
...
#define NS_DECL_NSISHCONTAINER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval); 
...
#define NS_FORWARD_NSISHCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval) { return _to GetChildAt(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSISHCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChildAt(PRInt32 index, nsISHEntry **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChildAt(index, _retval); } 
...
/* nsISHEntry GetChildAt (in long index); */
NS_IMETHODIMP nsSHContainer::GetChildAt(PRInt32 index, nsISHEntry **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
