/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/shistory/public/nsISHEntry.idl
 */
...
/** Append a child shell to the end of our list. */
  ...
  NS_SCRIPTABLE NS_IMETHOD ChildShellAt(PRInt32 index, nsIDocShellTreeItem **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollPosition(PRInt32 *x, PRInt32 *y) = 0;
  ...
  /* nsISHEntry clone (); */
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISHEntry **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAnyContentViewer(nsISHEntry **ownerEntry, nsIContentViewer **_retval) = 0;
...
#define NS_DECL_NSISHENTRY \
  ...
  NS_SCRIPTABLE NS_IMETHOD ChildShellAt(PRInt32 index, nsIDocShellTreeItem **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollPosition(PRInt32 *x, PRInt32 *y); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISHEntry **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetIsSubFrame(PRBool aFlag); \
  NS_SCRIPTABLE NS_IMETHOD GetAnyContentViewer(nsISHEntry **ownerEntry, nsIContentViewer **_retval); \
...
#define NS_FORWARD_NSISHENTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ChildShellAt(PRInt32 index, nsIDocShellTreeItem **_retval) { return _to ChildShellAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollPosition(PRInt32 *x, PRInt32 *y) { return _to GetScrollPosition(x, y); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISHEntry **_retval) { return _to Clone(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsSubFrame(PRBool aFlag) { return _to SetIsSubFrame(aFlag); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnyContentViewer(nsISHEntry **ownerEntry, nsIContentViewer **_retval) { return _to GetAnyContentViewer(ownerEntry, _retval); } \
...
#define NS_FORWARD_SAFE_NSISHENTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ChildShellAt(PRInt32 index, nsIDocShellTreeItem **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ChildShellAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollPosition(PRInt32 *x, PRInt32 *y) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScrollPosition(x, y); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISHEntry **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Clone(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsSubFrame(PRBool aFlag) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsSubFrame(aFlag); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnyContentViewer(nsISHEntry **ownerEntry, nsIContentViewer **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnyContentViewer(ownerEntry, _retval); } \
