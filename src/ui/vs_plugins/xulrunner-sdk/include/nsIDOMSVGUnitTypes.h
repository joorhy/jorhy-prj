/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/svg/nsIDOMSVGUnitTypes.idl
 */
...
class NS_NO_VTABLE nsIDOMSVGUnitTypes : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMSVGUNITTYPES_IID)

  enum {
    SVG_UNIT_TYPE_UNKNOWN = 0U,
    SVG_UNIT_TYPE_USERSPACEONUSE = 1U,
    SVG_UNIT_TYPE_OBJECTBOUNDINGBOX = 2U
  };
