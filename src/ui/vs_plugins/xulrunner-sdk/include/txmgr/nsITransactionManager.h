/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/txmgr/idl/nsITransactionManager.idl
 */
...
/**
  ...
  NS_SCRIPTABLE NS_IMETHOD PeekUndoStack(nsITransaction **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD PeekRedoStack(nsITransaction **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUndoList(nsITransactionList **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRedoList(nsITransactionList **_retval) = 0;
...
#define NS_DECL_NSITRANSACTIONMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD PeekUndoStack(nsITransaction **_retval); \
  NS_SCRIPTABLE NS_IMETHOD PeekRedoStack(nsITransaction **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetUndoList(nsITransactionList **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetRedoList(nsITransactionList **_retval); \
...
#define NS_FORWARD_NSITRANSACTIONMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PeekUndoStack(nsITransaction **_retval) { return _to PeekUndoStack(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PeekRedoStack(nsITransaction **_retval) { return _to PeekRedoStack(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetUndoList(nsITransactionList **_retval) { return _to GetUndoList(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetRedoList(nsITransactionList **_retval) { return _to GetRedoList(_retval); } \
...
#define NS_FORWARD_SAFE_NSITRANSACTIONMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PeekUndoStack(nsITransaction **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PeekUndoStack(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PeekRedoStack(nsITransaction **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PeekRedoStack(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetUndoList(nsITransactionList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUndoList(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetRedoList(nsITransactionList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRedoList(_retval); } \
