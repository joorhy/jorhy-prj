/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/txmgr/idl/nsITransactionList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITransactionList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItem(PRInt32 aIndex, nsITransaction **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNumChildrenForItem(PRInt32 aIndex, PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChildListForItem(PRInt32 aIndex, nsITransactionList **_retval) = 0;
...
#define NS_DECL_NSITRANSACTIONLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetItem(PRInt32 aIndex, nsITransaction **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetNumChildrenForItem(PRInt32 aIndex, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetChildListForItem(PRInt32 aIndex, nsITransactionList **_retval); 
...
#define NS_FORWARD_NSITRANSACTIONLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, PRBool *_retval) { return _to ItemIsBatch(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetItem(PRInt32 aIndex, nsITransaction **_retval) { return _to GetItem(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNumChildrenForItem(PRInt32 aIndex, PRInt32 *_retval) { return _to GetNumChildrenForItem(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetChildListForItem(PRInt32 aIndex, nsITransactionList **_retval) { return _to GetChildListForItem(aIndex, _retval); } 
...
#define NS_FORWARD_SAFE_NSITRANSACTIONLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemIsBatch(PRInt32 aIndex, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ItemIsBatch(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetItem(PRInt32 aIndex, nsITransaction **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItem(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNumChildrenForItem(PRInt32 aIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNumChildrenForItem(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetChildListForItem(PRInt32 aIndex, nsITransactionList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChildListForItem(aIndex, _retval); } 
...
/* boolean itemIsBatch (in long aIndex); */
NS_IMETHODIMP nsTransactionList::ItemIsBatch(PRInt32 aIndex, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsITransaction getItem (in long aIndex); */
NS_IMETHODIMP nsTransactionList::GetItem(PRInt32 aIndex, nsITransaction **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long getNumChildrenForItem (in long aIndex); */
NS_IMETHODIMP nsTransactionList::GetNumChildrenForItem(PRInt32 aIndex, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsITransactionList getChildListForItem (in long aIndex); */
NS_IMETHODIMP nsTransactionList::GetChildListForItem(PRInt32 aIndex, nsITransactionList **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
