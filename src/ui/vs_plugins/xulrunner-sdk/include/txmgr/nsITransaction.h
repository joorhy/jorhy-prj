/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/txmgr/idl/nsITransaction.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITransaction : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval) = 0;
...
#define NS_DECL_NSITRANSACTION \
  ...
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval); 
...
#define NS_FORWARD_NSITRANSACTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval) { return _to Merge(aTransaction, _retval); } 
...
#define NS_FORWARD_SAFE_NSITRANSACTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Merge(nsITransaction *aTransaction, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Merge(aTransaction, _retval); } 
...
/* boolean merge (in nsITransaction aTransaction); */
NS_IMETHODIMP nsTransaction::Merge(nsITransaction *aTransaction, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
