/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/css/nsIDOMCSSRuleList.idl
 */
...
#define NS_DECL_NSIDOMCSSRULELIST \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMCSSRule * *_retval); 
...
#define NS_FORWARD_NSIDOMCSSRULELIST(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMCSSRule * *_retval) { return _to Item(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMCSSRULELIST(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMCSSRule * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } 
