/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/extensions/spellcheck/idl/mozISpellI18NManager.idl
 */
...
class NS_NO_VTABLE mozISpellI18NManager : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(MOZISPELLI18NMANAGER_IID)

  /* mozISpellI18NUtil getUtil (in wstring language); */
  NS_IMETHOD GetUtil(const PRUnichar * language, mozISpellI18NUtil * *_retval) = 0;
...
#define NS_DECL_MOZISPELLI18NMANAGER \
  NS_IMETHOD GetUtil(const PRUnichar * language, mozISpellI18NUtil * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISPELLI18NMANAGER(_to) \
  NS_IMETHOD GetUtil(const PRUnichar * language, mozISpellI18NUtil * *_retval) { return _to GetUtil(language, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISPELLI18NMANAGER(_to) \
  NS_IMETHOD GetUtil(const PRUnichar * language, mozISpellI18NUtil * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUtil(language, _retval); } 
...
/* mozISpellI18NUtil getUtil (in wstring language); */
NS_IMETHODIMP _MYCLASS_::GetUtil(const PRUnichar * language, mozISpellI18NUtil * *_retval)
{
