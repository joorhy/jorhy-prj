/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/webshell/public/nsIDocumentLoaderFactory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocumentLoaderFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateInstance(const char *aCommand, nsIChannel *aChannel, nsILoadGroup *aLoadGroup, const char *aContentType, nsISupports *aContainer, nsISupports *aExtraInfo, nsIStreamListener **aDocListenerResult, nsIContentViewer **_retval) = 0;

  /* nsIContentViewer createInstanceForDocument (in nsISupports aContainer, in nsIDocument aDocument, in string aCommand); */
  NS_SCRIPTABLE NS_IMETHOD CreateInstanceForDocument(nsISupports *aContainer, nsIDocument *aDocument, const char *aCommand, nsIContentViewer **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateBlankDocument(nsILoadGroup *aLoadGroup, nsIPrincipal *aPrincipal, nsIDocument **_retval) = 0;
...
#define NS_DECL_NSIDOCUMENTLOADERFACTORY \
  NS_SCRIPTABLE NS_IMETHOD CreateInstance(const char *aCommand, nsIChannel *aChannel, nsILoadGroup *aLoadGroup, const char *aContentType, nsISupports *aContainer, nsISupports *aExtraInfo, nsIStreamListener **aDocListenerResult, nsIContentViewer **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateInstanceForDocument(nsISupports *aContainer, nsIDocument *aDocument, const char *aCommand, nsIContentViewer **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateBlankDocument(nsILoadGroup *aLoadGroup, nsIPrincipal *aPrincipal, nsIDocument **_retval); 
...
#define NS_FORWARD_NSIDOCUMENTLOADERFACTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateInstanceForDocument(nsISupports *aContainer, nsIDocument *aDocument, const char *aCommand, nsIContentViewer **_retval) { return _to CreateInstanceForDocument(aContainer, aDocument, aCommand, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateBlankDocument(nsILoadGroup *aLoadGroup, nsIPrincipal *aPrincipal, nsIDocument **_retval) { return _to CreateBlankDocument(aLoadGroup, aPrincipal, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOCUMENTLOADERFACTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateInstanceForDocument(nsISupports *aContainer, nsIDocument *aDocument, const char *aCommand, nsIContentViewer **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateInstanceForDocument(aContainer, aDocument, aCommand, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateBlankDocument(nsILoadGroup *aLoadGroup, nsIPrincipal *aPrincipal, nsIDocument **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateBlankDocument(aLoadGroup, aPrincipal, _retval); } 
