/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsINestedURI.idl
 */
...
#define NS_DECL_NSINESTEDURI \
  NS_IMETHOD GetInnerURI(nsIURI * *aInnerURI); \
  NS_IMETHOD GetInnermostURI(nsIURI * *aInnermostURI); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSINESTEDURI(_to) \
  NS_IMETHOD GetInnerURI(nsIURI * *aInnerURI) { return _to GetInnerURI(aInnerURI); } \
  NS_IMETHOD GetInnermostURI(nsIURI * *aInnermostURI) { return _to GetInnermostURI(aInnermostURI); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSINESTEDURI(_to) \
  NS_IMETHOD GetInnerURI(nsIURI * *aInnerURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInnerURI(aInnerURI); } \
  NS_IMETHOD GetInnermostURI(nsIURI * *aInnermostURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInnermostURI(aInnermostURI); } 
