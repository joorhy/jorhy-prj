/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/caps/idl/nsIScriptSecurityManager.idl
 */
...
/* starting interface:    nsIScriptSecurityManager_1_9_0_BRANCH */
#define NS_ISCRIPTSECURITYMANAGER_1_9_0_BRANCH_IID_STR "09cd62cd-3360-45e6-860b-6c0da411712a"

#define NS_ISCRIPTSECURITYMANAGER_1_9_0_BRANCH_IID \
  {0x09cd62cd, 0x3360, 0x45e6, \
    { 0x86, 0x0b, 0x6c, 0x0d, 0xa4, 0x11, 0x71, 0x2a }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptSecurityManager_1_9_0_BRANCH : public nsIScriptSecurityManager {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ISCRIPTSECURITYMANAGER_1_9_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIScriptSecurityManager_1_9_0_BRANCH, NS_ISCRIPTSECURITYMANAGER_1_9_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISCRIPTSECURITYMANAGER_1_9_0_BRANCH \
  NS_IMETHOD_(nsIPrincipal *) GetCxSubjectPrincipalAndFrame(JSContext * cx, JSStackFrame * *fp); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISCRIPTSECURITYMANAGER_1_9_0_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISCRIPTSECURITYMANAGER_1_9_0_BRANCH(_to) \
...
/* Header file */
class nsScriptSecurityManager_1_9_0_BRANCH : public nsIScriptSecurityManager_1_9_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSISCRIPTSECURITYMANAGER_1_9_0_BRANCH

  nsScriptSecurityManager_1_9_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsScriptSecurityManager_1_9_0_BRANCH, nsIScriptSecurityManager_1_9_0_BRANCH)

nsScriptSecurityManager_1_9_0_BRANCH::nsScriptSecurityManager_1_9_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* [noscript, notxpcom] nsIPrincipal getCxSubjectPrincipalAndFrame (in JSContextPtr cx, out JSStackFramePtr fp); */
NS_IMETHODIMP_(nsIPrincipal *) nsScriptSecurityManager_1_9_0_BRANCH::GetCxSubjectPrincipalAndFrame(JSContext * cx, JSStackFrame * *fp)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
