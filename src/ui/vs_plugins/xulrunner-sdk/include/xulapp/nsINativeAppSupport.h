/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/xre/nsINativeAppSupport.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINativeAppSupport : public nsISupports {
 public: 
  ...
  /* boolean start (); */
  NS_SCRIPTABLE NS_IMETHOD Start(PRBool *_retval) = 0;

  /* void enable (); */
  NS_SCRIPTABLE NS_IMETHOD Enable(void) = 0;

  /* boolean stop (); */
  NS_SCRIPTABLE NS_IMETHOD Stop(PRBool *_retval) = 0;
...
#define NS_DECL_NSINATIVEAPPSUPPORT \
  NS_SCRIPTABLE NS_IMETHOD Start(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD Enable(void); \
  NS_SCRIPTABLE NS_IMETHOD Stop(PRBool *_retval); \
...
#define NS_FORWARD_NSINATIVEAPPSUPPORT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Start(PRBool *_retval) { return _to Start(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Enable(void) { return _to Enable(); } \
  NS_SCRIPTABLE NS_IMETHOD Stop(PRBool *_retval) { return _to Stop(_retval); } \
...
#define NS_FORWARD_SAFE_NSINATIVEAPPSUPPORT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Start(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Start(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Enable(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enable(); } \
  NS_SCRIPTABLE NS_IMETHOD Stop(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Stop(_retval); } \
