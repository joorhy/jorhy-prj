/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/profile/public/nsIToolkitProfile.idl
 */
...
/**
  ...
  NS_SCRIPTABLE NS_IMETHOD Lock(nsIProfileUnlocker **aUnlocker, nsIProfileLock **_retval) = 0;
...
#define NS_DECL_NSITOOLKITPROFILE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Lock(nsIProfileUnlocker **aUnlocker, nsIProfileLock **_retval); 
...
#define NS_FORWARD_NSITOOLKITPROFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Lock(nsIProfileUnlocker **aUnlocker, nsIProfileLock **_retval) { return _to Lock(aUnlocker, _retval); } 
...
#define NS_FORWARD_SAFE_NSITOOLKITPROFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Lock(nsIProfileUnlocker **aUnlocker, nsIProfileLock **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Lock(aUnlocker, _retval); } 
