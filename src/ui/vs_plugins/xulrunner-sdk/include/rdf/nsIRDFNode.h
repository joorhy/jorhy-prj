/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/rdf/base/idl/nsIRDFNode.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFNode : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval) = 0;
...
#define NS_DECL_NSIRDFNODE \
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFNODE(_to) \
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval) { return _to EqualsNode(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFNODE(_to) \
  NS_SCRIPTABLE NS_IMETHOD EqualsNode(nsIRDFNode *aNode, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsNode(aNode, _retval); } 
...
/* boolean EqualsNode (in nsIRDFNode aNode); */
NS_IMETHODIMP nsRDFNode::EqualsNode(nsIRDFNode *aNode, PRBool *_retval)
{
