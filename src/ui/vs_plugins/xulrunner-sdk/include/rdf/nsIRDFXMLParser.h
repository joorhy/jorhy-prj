/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/rdf/base/idl/nsIRDFXMLParser.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFXMLParser : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ParseAsync(nsIRDFDataSource *aSink, nsIURI *aBaseURI, nsIStreamListener **_retval) = 0;
...
#define NS_DECL_NSIRDFXMLPARSER \
  NS_SCRIPTABLE NS_IMETHOD ParseAsync(nsIRDFDataSource *aSink, nsIURI *aBaseURI, nsIStreamListener **_retval); \
...
#define NS_FORWARD_NSIRDFXMLPARSER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ParseAsync(nsIRDFDataSource *aSink, nsIURI *aBaseURI, nsIStreamListener **_retval) { return _to ParseAsync(aSink, aBaseURI, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFXMLPARSER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ParseAsync(nsIRDFDataSource *aSink, nsIURI *aBaseURI, nsIStreamListener **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ParseAsync(aSink, aBaseURI, _retval); } \
