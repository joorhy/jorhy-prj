/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/rdf/base/idl/nsIRDFCompositeDataSource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFCompositeDataSource : public nsIRDFDataSource {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDataSources(nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_NSIRDFCOMPOSITEDATASOURCE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDataSources(nsISimpleEnumerator **_retval); 
...
#define NS_FORWARD_NSIRDFCOMPOSITEDATASOURCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDataSources(nsISimpleEnumerator **_retval) { return _to GetDataSources(_retval); } 
...
#define NS_FORWARD_SAFE_NSIRDFCOMPOSITEDATASOURCE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDataSources(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDataSources(_retval); } 
