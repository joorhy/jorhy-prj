/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/rdf/base/idl/nsIRDFPurgeableDataSource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFPurgeableDataSource : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, PRBool aTruthValue, PRBool *_retval) = 0;
...
#define NS_DECL_NSIRDFPURGEABLEDATASOURCE \
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, PRBool aTruthValue, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD Sweep(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFPURGEABLEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, PRBool aTruthValue, PRBool *_retval) { return _to Mark(aSource, aProperty, aTarget, aTruthValue, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFPURGEABLEDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, PRBool aTruthValue, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Mark(aSource, aProperty, aTarget, aTruthValue, _retval); } \
...
/* boolean Mark (in nsIRDFResource aSource, in nsIRDFResource aProperty, in nsIRDFNode aTarget, in boolean aTruthValue); */
NS_IMETHODIMP nsRDFPurgeableDataSource::Mark(nsIRDFResource *aSource, nsIRDFResource *aProperty, nsIRDFNode *aTarget, PRBool aTruthValue, PRBool *_retval)
{
