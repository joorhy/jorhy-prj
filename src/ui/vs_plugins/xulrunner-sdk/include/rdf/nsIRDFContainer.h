/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/rdf/base/idl/nsIRDFContainer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFContainer : public nsISupports {
 public: 
  ...
  /**
     ...
     */
  /* long GetCount (); */
  NS_SCRIPTABLE NS_IMETHOD GetCount(PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetElements(nsISimpleEnumerator **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IndexOf(nsIRDFNode *aElement, PRInt32 *_retval) = 0;
...
#define NS_DECL_NSIRDFCONTAINER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCount(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetElements(nsISimpleEnumerator **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD IndexOf(nsIRDFNode *aElement, PRInt32 *_retval); 
...
#define NS_FORWARD_NSIRDFCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCount(PRInt32 *_retval) { return _to GetCount(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetElements(nsISimpleEnumerator **_retval) { return _to GetElements(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval) { return _to RemoveElementAt(aIndex, aRenumber, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IndexOf(nsIRDFNode *aElement, PRInt32 *_retval) { return _to IndexOf(aElement, _retval); } 
...
#define NS_FORWARD_SAFE_NSIRDFCONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCount(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCount(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetElements(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElements(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveElementAt(aIndex, aRenumber, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IndexOf(nsIRDFNode *aElement, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IndexOf(aElement, _retval); } 
...
/* long GetCount (); */
NS_IMETHODIMP nsRDFContainer::GetCount(PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIRDFNode RemoveElementAt (in long aIndex, in boolean aRenumber); */
NS_IMETHODIMP nsRDFContainer::RemoveElementAt(PRInt32 aIndex, PRBool aRenumber, nsIRDFNode **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long IndexOf (in nsIRDFNode aElement); */
NS_IMETHODIMP nsRDFContainer::IndexOf(nsIRDFNode *aElement, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
