/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/rdf/base/idl/nsIRDFDelegateFactory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRDFDelegateFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char *aKey, const nsIID & aIID, void * *aResult) = 0;
...
#define NS_DECL_NSIRDFDELEGATEFACTORY \
  NS_SCRIPTABLE NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char *aKey, const nsIID & aIID, void * *aResult); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFDELEGATEFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char *aKey, const nsIID & aIID, void * *aResult) { return _to CreateDelegate(aOuter, aKey, aIID, aResult); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFDELEGATEFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateDelegate(nsIRDFResource *aOuter, const char *aKey, const nsIID & aIID, void * *aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateDelegate(aOuter, aKey, aIID, aResult); } 
