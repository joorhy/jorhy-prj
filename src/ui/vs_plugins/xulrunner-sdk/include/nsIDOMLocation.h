/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMLocation.idl
 */
...
#define NS_FORWARD_NSIDOMLOCATION(_to) \
  ...
  NS_IMETHOD Reload(bool forceget) { return _to Reload(forceget); } \
  ...
  NS_IMETHOD ValueOf(nsIDOMLocation * *_retval) { return _to ValueOf(_retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMLOCATION(_to) \
  ...
  NS_IMETHOD Reload(bool forceget) { return !_to ? NS_ERROR_NULL_POINTER : _to->Reload(forceget); } \
  ...
  NS_IMETHOD ValueOf(nsIDOMLocation * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ValueOf(_retval); } 
