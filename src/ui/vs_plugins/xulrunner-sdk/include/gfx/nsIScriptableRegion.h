/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/gfx/idl/nsIScriptableRegion.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableRegion : public nsISupports {
  ...
  **/
  /* boolean isEmpty (); */
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(PRBool *_retval) = 0;
  ...
  **/
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, PRBool *_retval) = 0;
  ...
  **/
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBoundingBox(PRInt32 *aX, PRInt32 *aY, PRInt32 *aWidth, PRInt32 *aHeight) = 0;
  ...
  **/
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, PRBool *_retval) = 0;
...
#define NS_DECL_NSISCRIPTABLEREGION \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetBoundingBox(PRInt32 *aX, PRInt32 *aY, PRInt32 *aWidth, PRInt32 *aHeight); \
  NS_SCRIPTABLE NS_IMETHOD Offset(PRInt32 aXOffset, PRInt32 aYOffset); \
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, PRBool *_retval); \
...
#define NS_FORWARD_NSISCRIPTABLEREGION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(PRBool *_retval) { return _to IsEmpty(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, PRBool *_retval) { return _to IsEqualRegion(aRegion, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetBoundingBox(PRInt32 *aX, PRInt32 *aY, PRInt32 *aWidth, PRInt32 *aHeight) { return _to GetBoundingBox(aX, aY, aWidth, aHeight); } \
  NS_SCRIPTABLE NS_IMETHOD Offset(PRInt32 aXOffset, PRInt32 aYOffset) { return _to Offset(aXOffset, aYOffset); } \
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, PRBool *_retval) { return _to ContainsRect(aX, aY, aWidth, aHeight, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEREGION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsEmpty(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEmpty(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsEqualRegion(nsIScriptableRegion *aRegion, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsEqualRegion(aRegion, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetBoundingBox(PRInt32 *aX, PRInt32 *aY, PRInt32 *aWidth, PRInt32 *aHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBoundingBox(aX, aY, aWidth, aHeight); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsRect(PRInt32 aX, PRInt32 aY, PRInt32 aWidth, PRInt32 aHeight, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContainsRect(aX, aY, aWidth, aHeight, _retval); } \
