/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpcom/base/nsIException.idl
 */
...
class NS_NO_VTABLE nsIException : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetMessageMoz(char * *aMessage) = 0;
...
#define NS_DECL_NSIEXCEPTION \
  NS_IMETHOD GetMessageMoz(char * *aMessage); \
...
#define NS_FORWARD_NSIEXCEPTION(_to) \
  NS_IMETHOD GetMessageMoz(char * *aMessage) { return _to GetMessageMoz(aMessage); } \
...
#define NS_FORWARD_SAFE_NSIEXCEPTION(_to) \
  NS_IMETHOD GetMessageMoz(char * *aMessage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMessageMoz(aMessage); } \
