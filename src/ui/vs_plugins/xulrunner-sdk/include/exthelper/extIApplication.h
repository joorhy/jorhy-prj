/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/exthelper/extIApplication.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE extIPreferenceBranch : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aName, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, extIPreference **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValue(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval) = 0;
...
#define NS_DECL_EXTIPREFERENCEBRANCH \
  ...
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aName, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, extIPreference **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetValue(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval); \
...
#define NS_FORWARD_EXTIPREFERENCEBRANCH(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aName, PRBool *_retval) { return _to Has(aName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, extIPreference **_retval) { return _to Get(aName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetValue(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval) { return _to GetValue(aName, aDefaultValue, _retval); } \
...
#define NS_FORWARD_SAFE_EXTIPREFERENCEBRANCH(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aName, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Has(aName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, extIPreference **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(aName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetValue(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValue(aName, aDefaultValue, _retval); } \
...
/* boolean has (in AString aName); */
NS_IMETHODIMP _MYCLASS_::Has(const nsAString & aName, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE extIExtensions : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aId, extIExtension **_retval) = 0;
...
#define NS_DECL_EXTIEXTENSIONS \
  NS_SCRIPTABLE NS_IMETHOD GetAll(nsIVariant * *aAll); \
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aId, extIExtension **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_EXTIEXTENSIONS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAll(nsIVariant * *aAll) { return _to GetAll(aAll); } \
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, PRBool *_retval) { return _to Has(aId, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aId, extIExtension **_retval) { return _to Get(aId, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_EXTIEXTENSIONS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAll(nsIVariant * *aAll) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAll(aAll); } \
  NS_SCRIPTABLE NS_IMETHOD Has(const nsAString & aId, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Has(aId, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aId, extIExtension **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(aId, _retval); } 
...
/* boolean has (in AString aId); */
NS_IMETHODIMP _MYCLASS_::Has(const nsAString & aId, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/**
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval) = 0;
...
#define NS_DECL_EXTISESSIONSTORAGE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval); 
...
#define NS_FORWARD_EXTISESSIONSTORAGE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval) { return _to Get(aName, aDefaultValue, _retval); } 
...
#define NS_FORWARD_SAFE_EXTISESSIONSTORAGE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant *aDefaultValue, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(aName, aDefaultValue, _retval); } 
...
#define EXTIAPPLICATION_IID_STR "ba9442ee-7070-44fb-8157-c111e1fa70b6"

#define EXTIAPPLICATION_IID \
  {0xba9442ee, 0x7070, 0x44fb, \
    { 0x81, 0x57, 0xc1, 0x11, 0xe1, 0xfa, 0x70, 0xb6 }}
