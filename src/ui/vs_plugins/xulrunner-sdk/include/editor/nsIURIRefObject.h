/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/idl/nsIURIRefObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIURIRefObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextURI(nsAString & _retval) = 0;
...
#define NS_DECL_NSIURIREFOBJECT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextURI(nsAString & _retval); \
...
#define NS_FORWARD_NSIURIREFOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextURI(nsAString & _retval) { return _to GetNextURI(_retval); } \
...
#define NS_FORWARD_SAFE_NSIURIREFOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextURI(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNextURI(_retval); } \
