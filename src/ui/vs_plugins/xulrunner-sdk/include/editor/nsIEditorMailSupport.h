/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/idl/nsIEditorMailSupport.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditorMailSupport : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsQuotation(const nsAString & aQuotedText, nsIDOMNode **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsCitedQuotation(const nsAString & aQuotedText, const nsAString & aCitation, PRBool aInsertHTML, nsIDOMNode **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEmbeddedObjects(nsISupportsArray **_retval) = 0;
...
#define NS_DECL_NSIEDITORMAILSUPPORT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsQuotation(const nsAString & aQuotedText, nsIDOMNode **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsCitedQuotation(const nsAString & aQuotedText, const nsAString & aCitation, PRBool aInsertHTML, nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Rewrap(PRBool aRespectNewlines); \
  NS_SCRIPTABLE NS_IMETHOD StripCites(void); \
  NS_SCRIPTABLE NS_IMETHOD GetEmbeddedObjects(nsISupportsArray **_retval); 
...
#define NS_FORWARD_NSIEDITORMAILSUPPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsQuotation(const nsAString & aQuotedText, nsIDOMNode **_retval) { return _to InsertAsQuotation(aQuotedText, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsCitedQuotation(const nsAString & aQuotedText, const nsAString & aCitation, PRBool aInsertHTML, nsIDOMNode **_retval) { return _to InsertAsCitedQuotation(aQuotedText, aCitation, aInsertHTML, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEmbeddedObjects(nsISupportsArray **_retval) { return _to GetEmbeddedObjects(_retval); } 
...
#define NS_FORWARD_SAFE_NSIEDITORMAILSUPPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsQuotation(const nsAString & aQuotedText, nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertAsQuotation(aQuotedText, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertAsCitedQuotation(const nsAString & aQuotedText, const nsAString & aCitation, PRBool aInsertHTML, nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertAsCitedQuotation(aQuotedText, aCitation, aInsertHTML, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEmbeddedObjects(nsISupportsArray **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEmbeddedObjects(_retval); } 
...
/* nsIDOMNode insertAsCitedQuotation (in AString aQuotedText, in AString aCitation, in boolean aInsertHTML); */
NS_IMETHODIMP nsEditorMailSupport::InsertAsCitedQuotation(const nsAString & aQuotedText, const nsAString & aCitation, PRBool aInsertHTML, nsIDOMNode **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
