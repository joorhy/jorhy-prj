/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIClassicPluginFactory.idl
 */
...
class NS_NO_VTABLE nsIClassicPluginFactory : public nsISupports {
  ...
  */
  ...
  NS_IMETHOD CreatePlugin(nsIServiceManagerObsolete *aServiceMgr, const char *aFileName, const char *aFullPath, PRLibrary * aLibrary, nsIPlugin **aResult) = 0;
...
#define NS_DECL_NSICLASSICPLUGINFACTORY \
  NS_IMETHOD CreatePlugin(nsIServiceManagerObsolete *aServiceMgr, const char *aFileName, const char *aFullPath, PRLibrary * aLibrary, nsIPlugin **aResult); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICLASSICPLUGINFACTORY(_to) \
  NS_IMETHOD CreatePlugin(nsIServiceManagerObsolete *aServiceMgr, const char *aFileName, const char *aFullPath, PRLibrary * aLibrary, nsIPlugin **aResult) { return _to CreatePlugin(aServiceMgr, aFileName, aFullPath, aLibrary, aResult); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICLASSICPLUGINFACTORY(_to) \
  NS_IMETHOD CreatePlugin(nsIServiceManagerObsolete *aServiceMgr, const char *aFileName, const char *aFullPath, PRLibrary * aLibrary, nsIPlugin **aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreatePlugin(aServiceMgr, aFileName, aFullPath, aLibrary, aResult); } 
...
/* void createPlugin (in nsIServiceManagerObsolete aServiceMgr, in string aFileName, in string aFullPath, in PRLibraryPtr aLibrary, out nsIPlugin aResult); */
NS_IMETHODIMP nsClassicPluginFactory::CreatePlugin(nsIServiceManagerObsolete *aServiceMgr, const char *aFileName, const char *aFullPath, PRLibrary * aLibrary, nsIPlugin **aResult)
{
