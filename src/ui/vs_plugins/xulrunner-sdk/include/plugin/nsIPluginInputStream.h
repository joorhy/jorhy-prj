/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIPluginInputStream.idl
 */
...
class NS_NO_VTABLE nsIPluginInputStream : public nsIInputStream {
 public: 
  ...
  NS_IMETHOD GetLastModified(PRUint32 *aResult) = 0;
...
#define NS_DECL_NSIPLUGININPUTSTREAM \
  NS_IMETHOD GetLastModified(PRUint32 *aResult); \
  NS_IMETHOD RequestRead(nsByteRange *aRangeList); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPLUGININPUTSTREAM(_to) \
  NS_IMETHOD GetLastModified(PRUint32 *aResult) { return _to GetLastModified(aResult); } \
...
#define NS_FORWARD_SAFE_NSIPLUGININPUTSTREAM(_to) \
  NS_IMETHOD GetLastModified(PRUint32 *aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastModified(aResult); } \
...
/* void getLastModified (out unsigned long aResult); */
NS_IMETHODIMP nsPluginInputStream::GetLastModified(PRUint32 *aResult)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void requestRead (out nsByteRange aRangeList); */
NS_IMETHODIMP nsPluginInputStream::RequestRead(nsByteRange *aRangeList)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
