/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsICookieStorage.idl
 */
...
class NS_NO_VTABLE nsICookieStorage : public nsISupports {
 public: 
  ...
  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ICOOKIESTORAGE_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsICookieStorage, NS_ICOOKIESTORAGE_IID)
