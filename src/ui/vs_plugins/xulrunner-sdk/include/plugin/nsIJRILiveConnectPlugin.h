/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIJRILiveConnectPlugin.idl
 */
...
class NS_NO_VTABLE nsIJRILiveConnectPlugin : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetJavaClass(JRIEnv * aEnv, jref *aJavaClass) = 0;
...
#define NS_DECL_NSIJRILIVECONNECTPLUGIN \
  NS_IMETHOD GetJavaClass(JRIEnv * aEnv, jref *aJavaClass); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJRILIVECONNECTPLUGIN(_to) \
  NS_IMETHOD GetJavaClass(JRIEnv * aEnv, jref *aJavaClass) { return _to GetJavaClass(aEnv, aJavaClass); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJRILIVECONNECTPLUGIN(_to) \
  NS_IMETHOD GetJavaClass(JRIEnv * aEnv, jref *aJavaClass) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJavaClass(aEnv, aJavaClass); } 
...
/* void getJavaClass (in JRIEnvPtr aEnv, out jref aJavaClass); */
NS_IMETHODIMP nsJRILiveConnectPlugin::GetJavaClass(JRIEnv * aEnv, jref *aJavaClass)
{
