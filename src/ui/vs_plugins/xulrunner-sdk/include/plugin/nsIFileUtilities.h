/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIFileUtilities.idl
 */
...
class NS_NO_VTABLE nsIFileUtilities : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetProgramPath(const char * *aProgramPath) = 0;
  ...
  NS_IMETHOD GetTempDirPath(const char * *aTempDirPath) = 0;
...
#define NS_DECL_NSIFILEUTILITIES \
  NS_IMETHOD GetProgramPath(const char * *aProgramPath); \
  NS_IMETHOD GetTempDirPath(const char * *aTempDirPath); \
...
#define NS_FORWARD_NSIFILEUTILITIES(_to) \
  NS_IMETHOD GetProgramPath(const char * *aProgramPath) { return _to GetProgramPath(aProgramPath); } \
  NS_IMETHOD GetTempDirPath(const char * *aTempDirPath) { return _to GetTempDirPath(aTempDirPath); } \
...
#define NS_FORWARD_SAFE_NSIFILEUTILITIES(_to) \
  NS_IMETHOD GetProgramPath(const char * *aProgramPath) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProgramPath(aProgramPath); } \
  NS_IMETHOD GetTempDirPath(const char * *aTempDirPath) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTempDirPath(aTempDirPath); } \
...
/* void getProgramPath (out constCharPtr aProgramPath); */
NS_IMETHODIMP nsFileUtilities::GetProgramPath(const char * *aProgramPath)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getTempDirPath (out constCharPtr aTempDirPath); */
NS_IMETHODIMP nsFileUtilities::GetTempDirPath(const char * *aTempDirPath)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
