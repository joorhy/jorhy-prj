/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIPluginStreamInfo.idl
 */
...
class NS_NO_VTABLE nsIPluginStreamInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD IsSeekable(PRBool *aSeekable) = 0;
  ...
  NS_IMETHOD GetURL(const char * *aURL) = 0;
...
#define NS_DECL_NSIPLUGINSTREAMINFO \
  ...
  NS_IMETHOD IsSeekable(PRBool *aSeekable); \
  NS_IMETHOD GetLength(PRUint32 *aLength); \
  NS_IMETHOD GetLastModified(PRUint32 *aLastModified); \
  NS_IMETHOD GetURL(const char * *aURL); \
...
#define NS_FORWARD_NSIPLUGINSTREAMINFO(_to) \
  ...
  NS_IMETHOD IsSeekable(PRBool *aSeekable) { return _to IsSeekable(aSeekable); } \
  NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } \
  NS_IMETHOD GetLastModified(PRUint32 *aLastModified) { return _to GetLastModified(aLastModified); } \
  NS_IMETHOD GetURL(const char * *aURL) { return _to GetURL(aURL); } \
...
#define NS_FORWARD_SAFE_NSIPLUGINSTREAMINFO(_to) \
  ...
  NS_IMETHOD IsSeekable(PRBool *aSeekable) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSeekable(aSeekable); } \
  ...
  NS_IMETHOD GetURL(const char * *aURL) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURL(aURL); } \
...
/* void isSeekable (out boolean aSeekable); */
NS_IMETHODIMP nsPluginStreamInfo::IsSeekable(PRBool *aSeekable)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getURL (out constCharPtr aURL); */
NS_IMETHODIMP nsPluginStreamInfo::GetURL(const char * *aURL)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
