/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIJRILiveConnectPIPeer.idl
 */
...
class NS_NO_VTABLE nsIJRILiveConnectPluginInstancePeer : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetJavaEnv(JRIEnv * *aEnv) = 0;
  ...
  NS_IMETHOD GetJavaPeer(jref *aJavaPeer) = 0;
...
#define NS_DECL_NSIJRILIVECONNECTPLUGININSTANCEPEER \
  NS_IMETHOD GetJavaEnv(JRIEnv * *aEnv); \
  NS_IMETHOD GetJavaPeer(jref *aJavaPeer); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJRILIVECONNECTPLUGININSTANCEPEER(_to) \
  NS_IMETHOD GetJavaEnv(JRIEnv * *aEnv) { return _to GetJavaEnv(aEnv); } \
  NS_IMETHOD GetJavaPeer(jref *aJavaPeer) { return _to GetJavaPeer(aJavaPeer); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJRILIVECONNECTPLUGININSTANCEPEER(_to) \
  NS_IMETHOD GetJavaEnv(JRIEnv * *aEnv) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJavaEnv(aEnv); } \
  NS_IMETHOD GetJavaPeer(jref *aJavaPeer) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJavaPeer(aJavaPeer); } 
...
/* void getJavaEnv (out JRIEnvPtr aEnv); */
NS_IMETHODIMP nsJRILiveConnectPluginInstancePeer::GetJavaEnv(JRIEnv * *aEnv)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void getJavaPeer (out jref aJavaPeer); */
NS_IMETHODIMP nsJRILiveConnectPluginInstancePeer::GetJavaPeer(jref *aJavaPeer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
