/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIPluginManager.idl
 */
...
class NS_SCRIPTABLE nsIPluginManager : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IPLUGINMANAGER_IID)
...
/**
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIPluginManager, NS_IPLUGINMANAGER_IID)
