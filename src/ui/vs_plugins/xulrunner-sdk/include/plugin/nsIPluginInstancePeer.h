/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIPluginInstancePeer.idl
 */
...
class NS_NO_VTABLE nsIPluginInstancePeer : public nsISupports {
 public: 
  ...
  NS_IMETHOD NewStream(nsMIMEType aType, const char *aTarget, nsIOutputStream **aResult) = 0;
...
#define NS_FORWARD_NSIPLUGININSTANCEPEER(_to) \
  ...
  NS_IMETHOD NewStream(nsMIMEType aType, const char *aTarget, nsIOutputStream **aResult) { return _to NewStream(aType, aTarget, aResult); } \
...
#define NS_FORWARD_SAFE_NSIPLUGININSTANCEPEER(_to) \
  ...
  NS_IMETHOD NewStream(nsMIMEType aType, const char *aTarget, nsIOutputStream **aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->NewStream(aType, aTarget, aResult); } \
...
/* void newStream (in nsMIMEType aType, in string aTarget, out nsIOutputStream aResult); */
NS_IMETHODIMP nsPluginInstancePeer::NewStream(nsMIMEType aType, const char *aTarget, nsIOutputStream **aResult)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
