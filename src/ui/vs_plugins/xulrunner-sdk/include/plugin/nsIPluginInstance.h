/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/plugin/base/public/nsIPluginInstance.idl
 */
...
class NS_NO_VTABLE nsIPluginInstance : public nsISupports {
 public: 
  ...
  NS_IMETHOD NewStream(nsIPluginStreamListener **aListener) = 0;
  ...
  NS_IMETHOD HandleEvent(nsPluginEvent * aEvent, PRBool *aHandled) = 0;
...
#define NS_FORWARD_NSIPLUGININSTANCE(_to) \
  ...
  NS_IMETHOD NewStream(nsIPluginStreamListener **aListener) { return _to NewStream(aListener); } \
  ...
  NS_IMETHOD HandleEvent(nsPluginEvent * aEvent, PRBool *aHandled) { return _to HandleEvent(aEvent, aHandled); } 
...
#define NS_FORWARD_SAFE_NSIPLUGININSTANCE(_to) \
  ...
  NS_IMETHOD NewStream(nsIPluginStreamListener **aListener) { return !_to ? NS_ERROR_NULL_POINTER : _to->NewStream(aListener); } \
  ...
  NS_IMETHOD HandleEvent(nsPluginEvent * aEvent, PRBool *aHandled) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEvent(aEvent, aHandled); } 
...
/* void newStream (out nsIPluginStreamListener aListener); */
NS_IMETHODIMP nsPluginInstance::NewStream(nsIPluginStreamListener **aListener)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void handleEvent (in nsPluginEventPtr aEvent, out boolean aHandled); */
NS_IMETHODIMP nsPluginInstance::HandleEvent(nsPluginEvent * aEvent, PRBool *aHandled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
