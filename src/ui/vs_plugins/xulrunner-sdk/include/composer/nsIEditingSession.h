/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/composer/public/nsIEditingSession.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditingSession : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, PRBool *_retval) = 0;

  /**
   *  Get the editor for this window. May return null
   */
  /* nsIEditor getEditorForWindow (in nsIDOMWindow window); */
  NS_SCRIPTABLE NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor **_retval) = 0;
...
#define NS_DECL_NSIEDITINGSESSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor **_retval); \
...
#define NS_FORWARD_NSIEDITINGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, PRBool *_retval) { return _to WindowIsEditable(window, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor **_retval) { return _to GetEditorForWindow(window, _retval); } \
...
#define NS_FORWARD_SAFE_NSIEDITINGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WindowIsEditable(nsIDOMWindow *window, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WindowIsEditable(window, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEditorForWindow(nsIDOMWindow *window, nsIEditor **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEditorForWindow(window, _retval); } \
