/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/js/jsd/idl/jsdIDebuggerService.idl
 */
...
class NS_NO_VTABLE jsdIDebuggerService : public nsISupports {
 public: 
  ...
  NS_IMETHOD WrapValue(const JS::Value & value, jsdIValue * *_retval) = 0;
...
#define NS_DECL_JSDIDEBUGGERSERVICE \
  ...
  NS_IMETHOD WrapValue(const JS::Value & value, jsdIValue * *_retval); \
...
#define NS_FORWARD_JSDIDEBUGGERSERVICE(_to) \
  ...
  NS_IMETHOD WrapValue(const JS::Value & value, jsdIValue * *_retval) { return _to WrapValue(value, _retval); } \
...
#define NS_FORWARD_SAFE_JSDIDEBUGGERSERVICE(_to) \
  ...
  NS_IMETHOD WrapValue(const JS::Value & value, jsdIValue * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WrapValue(value, _retval); } \
...
/* jsdIValue wrapValue (in jsval value); */
NS_IMETHODIMP _MYCLASS_::WrapValue(const JS::Value & value, jsdIValue * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE jsdIFilter : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetGlobalObject(nsISupports * *aGlobalObject) = 0;
  NS_IMETHOD SetGlobalObject(nsISupports *aGlobalObject) = 0;
...
#define NS_DECL_JSDIFILTER \
  NS_IMETHOD GetFlags(uint32_t *aFlags); \
  NS_IMETHOD SetFlags(uint32_t aFlags); \
  NS_IMETHOD GetGlobalObject(nsISupports * *aGlobalObject); \
  NS_IMETHOD SetGlobalObject(nsISupports *aGlobalObject); \
...
#define NS_FORWARD_JSDIFILTER(_to) \
  NS_IMETHOD GetFlags(uint32_t *aFlags) { return _to GetFlags(aFlags); } \
  NS_IMETHOD SetFlags(uint32_t aFlags) { return _to SetFlags(aFlags); } \
  NS_IMETHOD GetGlobalObject(nsISupports * *aGlobalObject) { return _to GetGlobalObject(aGlobalObject); } \
  NS_IMETHOD SetGlobalObject(nsISupports *aGlobalObject) { return _to SetGlobalObject(aGlobalObject); } \
...
#define NS_FORWARD_SAFE_JSDIFILTER(_to) \
  NS_IMETHOD GetFlags(uint32_t *aFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFlags(aFlags); } \
  NS_IMETHOD SetFlags(uint32_t aFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFlags(aFlags); } \
  NS_IMETHOD GetGlobalObject(nsISupports * *aGlobalObject) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGlobalObject(aGlobalObject); } \
  NS_IMETHOD SetGlobalObject(nsISupports *aGlobalObject) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetGlobalObject(aGlobalObject); } \
...
class NS_NO_VTABLE jsdIContext : public jsdIEphemeral {
 public: 
  ...
  NS_IMETHOD SetVersion(int32_t aVersion) = 0;
...
#define NS_DECL_JSDICONTEXT \
  ...
  NS_IMETHOD SetVersion(int32_t aVersion); \
...
#define NS_FORWARD_JSDICONTEXT(_to) \
  ...
  NS_IMETHOD SetVersion(int32_t aVersion) { return _to SetVersion(aVersion); } \
...
#define NS_FORWARD_SAFE_JSDICONTEXT(_to) \
  ...
  NS_IMETHOD SetVersion(int32_t aVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetVersion(aVersion); } \
...
NS_IMETHODIMP _MYCLASS_::SetVersion(int32_t aVersion)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE jsdIScript : public jsdIEphemeral {
 public: 
  ...
  NS_IMETHOD GetParameterNames(uint32_t *count, PRUnichar * **paramNames) = 0;
...
#define NS_DECL_JSDISCRIPT \
  ...
  NS_IMETHOD GetFunctionName(nsACString & aFunctionName); \
  NS_IMETHOD GetParameterNames(uint32_t *count, PRUnichar * **paramNames); \
...
#define NS_FORWARD_JSDISCRIPT(_to) \
  ...
  NS_IMETHOD GetFunctionName(nsACString & aFunctionName) { return _to GetFunctionName(aFunctionName); } \
  NS_IMETHOD GetParameterNames(uint32_t *count, PRUnichar * **paramNames) { return _to GetParameterNames(count, paramNames); } \
...
#define NS_FORWARD_SAFE_JSDISCRIPT(_to) \
  ...
  NS_IMETHOD GetFunctionName(nsACString & aFunctionName) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFunctionName(aFunctionName); } \
  NS_IMETHOD GetParameterNames(uint32_t *count, PRUnichar * **paramNames) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetParameterNames(count, paramNames); } \
...
/* void getParameterNames ([optional] out unsigned long count, [array, size_is (count), retval] out wstring paramNames); */
NS_IMETHODIMP _MYCLASS_::GetParameterNames(uint32_t *count, PRUnichar * **paramNames)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE jsdIValue : public jsdIEphemeral {
 public: 
  ...
  NS_IMETHOD GetWrappedValue(JSContext* cx, JS::Value *_retval) = 0;
...
#define NS_DECL_JSDIVALUE \
  ...
  NS_IMETHOD GetWrappedValue(JSContext* cx, JS::Value *_retval); \
  NS_IMETHOD GetScript(jsdIScript * *aScript); 
...
#define NS_FORWARD_JSDIVALUE(_to) \
  ...
  NS_IMETHOD GetWrappedValue(JSContext* cx, JS::Value *_retval) { return _to GetWrappedValue(cx, _retval); } \
  NS_IMETHOD GetScript(jsdIScript * *aScript) { return _to GetScript(aScript); } 
...
#define NS_FORWARD_SAFE_JSDIVALUE(_to) \
  ...
  NS_IMETHOD GetWrappedValue(JSContext* cx, JS::Value *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWrappedValue(cx, _retval); } \
  NS_IMETHOD GetScript(jsdIScript * *aScript) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScript(aScript); } 
...
/* [implicit_jscontext] jsval getWrappedValue (); */
NS_IMETHODIMP _MYCLASS_::GetWrappedValue(JSContext* cx, JS::Value *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
