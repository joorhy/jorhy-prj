/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsINSSCertCache.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINSSCertCache : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetX509CachedCerts(nsIX509CertList **_retval) = 0;
...
#define NS_DECL_NSINSSCERTCACHE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetX509CachedCerts(nsIX509CertList **_retval); \
...
#define NS_FORWARD_NSINSSCERTCACHE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetX509CachedCerts(nsIX509CertList **_retval) { return _to GetX509CachedCerts(_retval); } \
...
#define NS_FORWARD_SAFE_NSINSSCERTCACHE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetX509CachedCerts(nsIX509CertList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetX509CachedCerts(_retval); } \
