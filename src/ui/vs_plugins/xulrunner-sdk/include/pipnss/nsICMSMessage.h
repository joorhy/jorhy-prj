/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsICMSMessage.idl
 */
...
class NS_NO_VTABLE nsICMSMessage : public nsISupports {
 public: 
  ...
  NS_IMETHOD ContentIsSigned(PRBool *aSigned) = 0;

  /* void contentIsEncrypted (out boolean aEncrypted); */
  NS_IMETHOD ContentIsEncrypted(PRBool *aEncrypted) = 0;
...
#define NS_DECL_NSICMSMESSAGE \
  NS_IMETHOD ContentIsSigned(PRBool *aSigned); \
  NS_IMETHOD ContentIsEncrypted(PRBool *aEncrypted); \
...
#define NS_FORWARD_NSICMSMESSAGE(_to) \
  NS_IMETHOD ContentIsSigned(PRBool *aSigned) { return _to ContentIsSigned(aSigned); } \
  NS_IMETHOD ContentIsEncrypted(PRBool *aEncrypted) { return _to ContentIsEncrypted(aEncrypted); } \
...
#define NS_FORWARD_SAFE_NSICMSMESSAGE(_to) \
  NS_IMETHOD ContentIsSigned(PRBool *aSigned) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContentIsSigned(aSigned); } \
  NS_IMETHOD ContentIsEncrypted(PRBool *aEncrypted) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContentIsEncrypted(aEncrypted); } \
...
/* void contentIsSigned (out boolean aSigned); */
NS_IMETHODIMP nsCMSMessage::ContentIsSigned(PRBool *aSigned)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void contentIsEncrypted (out boolean aEncrypted); */
NS_IMETHODIMP nsCMSMessage::ContentIsEncrypted(PRBool *aEncrypted)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
