/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIX509Cert3.idl
 */
...
#define NS_IX509CERT3_IID_STR "aa67eb02-ccc8-4f55-84da-bcafff9265ae"

#define NS_IX509CERT3_IID \
  {0xaa67eb02, 0xccc8, 0x4f55, \
    { 0x84, 0xda, 0xbc, 0xaf, 0xff, 0x92, 0x65, 0xae }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIX509Cert3 : public nsIX509Cert2 {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ExportAsCMS(PRUint32 chainMode, PRUint32 *length, PRUint8 **data) = 0;
...
#define NS_DECL_NSIX509CERT3 \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExportAsCMS(PRUint32 chainMode, PRUint32 *length, PRUint8 **data); \
...
#define NS_FORWARD_NSIX509CERT3(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExportAsCMS(PRUint32 chainMode, PRUint32 *length, PRUint8 **data) { return _to ExportAsCMS(chainMode, length, data); } \
...
#define NS_FORWARD_SAFE_NSIX509CERT3(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ExportAsCMS(PRUint32 chainMode, PRUint32 *length, PRUint8 **data) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExportAsCMS(chainMode, length, data); } \
...
/* void exportAsCMS (in unsigned long chainMode, out unsigned long length, [array, size_is (length), retval] out octet data); */
NS_IMETHODIMP nsX509Cert3::ExportAsCMS(PRUint32 chainMode, PRUint32 *length, PRUint8 **data)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICertVerificationResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArrayResult(PRUint32 *verified, PRUint32 *count, PRUnichar ***usages) = 0;
...
#define NS_DECL_NSICERTVERIFICATIONRESULT \
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArrayResult(PRUint32 *verified, PRUint32 *count, PRUnichar ***usages); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICERTVERIFICATIONRESULT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArrayResult(PRUint32 *verified, PRUint32 *count, PRUnichar ***usages) { return _to GetUsagesArrayResult(verified, count, usages); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICERTVERIFICATIONRESULT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUsagesArrayResult(PRUint32 *verified, PRUint32 *count, PRUnichar ***usages) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUsagesArrayResult(verified, count, usages); } 
...
/* void getUsagesArrayResult (out PRUint32 verified, out PRUint32 count, [array, size_is (count)] out wstring usages); */
NS_IMETHODIMP nsCertVerificationResult::GetUsagesArrayResult(PRUint32 *verified, PRUint32 *count, PRUnichar ***usages)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
