/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIPK11Token.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPK11Token : public nsISupports {
 public: 
  ...
  /* boolean isLoggedIn (); */
  NS_SCRIPTABLE NS_IMETHOD IsLoggedIn(PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckPassword(const PRUnichar *password, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimes(PRInt32 *_retval) = 0;

  /* long getAskPasswordTimeout (); */
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimeout(PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHardwareToken(PRBool *_retval) = 0;

  /* boolean needsLogin (); */
  NS_SCRIPTABLE NS_IMETHOD NeedsLogin(PRBool *_retval) = 0;

  /* boolean isFriendly (); */
  NS_SCRIPTABLE NS_IMETHOD IsFriendly(PRBool *_retval) = 0;
...
#define NS_DECL_NSIPK11TOKEN \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLoggedIn(PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckPassword(const PRUnichar *password, PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimes(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimeout(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetAskPasswordDefaults(const PRInt32 askTimes, const PRInt32 timeout); \
  NS_SCRIPTABLE NS_IMETHOD IsHardwareToken(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD NeedsLogin(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD IsFriendly(PRBool *_retval); 
...
#define NS_FORWARD_NSIPK11TOKEN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLoggedIn(PRBool *_retval) { return _to IsLoggedIn(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckPassword(const PRUnichar *password, PRBool *_retval) { return _to CheckPassword(password, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimes(PRInt32 *_retval) { return _to GetAskPasswordTimes(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimeout(PRInt32 *_retval) { return _to GetAskPasswordTimeout(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHardwareToken(PRBool *_retval) { return _to IsHardwareToken(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD NeedsLogin(PRBool *_retval) { return _to NeedsLogin(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsFriendly(PRBool *_retval) { return _to IsFriendly(_retval); } 
...
#define NS_FORWARD_SAFE_NSIPK11TOKEN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLoggedIn(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLoggedIn(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckPassword(const PRUnichar *password, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckPassword(password, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimes(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAskPasswordTimes(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAskPasswordTimeout(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAskPasswordTimeout(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsHardwareToken(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsHardwareToken(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD NeedsLogin(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NeedsLogin(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsFriendly(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsFriendly(_retval); } 
