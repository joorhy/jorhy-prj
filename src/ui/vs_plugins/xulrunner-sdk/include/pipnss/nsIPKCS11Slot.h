/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIPKCS11Slot.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPKCS11Slot : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetToken(nsIPK11Token **_retval) = 0;
...
#define NS_DECL_NSIPKCS11SLOT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetToken(nsIPK11Token **_retval); \
...
#define NS_FORWARD_NSIPKCS11SLOT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetToken(nsIPK11Token **_retval) { return _to GetToken(_retval); } \
...
#define NS_FORWARD_SAFE_NSIPKCS11SLOT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetToken(nsIPK11Token **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetToken(_retval); } \
