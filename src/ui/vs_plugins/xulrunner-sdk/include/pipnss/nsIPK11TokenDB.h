/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIPK11TokenDB.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPK11TokenDB : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInternalKeyToken(nsIPK11Token **_retval) = 0;

  /* nsIPK11Token findTokenByName (in wstring tokenName); */
  NS_SCRIPTABLE NS_IMETHOD FindTokenByName(const PRUnichar *tokenName, nsIPK11Token **_retval) = 0;

  /* nsIEnumerator listTokens (); */
  NS_SCRIPTABLE NS_IMETHOD ListTokens(nsIEnumerator **_retval) = 0;
...
#define NS_DECL_NSIPK11TOKENDB \
  NS_SCRIPTABLE NS_IMETHOD GetInternalKeyToken(nsIPK11Token **_retval); \
  NS_SCRIPTABLE NS_IMETHOD FindTokenByName(const PRUnichar *tokenName, nsIPK11Token **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ListTokens(nsIEnumerator **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPK11TOKENDB(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInternalKeyToken(nsIPK11Token **_retval) { return _to GetInternalKeyToken(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindTokenByName(const PRUnichar *tokenName, nsIPK11Token **_retval) { return _to FindTokenByName(tokenName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ListTokens(nsIEnumerator **_retval) { return _to ListTokens(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPK11TOKENDB(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInternalKeyToken(nsIPK11Token **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInternalKeyToken(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindTokenByName(const PRUnichar *tokenName, nsIPK11Token **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindTokenByName(tokenName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ListTokens(nsIEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ListTokens(_retval); } 
