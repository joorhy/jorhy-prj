/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIPKCS11ModuleDB.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPKCS11ModuleDB : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInternal(nsIPKCS11Module **_retval) = 0;

  /* nsIPKCS11Module getInternalFIPS (); */
  NS_SCRIPTABLE NS_IMETHOD GetInternalFIPS(nsIPKCS11Module **_retval) = 0;

  /* nsIPKCS11Module findModuleByName (in wstring name); */
  NS_SCRIPTABLE NS_IMETHOD FindModuleByName(const PRUnichar *name, nsIPKCS11Module **_retval) = 0;

  /* nsIPKCS11Slot findSlotByName (in wstring name); */
  NS_SCRIPTABLE NS_IMETHOD FindSlotByName(const PRUnichar *name, nsIPKCS11Slot **_retval) = 0;

  /* nsIEnumerator listModules (); */
  NS_SCRIPTABLE NS_IMETHOD ListModules(nsIEnumerator **_retval) = 0;
...
#define NS_DECL_NSIPKCS11MODULEDB \
  NS_SCRIPTABLE NS_IMETHOD GetInternal(nsIPKCS11Module **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetInternalFIPS(nsIPKCS11Module **_retval); \
  NS_SCRIPTABLE NS_IMETHOD FindModuleByName(const PRUnichar *name, nsIPKCS11Module **_retval); \
  NS_SCRIPTABLE NS_IMETHOD FindSlotByName(const PRUnichar *name, nsIPKCS11Slot **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ListModules(nsIEnumerator **_retval); \
...
#define NS_FORWARD_NSIPKCS11MODULEDB(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInternal(nsIPKCS11Module **_retval) { return _to GetInternal(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetInternalFIPS(nsIPKCS11Module **_retval) { return _to GetInternalFIPS(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindModuleByName(const PRUnichar *name, nsIPKCS11Module **_retval) { return _to FindModuleByName(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindSlotByName(const PRUnichar *name, nsIPKCS11Slot **_retval) { return _to FindSlotByName(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ListModules(nsIEnumerator **_retval) { return _to ListModules(_retval); } \
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULEDB(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInternal(nsIPKCS11Module **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInternal(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetInternalFIPS(nsIPKCS11Module **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInternalFIPS(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindModuleByName(const PRUnichar *name, nsIPKCS11Module **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindModuleByName(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindSlotByName(const PRUnichar *name, nsIPKCS11Slot **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindSlotByName(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ListModules(nsIEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ListModules(_retval); } \
