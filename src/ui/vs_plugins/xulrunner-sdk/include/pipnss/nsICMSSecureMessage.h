/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsICMSSecureMessage.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICMSSecureMessage : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCertByPrefID(const char *certID, char **_retval) = 0;

  /**
   * decodeCert - decode a BASE64 string into an X509Certificate object
   */
  /* nsIX509Cert decodeCert (in string value); */
  NS_SCRIPTABLE NS_IMETHOD DecodeCert(const char *value, nsIX509Cert **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SendMessage(const char *msg, const char *cert, char **_retval) = 0;

  /**
   * receiveMessage - recieve an encrypted (enveloped) message
   */
  /* string receiveMessage (in string msg); */
  NS_SCRIPTABLE NS_IMETHOD ReceiveMessage(const char *msg, char **_retval) = 0;
...
#define NS_DECL_NSICMSSECUREMESSAGE \
  NS_SCRIPTABLE NS_IMETHOD GetCertByPrefID(const char *certID, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD DecodeCert(const char *value, nsIX509Cert **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SendMessage(const char *msg, const char *cert, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ReceiveMessage(const char *msg, char **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICMSSECUREMESSAGE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCertByPrefID(const char *certID, char **_retval) { return _to GetCertByPrefID(certID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DecodeCert(const char *value, nsIX509Cert **_retval) { return _to DecodeCert(value, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SendMessage(const char *msg, const char *cert, char **_retval) { return _to SendMessage(msg, cert, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ReceiveMessage(const char *msg, char **_retval) { return _to ReceiveMessage(msg, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICMSSECUREMESSAGE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCertByPrefID(const char *certID, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCertByPrefID(certID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DecodeCert(const char *value, nsIX509Cert **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->DecodeCert(value, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SendMessage(const char *msg, const char *cert, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendMessage(msg, cert, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ReceiveMessage(const char *msg, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReceiveMessage(msg, _retval); } 
