/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIProtectedAuthThread.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProtectedAuthThread : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTokenName(nsAString & _retval) = 0;
...
#define NS_DECL_NSIPROTECTEDAUTHTHREAD \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTokenName(nsAString & _retval); 
...
#define NS_FORWARD_NSIPROTECTEDAUTHTHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTokenName(nsAString & _retval) { return _to GetTokenName(_retval); } 
...
#define NS_FORWARD_SAFE_NSIPROTECTEDAUTHTHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTokenName(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTokenName(_retval); } 
