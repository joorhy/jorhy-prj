/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIFormSigningDialog.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFormSigningDialog : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ConfirmSignText(nsIInterfaceRequestor *ctxt, const nsAString & host, const nsAString & signText, const PRUnichar **certNickList, const PRUnichar **certDetailsList, PRUint32 count, PRInt32 *selectedIndex, nsAString & password, PRBool *_retval) = 0;
...
#define NS_DECL_NSIFORMSIGNINGDIALOG \
  NS_SCRIPTABLE NS_IMETHOD ConfirmSignText(nsIInterfaceRequestor *ctxt, const nsAString & host, const nsAString & signText, const PRUnichar **certNickList, const PRUnichar **certDetailsList, PRUint32 count, PRInt32 *selectedIndex, nsAString & password, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFORMSIGNINGDIALOG(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConfirmSignText(nsIInterfaceRequestor *ctxt, const nsAString & host, const nsAString & signText, const PRUnichar **certNickList, const PRUnichar **certDetailsList, PRUint32 count, PRInt32 *selectedIndex, nsAString & password, PRBool *_retval) { return _to ConfirmSignText(ctxt, host, signText, certNickList, certDetailsList, count, selectedIndex, password, _retval); } 
