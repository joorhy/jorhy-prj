/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIX509CertList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIX509CertList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_NSIX509CERTLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsISimpleEnumerator **_retval); \
...
#define NS_FORWARD_NSIX509CERTLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsISimpleEnumerator **_retval) { return _to GetEnumerator(_retval); } \
...
#define NS_FORWARD_SAFE_NSIX509CERTLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnumerator(_retval); } \
