/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsICertTree.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICertTree : public nsITreeView {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCert(PRUint32 index, nsIX509Cert **_retval) = 0;

  /* nsICertTreeItem getTreeItem (in unsigned long index); */
  NS_SCRIPTABLE NS_IMETHOD GetTreeItem(PRUint32 index, nsICertTreeItem **_retval) = 0;

  /* boolean isHostPortOverride (in unsigned long index); */
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, PRBool *_retval) = 0;
...
#define NS_DECL_NSICERTTREE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCert(PRUint32 index, nsIX509Cert **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetTreeItem(PRUint32 index, nsICertTreeItem **_retval); \
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, PRBool *_retval); \
...
#define NS_FORWARD_NSICERTTREE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCert(PRUint32 index, nsIX509Cert **_retval) { return _to GetCert(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTreeItem(PRUint32 index, nsICertTreeItem **_retval) { return _to GetTreeItem(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, PRBool *_retval) { return _to IsHostPortOverride(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSICERTTREE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCert(PRUint32 index, nsIX509Cert **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCert(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTreeItem(PRUint32 index, nsICertTreeItem **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTreeItem(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsHostPortOverride(PRUint32 index, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsHostPortOverride(index, _retval); } \
...
/* nsICertTreeItem getTreeItem (in unsigned long index); */
NS_IMETHODIMP nsCertTree::GetTreeItem(PRUint32 index, nsICertTreeItem **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isHostPortOverride (in unsigned long index); */
NS_IMETHODIMP nsCertTree::IsHostPortOverride(PRUint32 index, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
