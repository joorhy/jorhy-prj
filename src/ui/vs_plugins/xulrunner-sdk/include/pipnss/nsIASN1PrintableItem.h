/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIASN1PrintableItem.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIASN1PrintableItem : public nsIASN1Object {
 public: 
  ...
  NS_IMETHOD GetData(char * *data, PRUint32 *len) = 0;
...
#define NS_DECL_NSIASN1PRINTABLEITEM \
  ...
  NS_IMETHOD GetData(char * *data, PRUint32 *len); 
...
#define NS_FORWARD_NSIASN1PRINTABLEITEM(_to) \
  ...
  NS_IMETHOD GetData(char * *data, PRUint32 *len) { return _to GetData(data, len); } 
...
#define NS_FORWARD_SAFE_NSIASN1PRINTABLEITEM(_to) \
  ...
  NS_IMETHOD GetData(char * *data, PRUint32 *len) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetData(data, len); } 
...
/* [noscript] void getData (out charPtr data, out unsigned long len); */
NS_IMETHODIMP nsASN1PrintableItem::GetData(char * *data, PRUint32 *len)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
