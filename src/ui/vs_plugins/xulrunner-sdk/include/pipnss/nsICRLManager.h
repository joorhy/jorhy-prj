/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsICRLManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICRLManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar *url, const PRUnichar *key, PRBool *_retval) = 0;

  /* nsIArray getCrls (); */
  NS_SCRIPTABLE NS_IMETHOD GetCrls(nsIArray **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ComputeNextAutoUpdateTime(nsICRLInfo *info, PRUint32 autoUpdateType, double noOfDays, PRUnichar **_retval) = 0;
...
#define NS_DECL_NSICRLMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar *url, const PRUnichar *key, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetCrls(nsIArray **_retval); \
  NS_SCRIPTABLE NS_IMETHOD DeleteCrl(PRUint32 crlIndex); \
  NS_SCRIPTABLE NS_IMETHOD RescheduleCRLAutoUpdate(void); \
  NS_SCRIPTABLE NS_IMETHOD ComputeNextAutoUpdateTime(nsICRLInfo *info, PRUint32 autoUpdateType, double noOfDays, PRUnichar **_retval); 
...
#define NS_FORWARD_NSICRLMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar *url, const PRUnichar *key, PRBool *_retval) { return _to UpdateCRLFromURL(url, key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCrls(nsIArray **_retval) { return _to GetCrls(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ComputeNextAutoUpdateTime(nsICRLInfo *info, PRUint32 autoUpdateType, double noOfDays, PRUnichar **_retval) { return _to ComputeNextAutoUpdateTime(info, autoUpdateType, noOfDays, _retval); } 
...
#define NS_FORWARD_SAFE_NSICRLMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateCRLFromURL(const PRUnichar *url, const PRUnichar *key, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->UpdateCRLFromURL(url, key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCrls(nsIArray **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCrls(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ComputeNextAutoUpdateTime(nsICRLInfo *info, PRUint32 autoUpdateType, double noOfDays, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ComputeNextAutoUpdateTime(info, autoUpdateType, noOfDays, _retval); } 
...
/* boolean updateCRLFromURL (in wstring url, in wstring key); */
NS_IMETHODIMP nsCRLManager::UpdateCRLFromURL(const PRUnichar *url, const PRUnichar *key, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* wstring computeNextAutoUpdateTime (in nsICRLInfo info, in unsigned long autoUpdateType, in double noOfDays); */
NS_IMETHODIMP nsCRLManager::ComputeNextAutoUpdateTime(nsICRLInfo *info, PRUint32 autoUpdateType, double noOfDays, PRUnichar **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
