/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIX509CertDB2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIX509CertDB2 : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCerts(nsIX509CertList **_retval) = 0;
...
#define NS_DECL_NSIX509CERTDB2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCerts(nsIX509CertList **_retval); 
...
#define NS_FORWARD_NSIX509CERTDB2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCerts(nsIX509CertList **_retval) { return _to GetCerts(_retval); } 
...
#define NS_FORWARD_SAFE_NSIX509CERTDB2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCerts(nsIX509CertList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCerts(_retval); } 
...
/* nsIX509CertList getCerts (); */
NS_IMETHODIMP nsX509CertDB2::GetCerts(nsIX509CertList **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
