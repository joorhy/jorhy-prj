/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsICipherInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICipherInfoService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCipherInfoByPrefString(const nsACString & aPrefString, nsICipherInfo **_retval) = 0;
...
#define NS_DECL_NSICIPHERINFOSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetCipherInfoByPrefString(const nsACString & aPrefString, nsICipherInfo **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICIPHERINFOSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCipherInfoByPrefString(const nsACString & aPrefString, nsICipherInfo **_retval) { return _to GetCipherInfoByPrefString(aPrefString, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICIPHERINFOSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCipherInfoByPrefString(const nsACString & aPrefString, nsICipherInfo **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCipherInfoByPrefString(aPrefString, _retval); } 
...
/* nsICipherInfo getCipherInfoByPrefString (in ACString aPrefString); */
NS_IMETHODIMP nsCipherInfoService::GetCipherInfoByPrefString(const nsACString & aPrefString, nsICipherInfo **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
