/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIKeygenThread.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIKeygenThread : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(PRBool *threadAlreadyClosedDialog) = 0;
...
#define NS_DECL_NSIKEYGENTHREAD \
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(PRBool *threadAlreadyClosedDialog); 
...
#define NS_FORWARD_NSIKEYGENTHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(PRBool *threadAlreadyClosedDialog) { return _to UserCanceled(threadAlreadyClosedDialog); } 
...
#define NS_FORWARD_SAFE_NSIKEYGENTHREAD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UserCanceled(PRBool *threadAlreadyClosedDialog) { return !_to ? NS_ERROR_NULL_POINTER : _to->UserCanceled(threadAlreadyClosedDialog); } 
