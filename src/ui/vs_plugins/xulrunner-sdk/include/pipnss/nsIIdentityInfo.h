/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIIdentityInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIdentityInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValidEVPolicyOid(nsACString & _retval) = 0;
...
#define NS_DECL_NSIIDENTITYINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValidEVPolicyOid(nsACString & _retval); 
...
#define NS_FORWARD_NSIIDENTITYINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValidEVPolicyOid(nsACString & _retval) { return _to GetValidEVPolicyOid(_retval); } 
...
#define NS_FORWARD_SAFE_NSIIDENTITYINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValidEVPolicyOid(nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValidEVPolicyOid(_retval); } 
