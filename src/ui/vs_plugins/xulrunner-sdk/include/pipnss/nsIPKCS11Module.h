/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIPKCS11Module.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPKCS11Module : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ListSlots(nsIEnumerator **_retval) = 0;
...
#define NS_DECL_NSIPKCS11MODULE \
  ...
  NS_SCRIPTABLE NS_IMETHOD ListSlots(nsIEnumerator **_retval); 
...
#define NS_FORWARD_NSIPKCS11MODULE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ListSlots(nsIEnumerator **_retval) { return _to ListSlots(_retval); } 
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ListSlots(nsIEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ListSlots(_retval); } 
...
/* nsIPKCS11Slot findSlotByName (in wstring name); */
NS_IMETHODIMP nsPKCS11Module::FindSlotByName(const PRUnichar *name, nsIPKCS11Slot **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
