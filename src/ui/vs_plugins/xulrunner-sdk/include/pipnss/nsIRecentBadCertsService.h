/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/ssl/public/nsIRecentBadCertsService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRecentBadCertsService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRecentBadCert(const nsAString & aHostNameWithPort, nsISSLStatus **_retval) = 0;
...
#define NS_DECL_NSIRECENTBADCERTSSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetRecentBadCert(const nsAString & aHostNameWithPort, nsISSLStatus **_retval); \
...
#define NS_FORWARD_NSIRECENTBADCERTSSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRecentBadCert(const nsAString & aHostNameWithPort, nsISSLStatus **_retval) { return _to GetRecentBadCert(aHostNameWithPort, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRECENTBADCERTSSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRecentBadCert(const nsAString & aHostNameWithPort, nsISSLStatus **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRecentBadCert(aHostNameWithPort, _retval); } \
...
/* nsISSLStatus getRecentBadCert (in AString aHostNameWithPort); */
NS_IMETHODIMP nsRecentBadCertsService::GetRecentBadCert(const nsAString & aHostNameWithPort, nsISSLStatus **_retval)
{
