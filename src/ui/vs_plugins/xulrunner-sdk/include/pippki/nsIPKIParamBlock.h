/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/pki/public/nsIPKIParamBlock.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPKIParamBlock : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetISupportAtIndex(PRInt32 index, nsISupports **_retval) = 0;
...
#define NS_DECL_NSIPKIPARAMBLOCK \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetISupportAtIndex(PRInt32 index, nsISupports **_retval); 
...
#define NS_FORWARD_NSIPKIPARAMBLOCK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetISupportAtIndex(PRInt32 index, nsISupports **_retval) { return _to GetISupportAtIndex(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPKIPARAMBLOCK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetISupportAtIndex(PRInt32 index, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetISupportAtIndex(index, _retval); } 
...
/* nsISupports getISupportAtIndex (in long index); */
NS_IMETHODIMP nsPKIParamBlock::GetISupportAtIndex(PRInt32 index, nsISupports **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
