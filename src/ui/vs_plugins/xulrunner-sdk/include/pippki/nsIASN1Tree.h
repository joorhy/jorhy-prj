/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/security/manager/pki/public/nsIASN1Tree.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIASN1Tree : public nsITreeView {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval) = 0;
...
#define NS_DECL_NSIASN1TREE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval); 
...
#define NS_FORWARD_NSIASN1TREE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval) { return _to GetDisplayData(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIASN1TREE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayData(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDisplayData(index, _retval); } 
...
/* AString getDisplayData (in unsigned long index); */
NS_IMETHODIMP nsASN1Tree::GetDisplayData(PRUint32 index, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
