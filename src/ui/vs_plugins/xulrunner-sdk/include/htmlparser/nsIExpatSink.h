/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/parser/htmlparser/public/nsIExpatSink.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExpatSink : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReportError(const PRUnichar *aErrorText, const PRUnichar *aSourceText, nsIScriptError *aError, PRBool *_retval) = 0;
...
#define NS_DECL_NSIEXPATSINK \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReportError(const PRUnichar *aErrorText, const PRUnichar *aSourceText, nsIScriptError *aError, PRBool *_retval); 
...
#define NS_FORWARD_NSIEXPATSINK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReportError(const PRUnichar *aErrorText, const PRUnichar *aSourceText, nsIScriptError *aError, PRBool *_retval) { return _to ReportError(aErrorText, aSourceText, aError, _retval); } 
...
#define NS_FORWARD_SAFE_NSIEXPATSINK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReportError(const PRUnichar *aErrorText, const PRUnichar *aSourceText, nsIScriptError *aError, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReportError(aErrorText, aSourceText, aError, _retval); } 
...
/* boolean ReportError (in wstring aErrorText, in wstring aSourceText, in nsIScriptError aError); */
NS_IMETHODIMP nsExpatSink::ReportError(const PRUnichar *aErrorText, const PRUnichar *aSourceText, nsIScriptError *aError, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
