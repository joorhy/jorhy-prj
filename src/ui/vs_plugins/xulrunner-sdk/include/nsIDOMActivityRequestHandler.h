/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/activities/interfaces/nsIDOMActivityRequestHandler.idl
 */
...
class NS_NO_VTABLE nsIDOMMozActivityRequestHandler : public nsISupports {
 public: 
  ...
  NS_IMETHOD PostResult(const JS::Value & result) = 0;
...
#define NS_DECL_NSIDOMMOZACTIVITYREQUESTHANDLER \
  NS_IMETHOD PostResult(const JS::Value & result); \
...
#define NS_FORWARD_NSIDOMMOZACTIVITYREQUESTHANDLER(_to) \
  NS_IMETHOD PostResult(const JS::Value & result) { return _to PostResult(result); } \
...
#define NS_FORWARD_SAFE_NSIDOMMOZACTIVITYREQUESTHANDLER(_to) \
  NS_IMETHOD PostResult(const JS::Value & result) { return !_to ? NS_ERROR_NULL_POINTER : _to->PostResult(result); } \
...
/* void postResult (in jsval result); */
NS_IMETHODIMP nsDOMMozActivityRequestHandler::PostResult(const JS::Value & result)
{
