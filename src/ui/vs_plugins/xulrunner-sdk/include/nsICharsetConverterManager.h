/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/intl/uconv/idl/nsICharsetConverterManager.idl
 */
...
class NS_NO_VTABLE nsICharsetConverterManager : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval) = 0;
...
#define NS_DECL_NSICHARSETCONVERTERMANAGER \
  ...
  NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval); \
...
#define NS_FORWARD_NSICHARSETCONVERTERMANAGER(_to) \
  ...
  NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval) { return _to GetCharsetData(aCharset, aProp, _retval); } \
...
#define NS_FORWARD_SAFE_NSICHARSETCONVERTERMANAGER(_to) \
  ...
  NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetData(aCharset, aProp, _retval); } \
...
/* AString getCharsetData (in string aCharset, in wstring aProp); */
NS_IMETHODIMP nsCharsetConverterManager::GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
