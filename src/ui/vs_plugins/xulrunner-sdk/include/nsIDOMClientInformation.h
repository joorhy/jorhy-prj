/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMClientInformation.idl
 */
...
class NS_NO_VTABLE nsIDOMClientInformation : public nsISupports {
 public: 
  ...
  NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval) = 0;
...
#define NS_DECL_NSIDOMCLIENTINFORMATION \
  ...
  NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval); 
...
#define NS_FORWARD_NSIDOMCLIENTINFORMATION(_to) \
  ...
  NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval) { return _to MozIsLocallyAvailable(uri, whenOffline, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMCLIENTINFORMATION(_to) \
  ...
  NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozIsLocallyAvailable(uri, whenOffline, _retval); } 
...
/* boolean mozIsLocallyAvailable (in DOMString uri, in boolean whenOffline); */
NS_IMETHODIMP nsDOMClientInformation::MozIsLocallyAvailable(const nsAString & uri, bool whenOffline, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
