/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/html/nsIDOMHTMLTableElement.idl
 */
...
#define NS_IDOMHTMLTABLEELEMENT_IID_STR "ae50de74-bc26-402e-85dc-a980f506b655"

#define NS_IDOMHTMLTABLEELEMENT_IID \
  {0xae50de74, 0xbc26, 0x402e, \
    { 0x85, 0xdc, 0xa9, 0x80, 0xf5, 0x06, 0xb6, 0x55 }}
...
/* nsIDOMHTMLElement insertRow (in long index) raises (DOMException); */
NS_IMETHODIMP nsDOMHTMLTableElement::InsertRow(int32_t index, nsIDOMHTMLElement * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void deleteRow (in long index) raises (DOMException); */
NS_IMETHODIMP nsDOMHTMLTableElement::DeleteRow(int32_t index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
