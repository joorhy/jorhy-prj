/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/storage/public/mozIStorageProgressHandler.idl
 */
...
class NS_NO_VTABLE mozIStorageProgressHandler : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnProgress(mozIStorageConnection *aConnection, bool *_retval) = 0;
...
#define NS_DECL_MOZISTORAGEPROGRESSHANDLER \
  NS_IMETHOD OnProgress(mozIStorageConnection *aConnection, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISTORAGEPROGRESSHANDLER(_to) \
  NS_IMETHOD OnProgress(mozIStorageConnection *aConnection, bool *_retval) { return _to OnProgress(aConnection, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISTORAGEPROGRESSHANDLER(_to) \
  NS_IMETHOD OnProgress(mozIStorageConnection *aConnection, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnProgress(aConnection, _retval); } 
...
/* boolean onProgress (in mozIStorageConnection aConnection); */
NS_IMETHODIMP _MYCLASS_::OnProgress(mozIStorageConnection *aConnection, bool *_retval)
{
