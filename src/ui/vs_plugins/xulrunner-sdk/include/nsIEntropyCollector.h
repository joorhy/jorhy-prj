/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/base/nsIEntropyCollector.idl
 */
...
class NS_NO_VTABLE nsIEntropyCollector : public nsISupports {
 public: 
  ...
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen) = 0;
...
#define NS_DECL_NSIENTROPYCOLLECTOR \
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIENTROPYCOLLECTOR(_to) \
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen) { return _to RandomUpdate(entropy, bufLen); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIENTROPYCOLLECTOR(_to) \
  NS_IMETHOD RandomUpdate(void *entropy, int32_t bufLen) { return !_to ? NS_ERROR_NULL_POINTER : _to->RandomUpdate(entropy, bufLen); } 
...
/* void randomUpdate (in buffer entropy, in long bufLen); */
NS_IMETHODIMP nsEntropyCollector::RandomUpdate(void *entropy, int32_t bufLen)
{
