/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/satchel/public/nsIFormHistory.idl
 */
...
#define NS_IFORMHISTORY2_IID_STR "a61f0a62-ae0a-4382-b474-d259442ca80c"
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFormHistory2 : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD NameExists(const nsAString & name, PRBool *_retval) = 0;

  /**
   * Gets whether a name and value pair exists in the form history.
   */
  /* boolean entryExists (in AString name, in AString value); */
  NS_SCRIPTABLE NS_IMETHOD EntryExists(const nsAString & name, const nsAString & value, PRBool *_retval) = 0;
...
#define NS_DECL_NSIFORMHISTORY2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameExists(const nsAString & name, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD EntryExists(const nsAString & name, const nsAString & value, PRBool *_retval); 
...
#define NS_FORWARD_NSIFORMHISTORY2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameExists(const nsAString & name, PRBool *_retval) { return _to NameExists(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EntryExists(const nsAString & name, const nsAString & value, PRBool *_retval) { return _to EntryExists(name, value, _retval); } 
...
#define NS_FORWARD_SAFE_NSIFORMHISTORY2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameExists(const nsAString & name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NameExists(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EntryExists(const nsAString & name, const nsAString & value, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EntryExists(name, value, _retval); } 
...
/* boolean nameExists (in AString name); */
NS_IMETHODIMP nsFormHistory2::NameExists(const nsAString & name, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean entryExists (in AString name, in AString value); */
NS_IMETHODIMP nsFormHistory2::EntryExists(const nsAString & name, const nsAString & value, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
