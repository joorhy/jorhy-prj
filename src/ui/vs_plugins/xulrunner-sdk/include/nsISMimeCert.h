/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsISMimeCert.idl
 */
...
class NS_NO_VTABLE nsISMimeCert : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ISMIMECERT_IID)

  /* void saveSMimeProfile (); */
  NS_IMETHOD SaveSMimeProfile(void) = 0;
...
#define NS_DECL_NSISMIMECERT \
  NS_IMETHOD SaveSMimeProfile(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISMIMECERT(_to) \
  NS_IMETHOD SaveSMimeProfile(void) { return _to SaveSMimeProfile(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISMIMECERT(_to) \
  NS_IMETHOD SaveSMimeProfile(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->SaveSMimeProfile(); } 
