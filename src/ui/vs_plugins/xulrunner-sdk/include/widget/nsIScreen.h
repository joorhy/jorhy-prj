/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIScreen.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScreen : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height) = 0;

  /* void GetAvailRect (out long left, out long top, out long width, out long height); */
  NS_SCRIPTABLE NS_IMETHOD GetAvailRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height) = 0;
...
#define NS_DECL_NSISCREEN \
  NS_SCRIPTABLE NS_IMETHOD GetRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height); \
  NS_SCRIPTABLE NS_IMETHOD GetAvailRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height); \
...
#define NS_FORWARD_NSISCREEN(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height) { return _to GetRect(left, top, width, height); } \
  NS_SCRIPTABLE NS_IMETHOD GetAvailRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height) { return _to GetAvailRect(left, top, width, height); } \
...
#define NS_FORWARD_SAFE_NSISCREEN(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRect(left, top, width, height); } \
  NS_SCRIPTABLE NS_IMETHOD GetAvailRect(PRInt32 *left, PRInt32 *top, PRInt32 *width, PRInt32 *height) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAvailRect(left, top, width, height); } \
