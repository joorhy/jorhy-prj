/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIPrintOptions.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrintOptions : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreatePrintSettings(nsIPrintSettings **_retval) = 0;

  /**
   * Get a prefixed integer pref 
   */
  /* PRInt32 getPrinterPrefInt (in nsIPrintSettings aPrintSettings, in wstring aPrefName); */
  NS_SCRIPTABLE NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const PRUnichar *aPrefName, PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar *aPrinter, nsIPrintSettings *aPrintSettings, PRBool *aDisplayed) = 0;
...
#define NS_DECL_NSIPRINTOPTIONS \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreatePrintSettings(nsIPrintSettings **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const PRUnichar *aPrefName, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar *aPrinter, nsIPrintSettings *aPrintSettings, PRBool *aDisplayed); \
...
#define NS_FORWARD_NSIPRINTOPTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreatePrintSettings(nsIPrintSettings **_retval) { return _to CreatePrintSettings(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const PRUnichar *aPrefName, PRInt32 *_retval) { return _to GetPrinterPrefInt(aPrintSettings, aPrefName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar *aPrinter, nsIPrintSettings *aPrintSettings, PRBool *aDisplayed) { return _to DisplayJobProperties(aPrinter, aPrintSettings, aDisplayed); } \
...
#define NS_FORWARD_SAFE_NSIPRINTOPTIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreatePrintSettings(nsIPrintSettings **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreatePrintSettings(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrinterPrefInt(nsIPrintSettings *aPrintSettings, const PRUnichar *aPrefName, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrinterPrefInt(aPrintSettings, aPrefName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DisplayJobProperties(const PRUnichar *aPrinter, nsIPrintSettings *aPrintSettings, PRBool *aDisplayed) { return !_to ? NS_ERROR_NULL_POINTER : _to->DisplayJobProperties(aPrinter, aPrintSettings, aDisplayed); } \
