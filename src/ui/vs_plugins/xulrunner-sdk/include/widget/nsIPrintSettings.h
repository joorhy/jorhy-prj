/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIPrintSettings.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrintSettings : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, PRBool *_retval) = 0;

  /**
   * Set PrintOptions Bit field
   */
  /* PRInt32 GetPrintOptionsBits (); */
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptionsBits(PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEffectivePageSize(double *aWidth, double *aHeight) = 0;

  /**
   * Makes a new copy
   */
  /* nsIPrintSettings clone (); */
  NS_SCRIPTABLE NS_IMETHOD Clone(nsIPrintSettings **_retval) = 0;
...
#define NS_DECL_NSIPRINTSETTINGS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptionsBits(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetEffectivePageSize(double *aWidth, double *aHeight); \
  NS_SCRIPTABLE NS_IMETHOD Clone(nsIPrintSettings **_retval); \
...
#define NS_FORWARD_NSIPRINTSETTINGS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, PRBool *_retval) { return _to GetPrintOptions(aType, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptionsBits(PRInt32 *_retval) { return _to GetPrintOptionsBits(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEffectivePageSize(double *aWidth, double *aHeight) { return _to GetEffectivePageSize(aWidth, aHeight); } \
  NS_SCRIPTABLE NS_IMETHOD Clone(nsIPrintSettings **_retval) { return _to Clone(_retval); } \
...
#define NS_FORWARD_SAFE_NSIPRINTSETTINGS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptions(PRInt32 aType, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintOptions(aType, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrintOptionsBits(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrintOptionsBits(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEffectivePageSize(double *aWidth, double *aHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEffectivePageSize(aWidth, aHeight); } \
  NS_SCRIPTABLE NS_IMETHOD Clone(nsIPrintSettings **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Clone(_retval); } \
