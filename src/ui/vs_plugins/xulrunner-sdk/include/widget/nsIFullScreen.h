/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIFullScreen.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFullScreen : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_NSIFULLSCREEN \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval); 
...
#define NS_FORWARD_NSIFULLSCREEN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval) { return _to GetChromeItems(_retval); } 
...
#define NS_FORWARD_SAFE_NSIFULLSCREEN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetChromeItems(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetChromeItems(_retval); } 
