/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIClipboard.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIClipboard : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char **aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(PRBool *_retval) = 0;
...
#define NS_DECL_NSICLIPBOARD \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char **aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(PRBool *_retval); 
...
#define NS_FORWARD_NSICLIPBOARD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char **aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, PRBool *_retval) { return _to HasDataMatchingFlavors(aFlavorList, aLength, aWhichClipboard, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(PRBool *_retval) { return _to SupportsSelectionClipboard(_retval); } 
...
#define NS_FORWARD_SAFE_NSICLIPBOARD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasDataMatchingFlavors(const char **aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasDataMatchingFlavors(aFlavorList, aLength, aWhichClipboard, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SupportsSelectionClipboard(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SupportsSelectionClipboard(_retval); } 
...
/* boolean hasDataMatchingFlavors ([array, size_is (aLength)] in string aFlavorList, in unsigned long aLength, in long aWhichClipboard); */
NS_IMETHODIMP nsClipboard::HasDataMatchingFlavors(const char **aFlavorList, PRUint32 aLength, PRInt32 aWhichClipboard, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
