/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIBidiKeyboard.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBidiKeyboard : public nsISupports {
 public: 
   ...
   */
  /* boolean isLangRTL (); */
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(PRBool *_retval) = 0;
...
#define NS_DECL_NSIBIDIKEYBOARD \
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetLangFromBidiLevel(PRUint8 aLevel); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIBIDIKEYBOARD(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(PRBool *_retval) { return _to IsLangRTL(_retval); } \
...
#define NS_FORWARD_SAFE_NSIBIDIKEYBOARD(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsLangRTL(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLangRTL(_retval); } \
...
/* boolean isLangRTL (); */
NS_IMETHODIMP nsBidiKeyboard::IsLangRTL(PRBool *_retval)
{
