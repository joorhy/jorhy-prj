/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIRollupListener.idl
 */
...
class NS_NO_VTABLE nsIRollupListener : public nsISupports {
 public: 
   ...
   */
  /* nsIContent Rollup (); */
  NS_IMETHOD Rollup(nsIContent **_retval) = 0;
...
#define NS_DECL_NSIROLLUPLISTENER \
  NS_IMETHOD Rollup(nsIContent **_retval); \
...
#define NS_FORWARD_NSIROLLUPLISTENER(_to) \
  NS_IMETHOD Rollup(nsIContent **_retval) { return _to Rollup(_retval); } \
...
#define NS_FORWARD_SAFE_NSIROLLUPLISTENER(_to) \
  NS_IMETHOD Rollup(nsIContent **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Rollup(_retval); } \
...
/* nsIContent Rollup (); */
NS_IMETHODIMP nsRollupListener::Rollup(nsIContent **_retval)
{
