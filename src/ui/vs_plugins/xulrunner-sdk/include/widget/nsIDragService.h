/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIDragService.idl
 */
...
class nsIDOMMouseEvent; /* forward declaration */

class nsISelection; /* forward declaration */


/* starting interface:    nsIDragService */
#define NS_IDRAGSERVICE_IID_STR "034c44a4-604b-44a2-9205-676d5135f359"

#define NS_IDRAGSERVICE_IID \
  {0x034c44a4, 0x604b, 0x44a2, \
    { 0x92, 0x05, 0x67, 0x6d, 0x51, 0x35, 0xf3, 0x59 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDragService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithImage(nsIDOMNode *aDOMNode, nsISupportsArray *aTransferableArray, nsIScriptableRegion *aRegion, PRUint32 aActionType, nsIDOMNode *aImage, PRInt32 aImageX, PRInt32 aImageY, nsIDOMMouseEvent *aDragEvent) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithSelection(nsISelection *aSelection, nsISupportsArray *aTransferableArray, PRUint32 aActionType, nsIDOMMouseEvent *aDragEvent) = 0;

  /**
    * Returns the current Drag Session  
    */
  /* nsIDragSession getCurrentSession (); */
  NS_SCRIPTABLE NS_IMETHOD GetCurrentSession(nsIDragSession **_retval) = 0;
...
#define NS_DECL_NSIDRAGSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithImage(nsIDOMNode *aDOMNode, nsISupportsArray *aTransferableArray, nsIScriptableRegion *aRegion, PRUint32 aActionType, nsIDOMNode *aImage, PRInt32 aImageX, PRInt32 aImageY, nsIDOMMouseEvent *aDragEvent); \
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithSelection(nsISelection *aSelection, nsISupportsArray *aTransferableArray, PRUint32 aActionType, nsIDOMMouseEvent *aDragEvent); \
  NS_SCRIPTABLE NS_IMETHOD GetCurrentSession(nsIDragSession **_retval); \
...
#define NS_FORWARD_NSIDRAGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithImage(nsIDOMNode *aDOMNode, nsISupportsArray *aTransferableArray, nsIScriptableRegion *aRegion, PRUint32 aActionType, nsIDOMNode *aImage, PRInt32 aImageX, PRInt32 aImageY, nsIDOMMouseEvent *aDragEvent) { return _to InvokeDragSessionWithImage(aDOMNode, aTransferableArray, aRegion, aActionType, aImage, aImageX, aImageY, aDragEvent); } \
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithSelection(nsISelection *aSelection, nsISupportsArray *aTransferableArray, PRUint32 aActionType, nsIDOMMouseEvent *aDragEvent) { return _to InvokeDragSessionWithSelection(aSelection, aTransferableArray, aActionType, aDragEvent); } \
  NS_SCRIPTABLE NS_IMETHOD GetCurrentSession(nsIDragSession **_retval) { return _to GetCurrentSession(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDRAGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithImage(nsIDOMNode *aDOMNode, nsISupportsArray *aTransferableArray, nsIScriptableRegion *aRegion, PRUint32 aActionType, nsIDOMNode *aImage, PRInt32 aImageX, PRInt32 aImageY, nsIDOMMouseEvent *aDragEvent) { return !_to ? NS_ERROR_NULL_POINTER : _to->InvokeDragSessionWithImage(aDOMNode, aTransferableArray, aRegion, aActionType, aImage, aImageX, aImageY, aDragEvent); } \
  NS_SCRIPTABLE NS_IMETHOD InvokeDragSessionWithSelection(nsISelection *aSelection, nsISupportsArray *aTransferableArray, PRUint32 aActionType, nsIDOMMouseEvent *aDragEvent) { return !_to ? NS_ERROR_NULL_POINTER : _to->InvokeDragSessionWithSelection(aSelection, aTransferableArray, aActionType, aDragEvent); } \
  NS_SCRIPTABLE NS_IMETHOD GetCurrentSession(nsIDragSession **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurrentSession(_retval); } \
...
/* void invokeDragSessionWithImage (in nsIDOMNode aDOMNode, in nsISupportsArray aTransferableArray, in nsIScriptableRegion aRegion, in unsigned long aActionType, in nsIDOMNode aImage, in long aImageX, in long aImageY, in nsIDOMMouseEvent aDragEvent); */
NS_IMETHODIMP nsDragService::InvokeDragSessionWithImage(nsIDOMNode *aDOMNode, nsISupportsArray *aTransferableArray, nsIScriptableRegion *aRegion, PRUint32 aActionType, nsIDOMNode *aImage, PRInt32 aImageX, PRInt32 aImageY, nsIDOMMouseEvent *aDragEvent)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void invokeDragSessionWithSelection (in nsISelection aSelection, in nsISupportsArray aTransferableArray, in unsigned long aActionType, in nsIDOMMouseEvent aDragEvent); */
NS_IMETHODIMP nsDragService::InvokeDragSessionWithSelection(nsISelection *aSelection, nsISupportsArray *aTransferableArray, PRUint32 aActionType, nsIDOMMouseEvent *aDragEvent)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
