/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIDragSession.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDragSession : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char *aDataFlavor, PRBool *_retval) = 0;
...
#define NS_DECL_NSIDRAGSESSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char *aDataFlavor, PRBool *_retval); 
...
#define NS_FORWARD_NSIDRAGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char *aDataFlavor, PRBool *_retval) { return _to IsDataFlavorSupported(aDataFlavor, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDRAGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDataFlavorSupported(const char *aDataFlavor, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsDataFlavorSupported(aDataFlavor, _retval); } 
