/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/widget/public/nsIFilePicker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFilePicker : public nsISupports {
  ...
  */
  /* short show (); */
  NS_SCRIPTABLE NS_IMETHOD Show(PRInt16 *_retval) = 0;
...
#define NS_DECL_NSIFILEPICKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Show(PRInt16 *_retval); 
...
#define NS_FORWARD_NSIFILEPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Show(PRInt16 *_retval) { return _to Show(_retval); } 
...
#define NS_FORWARD_SAFE_NSIFILEPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Show(PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Show(_retval); } 
