/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/components/startup/public/nsIUserInfo.idl
 */
...
class NS_NO_VTABLE nsIUserInfo : public nsISupports {
 public: 
...
#define NS_DECL_NSIUSERINFO \
  ...
  NS_IMETHOD GetEmailAddress(char * *aEmailAddress); \
  NS_IMETHOD GetUsername(char * *aUsername); \
  NS_IMETHOD GetDomain(char * *aDomain); 
...
#define NS_FORWARD_NSIUSERINFO(_to) \
  ...
  NS_IMETHOD GetEmailAddress(char * *aEmailAddress) { return _to GetEmailAddress(aEmailAddress); } \
  NS_IMETHOD GetUsername(char * *aUsername) { return _to GetUsername(aUsername); } \
  NS_IMETHOD GetDomain(char * *aDomain) { return _to GetDomain(aDomain); } 
...
#define NS_FORWARD_SAFE_NSIUSERINFO(_to) \
  ...
  NS_IMETHOD GetEmailAddress(char * *aEmailAddress) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEmailAddress(aEmailAddress); } \
  NS_IMETHOD GetUsername(char * *aUsername) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUsername(aUsername); } \
  NS_IMETHOD GetDomain(char * *aDomain) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDomain(aDomain); } 
