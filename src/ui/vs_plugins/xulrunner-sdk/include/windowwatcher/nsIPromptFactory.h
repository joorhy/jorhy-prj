/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/components/windowwatcher/public/nsIPromptFactory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPromptFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void * *result) = 0;
...
#define NS_DECL_NSIPROMPTFACTORY \
  NS_SCRIPTABLE NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void * *result); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROMPTFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void * *result) { return _to GetPrompt(aParent, iid, result); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROMPTFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetPrompt(nsIDOMWindow *aParent, const nsIID & iid, void * *result) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrompt(aParent, iid, result); } 
