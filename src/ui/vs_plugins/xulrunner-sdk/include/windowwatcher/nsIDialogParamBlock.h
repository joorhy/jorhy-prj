/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/components/windowwatcher/public/nsIDialogParamBlock.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDialogParamBlock : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetInt(PRInt32 inIndex, PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetString(PRInt32 inIndex, PRUnichar **_retval) = 0;
...
#define NS_DECL_NSIDIALOGPARAMBLOCK \
  NS_SCRIPTABLE NS_IMETHOD GetInt(PRInt32 inIndex, PRInt32 *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetString(PRInt32 inIndex, PRUnichar **_retval); \
...
#define NS_FORWARD_NSIDIALOGPARAMBLOCK(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInt(PRInt32 inIndex, PRInt32 *_retval) { return _to GetInt(inIndex, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetString(PRInt32 inIndex, PRUnichar **_retval) { return _to GetString(inIndex, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDIALOGPARAMBLOCK(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetInt(PRInt32 inIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInt(inIndex, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetString(PRInt32 inIndex, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetString(inIndex, _retval); } \
