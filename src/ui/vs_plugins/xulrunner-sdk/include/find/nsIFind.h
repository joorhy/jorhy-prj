/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/components/find/public/nsIFind.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFind : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordBreaker(nsIWordBreaker * *aWordBreaker) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetWordBreaker(nsIWordBreaker * aWordBreaker) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const PRUnichar *aPatText, nsIDOMRange *aSearchRange, nsIDOMRange *aStartPoint, nsIDOMRange *aEndPoint, nsIDOMRange **_retval) = 0;
...
#define NS_DECL_NSIFIND \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordBreaker(nsIWordBreaker * *aWordBreaker); \
  NS_SCRIPTABLE NS_IMETHOD SetWordBreaker(nsIWordBreaker * aWordBreaker); \
  NS_SCRIPTABLE NS_IMETHOD Find(const PRUnichar *aPatText, nsIDOMRange *aSearchRange, nsIDOMRange *aStartPoint, nsIDOMRange *aEndPoint, nsIDOMRange **_retval); 
...
#define NS_FORWARD_NSIFIND(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordBreaker(nsIWordBreaker * *aWordBreaker) { return _to GetWordBreaker(aWordBreaker); } \
  NS_SCRIPTABLE NS_IMETHOD SetWordBreaker(nsIWordBreaker * aWordBreaker) { return _to SetWordBreaker(aWordBreaker); } \
  NS_SCRIPTABLE NS_IMETHOD Find(const PRUnichar *aPatText, nsIDOMRange *aSearchRange, nsIDOMRange *aStartPoint, nsIDOMRange *aEndPoint, nsIDOMRange **_retval) { return _to Find(aPatText, aSearchRange, aStartPoint, aEndPoint, _retval); } 
...
#define NS_FORWARD_SAFE_NSIFIND(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWordBreaker(nsIWordBreaker * *aWordBreaker) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWordBreaker(aWordBreaker); } \
  NS_SCRIPTABLE NS_IMETHOD SetWordBreaker(nsIWordBreaker * aWordBreaker) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWordBreaker(aWordBreaker); } \
  NS_SCRIPTABLE NS_IMETHOD Find(const PRUnichar *aPatText, nsIDOMRange *aSearchRange, nsIDOMRange *aStartPoint, nsIDOMRange *aEndPoint, nsIDOMRange **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Find(aPatText, aSearchRange, aStartPoint, aEndPoint, _retval); } 
