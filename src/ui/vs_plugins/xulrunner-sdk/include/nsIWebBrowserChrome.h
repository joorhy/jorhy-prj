/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/embedding/browser/webBrowser/nsIWebBrowserChrome.idl
 */
...
class NS_NO_VTABLE nsIWebBrowserChrome : public nsISupports {
 public: 
  ...
  NS_IMETHOD SetStatus(uint32_t statusType, const PRUnichar * status) = 0;
...
#define NS_DECL_NSIWEBBROWSERCHROME \
  NS_IMETHOD SetStatus(uint32_t statusType, const PRUnichar * status); \
...
#define NS_FORWARD_NSIWEBBROWSERCHROME(_to) \
  NS_IMETHOD SetStatus(uint32_t statusType, const PRUnichar * status) { return _to SetStatus(statusType, status); } \
...
#define NS_FORWARD_SAFE_NSIWEBBROWSERCHROME(_to) \
  NS_IMETHOD SetStatus(uint32_t statusType, const PRUnichar * status) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStatus(statusType, status); } \
...
/* void setStatus (in unsigned long statusType, in wstring status); */
NS_IMETHODIMP nsWebBrowserChrome::SetStatus(uint32_t statusType, const PRUnichar * status)
{
