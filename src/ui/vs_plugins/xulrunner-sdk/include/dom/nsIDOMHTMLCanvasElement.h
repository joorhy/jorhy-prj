/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/html/nsIDOMHTMLCanvasElement.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLCanvasElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContext(const nsAString & contextId, nsISupports **_retval) = 0;

  /* DOMString toDataURL (); */
  NS_SCRIPTABLE NS_IMETHOD ToDataURL(nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMHTMLCANVASELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContext(const nsAString & contextId, nsISupports **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ToDataURL(nsAString & _retval); \
...
#define NS_FORWARD_NSIDOMHTMLCANVASELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContext(const nsAString & contextId, nsISupports **_retval) { return _to GetContext(contextId, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ToDataURL(nsAString & _retval) { return _to ToDataURL(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLCANVASELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContext(const nsAString & contextId, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContext(contextId, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ToDataURL(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToDataURL(_retval); } \
