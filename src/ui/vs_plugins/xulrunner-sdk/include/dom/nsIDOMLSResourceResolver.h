/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/ls/nsIDOMLSResourceResolver.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMLSResourceResolver : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ResolveResource(const nsAString & type, const nsAString & namespaceURI, const nsAString & publicId, const nsAString & systemId, const nsAString & baseURI, nsIDOMLSInput **_retval) = 0;
...
#define NS_DECL_NSIDOMLSRESOURCERESOLVER \
  NS_SCRIPTABLE NS_IMETHOD ResolveResource(const nsAString & type, const nsAString & namespaceURI, const nsAString & publicId, const nsAString & systemId, const nsAString & baseURI, nsIDOMLSInput **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMLSRESOURCERESOLVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ResolveResource(const nsAString & type, const nsAString & namespaceURI, const nsAString & publicId, const nsAString & systemId, const nsAString & baseURI, nsIDOMLSInput **_retval) { return _to ResolveResource(type, namespaceURI, publicId, systemId, baseURI, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMLSRESOURCERESOLVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ResolveResource(const nsAString & type, const nsAString & namespaceURI, const nsAString & publicId, const nsAString & systemId, const nsAString & baseURI, nsIDOMLSInput **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ResolveResource(type, namespaceURI, publicId, systemId, baseURI, _retval); } 
