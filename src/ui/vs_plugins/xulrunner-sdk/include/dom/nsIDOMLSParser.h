/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/ls/nsIDOMLSParser.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMLSParser : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Parse(nsIDOMLSInput *input, nsIDOMDocument **_retval) = 0;

  /* nsIDOMDocument parseURI (in DOMString uri)  raises (DOMException, LSException); */
  NS_SCRIPTABLE NS_IMETHOD ParseURI(const nsAString & uri, nsIDOMDocument **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ParseWithContext(nsIDOMLSInput *input, nsIDOMNode *contextArg, PRUint16 action, nsIDOMNode **_retval) = 0;
...
#define NS_DECL_NSIDOMLSPARSER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Parse(nsIDOMLSInput *input, nsIDOMDocument **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ParseURI(const nsAString & uri, nsIDOMDocument **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ParseWithContext(nsIDOMLSInput *input, nsIDOMNode *contextArg, PRUint16 action, nsIDOMNode **_retval); \
...
#define NS_FORWARD_NSIDOMLSPARSER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Parse(nsIDOMLSInput *input, nsIDOMDocument **_retval) { return _to Parse(input, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ParseURI(const nsAString & uri, nsIDOMDocument **_retval) { return _to ParseURI(uri, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ParseWithContext(nsIDOMLSInput *input, nsIDOMNode *contextArg, PRUint16 action, nsIDOMNode **_retval) { return _to ParseWithContext(input, contextArg, action, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMLSPARSER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Parse(nsIDOMLSInput *input, nsIDOMDocument **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Parse(input, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ParseURI(const nsAString & uri, nsIDOMDocument **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ParseURI(uri, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ParseWithContext(nsIDOMLSInput *input, nsIDOMNode *contextArg, PRUint16 action, nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ParseWithContext(input, contextArg, action, _retval); } \
