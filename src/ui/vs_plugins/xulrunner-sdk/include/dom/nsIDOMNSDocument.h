/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/core/nsIDOMNSDocument.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSDocument : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBoxObjectFor(nsIDOMElement *elt, nsIBoxObject **_retval) = 0;

  /* boolean hasFocus (); */
  NS_SCRIPTABLE NS_IMETHOD HasFocus(PRBool *_retval) = 0;
  ...
  */
  ...
  NS_SCRIPTABLE NS_IMETHOD ElementFromPoint(PRInt32 x, PRInt32 y, nsIDOMElement **_retval) = 0;
...
#define NS_DECL_NSIDOMNSDOCUMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBoxObjectFor(nsIDOMElement *elt, nsIBoxObject **_retval); \
  NS_SCRIPTABLE NS_IMETHOD HasFocus(PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD ElementFromPoint(PRInt32 x, PRInt32 y, nsIDOMElement **_retval); 
...
#define NS_FORWARD_NSIDOMNSDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBoxObjectFor(nsIDOMElement *elt, nsIBoxObject **_retval) { return _to GetBoxObjectFor(elt, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasFocus(PRBool *_retval) { return _to HasFocus(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ElementFromPoint(PRInt32 x, PRInt32 y, nsIDOMElement **_retval) { return _to ElementFromPoint(x, y, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMNSDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBoxObjectFor(nsIDOMElement *elt, nsIBoxObject **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBoxObjectFor(elt, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasFocus(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasFocus(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ElementFromPoint(PRInt32 x, PRInt32 y, nsIDOMElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ElementFromPoint(x, y, _retval); } 
...
/* boolean hasFocus (); */
NS_IMETHODIMP nsDOMNSDocument::HasFocus(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIDOMNodeList getElementsByClassName (in DOMString classes); */
NS_IMETHODIMP nsDOMNSDocument::GetElementsByClassName(const nsAString & classes, nsIDOMNodeList **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMElement elementFromPoint (in long x, in long y); */
NS_IMETHODIMP nsDOMNSDocument::ElementFromPoint(PRInt32 x, PRInt32 y, nsIDOMElement **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
