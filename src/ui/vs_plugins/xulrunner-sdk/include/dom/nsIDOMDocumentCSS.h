/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/css/nsIDOMDocumentCSS.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDocumentCSS : public nsIDOMDocumentStyle {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval) = 0;
...
#define NS_DECL_NSIDOMDOCUMENTCSS \
  NS_SCRIPTABLE NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMDOCUMENTCSS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval) { return _to GetOverrideStyle(elt, pseudoElt, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMDOCUMENTCSS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOverrideStyle(nsIDOMElement *elt, const nsAString & pseudoElt, nsIDOMCSSStyleDeclaration **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOverrideStyle(elt, pseudoElt, _retval); } 
