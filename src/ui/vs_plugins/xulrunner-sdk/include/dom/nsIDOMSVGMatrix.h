/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/svg/nsIDOMSVGMatrix.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGMatrix : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Multiply(nsIDOMSVGMatrix *secondMatrix, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix inverse (); */
  NS_SCRIPTABLE NS_IMETHOD Inverse(nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix translate (in float x, in float y); */
  NS_SCRIPTABLE NS_IMETHOD Translate(float x, float y, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix scale (in float scaleFactor); */
  NS_SCRIPTABLE NS_IMETHOD Scale(float scaleFactor, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix scaleNonUniform (in float scaleFactorX, in float scaleFactorY); */
  NS_SCRIPTABLE NS_IMETHOD ScaleNonUniform(float scaleFactorX, float scaleFactorY, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix rotate (in float angle); */
  NS_SCRIPTABLE NS_IMETHOD Rotate(float angle, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix rotateFromVector (in float x, in float y); */
  NS_SCRIPTABLE NS_IMETHOD RotateFromVector(float x, float y, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix flipX (); */
  NS_SCRIPTABLE NS_IMETHOD FlipX(nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix flipY (); */
  NS_SCRIPTABLE NS_IMETHOD FlipY(nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix skewX (in float angle); */
  NS_SCRIPTABLE NS_IMETHOD SkewX(float angle, nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix skewY (in float angle); */
  NS_SCRIPTABLE NS_IMETHOD SkewY(float angle, nsIDOMSVGMatrix **_retval) = 0;
...
#define NS_DECL_NSIDOMSVGMATRIX \
  ...
  NS_SCRIPTABLE NS_IMETHOD Multiply(nsIDOMSVGMatrix *secondMatrix, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Inverse(nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Translate(float x, float y, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Scale(float scaleFactor, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ScaleNonUniform(float scaleFactorX, float scaleFactorY, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Rotate(float angle, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD RotateFromVector(float x, float y, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD FlipX(nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD FlipY(nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SkewX(float angle, nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SkewY(float angle, nsIDOMSVGMatrix **_retval); 
...
#define NS_FORWARD_NSIDOMSVGMATRIX(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Multiply(nsIDOMSVGMatrix *secondMatrix, nsIDOMSVGMatrix **_retval) { return _to Multiply(secondMatrix, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Inverse(nsIDOMSVGMatrix **_retval) { return _to Inverse(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Translate(float x, float y, nsIDOMSVGMatrix **_retval) { return _to Translate(x, y, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Scale(float scaleFactor, nsIDOMSVGMatrix **_retval) { return _to Scale(scaleFactor, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ScaleNonUniform(float scaleFactorX, float scaleFactorY, nsIDOMSVGMatrix **_retval) { return _to ScaleNonUniform(scaleFactorX, scaleFactorY, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Rotate(float angle, nsIDOMSVGMatrix **_retval) { return _to Rotate(angle, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RotateFromVector(float x, float y, nsIDOMSVGMatrix **_retval) { return _to RotateFromVector(x, y, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FlipX(nsIDOMSVGMatrix **_retval) { return _to FlipX(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FlipY(nsIDOMSVGMatrix **_retval) { return _to FlipY(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SkewX(float angle, nsIDOMSVGMatrix **_retval) { return _to SkewX(angle, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SkewY(float angle, nsIDOMSVGMatrix **_retval) { return _to SkewY(angle, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGMATRIX(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Multiply(nsIDOMSVGMatrix *secondMatrix, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Multiply(secondMatrix, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Inverse(nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Inverse(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Translate(float x, float y, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Translate(x, y, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Scale(float scaleFactor, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Scale(scaleFactor, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ScaleNonUniform(float scaleFactorX, float scaleFactorY, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScaleNonUniform(scaleFactorX, scaleFactorY, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Rotate(float angle, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Rotate(angle, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RotateFromVector(float x, float y, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RotateFromVector(x, y, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FlipX(nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FlipX(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FlipY(nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FlipY(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SkewX(float angle, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SkewX(angle, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SkewY(float angle, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SkewY(angle, _retval); } 
