/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMClientInformation.idl
 */
...
class nsIDOMLoadStatusList; /* forward declaration */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMClientInformation : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, PRBool whenOffline, PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOMCLIENTINFORMATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, PRBool whenOffline, PRBool *_retval); 
...
#define NS_FORWARD_NSIDOMCLIENTINFORMATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, PRBool whenOffline, PRBool *_retval) { return _to MozIsLocallyAvailable(uri, whenOffline, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMCLIENTINFORMATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsLocallyAvailable(const nsAString & uri, PRBool whenOffline, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozIsLocallyAvailable(uri, whenOffline, _retval); } 
...
/* boolean mozIsLocallyAvailable (in DOMString uri, in boolean whenOffline); */
NS_IMETHODIMP nsDOMClientInformation::MozIsLocallyAvailable(const nsAString & uri, PRBool whenOffline, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
