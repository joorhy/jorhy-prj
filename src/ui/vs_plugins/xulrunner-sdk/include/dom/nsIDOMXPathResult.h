/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/xpath/nsIDOMXPathResult.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXPathResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IterateNext(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode snapshotItem (in unsigned long index)  raises (XPathException); */
  NS_SCRIPTABLE NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval) = 0;
...
#define NS_DECL_NSIDOMXPATHRESULT \
  ...
  NS_SCRIPTABLE NS_IMETHOD IterateNext(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval); 
...
#define NS_FORWARD_NSIDOMXPATHRESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IterateNext(nsIDOMNode **_retval) { return _to IterateNext(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval) { return _to SnapshotItem(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMXPATHRESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IterateNext(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IterateNext(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SnapshotItem(PRUint32 index, nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SnapshotItem(index, _retval); } 
