/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/svg/nsIDOMSVGStylable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGStylable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPresentationAttribute(const nsAString & name, nsIDOMCSSValue **_retval) = 0;
...
#define NS_DECL_NSIDOMSVGSTYLABLE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPresentationAttribute(const nsAString & name, nsIDOMCSSValue **_retval); 
...
#define NS_FORWARD_NSIDOMSVGSTYLABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPresentationAttribute(const nsAString & name, nsIDOMCSSValue **_retval) { return _to GetPresentationAttribute(name, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGSTYLABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPresentationAttribute(const nsAString & name, nsIDOMCSSValue **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPresentationAttribute(name, _retval); } 
