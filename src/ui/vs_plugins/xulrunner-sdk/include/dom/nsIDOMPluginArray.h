/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMPluginArray.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMPluginArray : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMPlugin **_retval) = 0;

  /* nsIDOMPlugin namedItem (in DOMString name); */
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsIDOMPlugin **_retval) = 0;
...
#define NS_DECL_NSIDOMPLUGINARRAY \
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMPlugin **_retval); \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsIDOMPlugin **_retval); \
  NS_IMETHOD Refresh(PRBool reloadDocuments); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMPLUGINARRAY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMPlugin **_retval) { return _to Item(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsIDOMPlugin **_retval) { return _to NamedItem(name, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMPLUGINARRAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMPlugin **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsIDOMPlugin **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NamedItem(name, _retval); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMJSPluginArray : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMJSPLUGINARRAY_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMJSPluginArray, NS_IDOMJSPLUGINARRAY_IID)
