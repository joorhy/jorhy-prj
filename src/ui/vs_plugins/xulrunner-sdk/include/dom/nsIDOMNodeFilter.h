/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/traversal/nsIDOMNodeFilter.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNodeFilter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval) = 0;
...
#define NS_DECL_NSIDOMNODEFILTER \
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNODEFILTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval) { return _to AcceptNode(n, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNODEFILTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *n, PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AcceptNode(n, _retval); } 
