/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/sidebar/nsISidebar.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISidebarExternal : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsSearchProviderInstalled(const char *aSearchURL, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSISIDEBAREXTERNAL \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsSearchProviderInstalled(const char *aSearchURL, PRUint32 *_retval); 
...
#define NS_FORWARD_NSISIDEBAREXTERNAL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsSearchProviderInstalled(const char *aSearchURL, PRUint32 *_retval) { return _to IsSearchProviderInstalled(aSearchURL, _retval); } 
...
#define NS_FORWARD_SAFE_NSISIDEBAREXTERNAL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsSearchProviderInstalled(const char *aSearchURL, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsSearchProviderInstalled(aSearchURL, _retval); } 
