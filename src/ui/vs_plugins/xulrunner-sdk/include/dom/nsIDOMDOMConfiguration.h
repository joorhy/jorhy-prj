/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/core/nsIDOMDOMConfiguration.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDOMConfiguration : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetParameter(const nsAString & name, nsIVariant **_retval) = 0;

  /* boolean canSetParameter (in DOMString name, in nsIVariant value); */
  NS_SCRIPTABLE NS_IMETHOD CanSetParameter(const nsAString & name, nsIVariant *value, PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOMDOMCONFIGURATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetParameter(const nsAString & name, nsIVariant **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CanSetParameter(const nsAString & name, nsIVariant *value, PRBool *_retval); 
...
#define NS_FORWARD_NSIDOMDOMCONFIGURATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetParameter(const nsAString & name, nsIVariant **_retval) { return _to GetParameter(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanSetParameter(const nsAString & name, nsIVariant *value, PRBool *_retval) { return _to CanSetParameter(name, value, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMDOMCONFIGURATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetParameter(const nsAString & name, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetParameter(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanSetParameter(const nsAString & name, nsIVariant *value, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanSetParameter(name, value, _retval); } 
