/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/xul/nsIDOMXULMultSelectCntrlEl.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXULMultiSelectControlElement : public nsIDOMXULSelectControlElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectedItem(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) = 0;
...
#define NS_DECL_NSIDOMXULMULTISELECTCONTROLELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectedItem(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval); 
...
#define NS_FORWARD_NSIDOMXULMULTISELECTCONTROLELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectedItem(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) { return _to GetSelectedItem(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMXULMULTISELECTCONTROLELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectedItem(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelectedItem(index, _retval); } 
