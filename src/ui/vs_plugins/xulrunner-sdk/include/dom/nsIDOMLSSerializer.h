/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/ls/nsIDOMLSSerializer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMLSSerializer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Write(nsIDOMNode *nodeArg, nsIDOMLSOutput *destination, PRBool *_retval) = 0;

  /* boolean writeToURI (in nsIDOMNode nodeArg, in DOMString uri)  raises (LSException); */
  NS_SCRIPTABLE NS_IMETHOD WriteToURI(nsIDOMNode *nodeArg, const nsAString & uri, PRBool *_retval) = 0;

  /* DOMString writeToString (in nsIDOMNode nodeArg)  raises (DOMException, LSException); */
  NS_SCRIPTABLE NS_IMETHOD WriteToString(nsIDOMNode *nodeArg, nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMLSSERIALIZER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Write(nsIDOMNode *nodeArg, nsIDOMLSOutput *destination, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD WriteToURI(nsIDOMNode *nodeArg, const nsAString & uri, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD WriteToString(nsIDOMNode *nodeArg, nsAString & _retval); 
...
#define NS_FORWARD_NSIDOMLSSERIALIZER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Write(nsIDOMNode *nodeArg, nsIDOMLSOutput *destination, PRBool *_retval) { return _to Write(nodeArg, destination, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteToURI(nsIDOMNode *nodeArg, const nsAString & uri, PRBool *_retval) { return _to WriteToURI(nodeArg, uri, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteToString(nsIDOMNode *nodeArg, nsAString & _retval) { return _to WriteToString(nodeArg, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMLSSERIALIZER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Write(nsIDOMNode *nodeArg, nsIDOMLSOutput *destination, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Write(nodeArg, destination, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteToURI(nsIDOMNode *nodeArg, const nsAString & uri, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteToURI(nodeArg, uri, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteToString(nsIDOMNode *nodeArg, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteToString(nodeArg, _retval); } 
