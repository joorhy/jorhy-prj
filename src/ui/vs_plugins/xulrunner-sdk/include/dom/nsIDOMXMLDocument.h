/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/core/nsIDOMXMLDocument.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXMLDocument : public nsIDOMDocument {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Load(const nsAString & url, PRBool *_retval) = 0;
  ...
  */
  ...
  NS_SCRIPTABLE NS_IMETHOD EvaluateFIXptr(const nsAString & expression, nsIDOMRange **_retval) = 0;

  /**
  * Evaluate XPointer expression.
  */
  /* nsIXPointerResult evaluateXPointer (in DOMString expression); */
  NS_SCRIPTABLE NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval) = 0;
...
#define NS_DECL_NSIDOMXMLDOCUMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD Load(const nsAString & url, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD EvaluateFIXptr(const nsAString & expression, nsIDOMRange **_retval); \
  NS_SCRIPTABLE NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval); 
...
#define NS_FORWARD_NSIDOMXMLDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Load(const nsAString & url, PRBool *_retval) { return _to Load(url, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EvaluateFIXptr(const nsAString & expression, nsIDOMRange **_retval) { return _to EvaluateFIXptr(expression, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval) { return _to EvaluateXPointer(expression, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMXMLDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Load(const nsAString & url, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Load(url, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EvaluateFIXptr(const nsAString & expression, nsIDOMRange **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EvaluateFIXptr(expression, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EvaluateXPointer(const nsAString & expression, nsIXPointerResult **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EvaluateXPointer(expression, _retval); } 
