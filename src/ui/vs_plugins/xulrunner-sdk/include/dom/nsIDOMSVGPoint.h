/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/svg/nsIDOMSVGPoint.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGPoint : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval) = 0;
...
#define NS_DECL_NSIDOMSVGPOINT \
  ...
  NS_SCRIPTABLE NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval); 
...
#define NS_FORWARD_NSIDOMSVGPOINT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval) { return _to MatrixTransform(matrix, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGPOINT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MatrixTransform(nsIDOMSVGMatrix *matrix, nsIDOMSVGPoint **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->MatrixTransform(matrix, _retval); } 
