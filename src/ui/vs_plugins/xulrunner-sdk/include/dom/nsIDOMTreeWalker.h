/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/traversal/nsIDOMTreeWalker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMTreeWalker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ParentNode(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode firstChild (); */
  NS_SCRIPTABLE NS_IMETHOD FirstChild(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode lastChild (); */
  NS_SCRIPTABLE NS_IMETHOD LastChild(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode previousSibling (); */
  NS_SCRIPTABLE NS_IMETHOD PreviousSibling(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode nextSibling (); */
  NS_SCRIPTABLE NS_IMETHOD NextSibling(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode previousNode (); */
  NS_SCRIPTABLE NS_IMETHOD PreviousNode(nsIDOMNode **_retval) = 0;

  /* nsIDOMNode nextNode (); */
  NS_SCRIPTABLE NS_IMETHOD NextNode(nsIDOMNode **_retval) = 0;
...
#define NS_DECL_NSIDOMTREEWALKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParentNode(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD FirstChild(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD LastChild(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD PreviousSibling(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD NextSibling(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD PreviousNode(nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD NextNode(nsIDOMNode **_retval); 
...
#define NS_FORWARD_NSIDOMTREEWALKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParentNode(nsIDOMNode **_retval) { return _to ParentNode(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FirstChild(nsIDOMNode **_retval) { return _to FirstChild(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD LastChild(nsIDOMNode **_retval) { return _to LastChild(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PreviousSibling(nsIDOMNode **_retval) { return _to PreviousSibling(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD NextSibling(nsIDOMNode **_retval) { return _to NextSibling(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PreviousNode(nsIDOMNode **_retval) { return _to PreviousNode(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD NextNode(nsIDOMNode **_retval) { return _to NextNode(_retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMTREEWALKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ParentNode(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ParentNode(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD FirstChild(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FirstChild(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD LastChild(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->LastChild(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PreviousSibling(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PreviousSibling(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD NextSibling(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NextSibling(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PreviousNode(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PreviousNode(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD NextNode(nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NextNode(_retval); } 
