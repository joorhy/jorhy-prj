/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMClientRectList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMClientRectList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMClientRect **_retval) = 0;
...
#define NS_DECL_NSIDOMCLIENTRECTLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMClientRect **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMCLIENTRECTLIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMClientRect **_retval) { return _to Item(index, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMCLIENTRECTLIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMClientRect **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } 
...
/* nsIDOMClientRect item (in unsigned long index); */
NS_IMETHODIMP nsDOMClientRectList::Item(PRUint32 index, nsIDOMClientRect **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
