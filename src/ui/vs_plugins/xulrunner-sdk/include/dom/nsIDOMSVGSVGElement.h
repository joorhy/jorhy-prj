/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/svg/nsIDOMSVGSVGElement.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGSVGElement : public nsIDOMSVGElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SuspendRedraw(PRUint32 max_wait_milliseconds, PRUint32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(PRBool *_retval) = 0;

  /* float getCurrentTime (); */
  NS_SCRIPTABLE NS_IMETHOD GetCurrentTime(float *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIntersectionList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval) = 0;

  /* nsIDOMNodeList getEnclosureList (in nsIDOMSVGRect rect, in nsIDOMSVGElement referenceElement); */
  NS_SCRIPTABLE NS_IMETHOD GetEnclosureList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval) = 0;

  /* boolean checkIntersection (in nsIDOMSVGElement element, in nsIDOMSVGRect rect); */
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval) = 0;

  /* boolean checkEnclosure (in nsIDOMSVGElement element, in nsIDOMSVGRect rect); */
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval) = 0;

  /* void deSelectAll (); */
  NS_SCRIPTABLE NS_IMETHOD DeSelectAll(void) = 0;

  /* nsIDOMSVGNumber createSVGNumber (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGNumber(nsIDOMSVGNumber **_retval) = 0;

  /* nsIDOMSVGLength createSVGLength (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGLength(nsIDOMSVGLength **_retval) = 0;

  /* nsIDOMSVGAngle createSVGAngle (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGAngle(nsIDOMSVGAngle **_retval) = 0;

  /* nsIDOMSVGPoint createSVGPoint (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGPoint(nsIDOMSVGPoint **_retval) = 0;

  /* nsIDOMSVGMatrix createSVGMatrix (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGMatrix(nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGRect createSVGRect (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGRect(nsIDOMSVGRect **_retval) = 0;

  /* nsIDOMSVGTransform createSVGTransform (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransform(nsIDOMSVGTransform **_retval) = 0;

  /* nsIDOMSVGTransform createSVGTransformFromMatrix (in nsIDOMSVGMatrix matrix); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransformFromMatrix(nsIDOMSVGMatrix *matrix, nsIDOMSVGTransform **_retval) = 0;

  /* DOMString createSVGString (); */
  NS_SCRIPTABLE NS_IMETHOD CreateSVGString(nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMSVGSVGELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD SuspendRedraw(PRUint32 max_wait_milliseconds, PRUint32 *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetCurrentTime(float *_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetCurrentTime(float seconds); \
  NS_SCRIPTABLE NS_IMETHOD GetIntersectionList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetEnclosureList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD DeSelectAll(void); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGNumber(nsIDOMSVGNumber **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGLength(nsIDOMSVGLength **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGAngle(nsIDOMSVGAngle **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGPoint(nsIDOMSVGPoint **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGMatrix(nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGRect(nsIDOMSVGRect **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransform(nsIDOMSVGTransform **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransformFromMatrix(nsIDOMSVGMatrix *matrix, nsIDOMSVGTransform **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGString(nsAString & _retval); \
...
#define NS_FORWARD_NSIDOMSVGSVGELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SuspendRedraw(PRUint32 max_wait_milliseconds, PRUint32 *_retval) { return _to SuspendRedraw(max_wait_milliseconds, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(PRBool *_retval) { return _to AnimationsPaused(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCurrentTime(float *_retval) { return _to GetCurrentTime(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetCurrentTime(float seconds) { return _to SetCurrentTime(seconds); } \
  NS_SCRIPTABLE NS_IMETHOD GetIntersectionList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval) { return _to GetIntersectionList(rect, referenceElement, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEnclosureList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval) { return _to GetEnclosureList(rect, referenceElement, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval) { return _to CheckIntersection(element, rect, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval) { return _to CheckEnclosure(element, rect, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DeSelectAll(void) { return _to DeSelectAll(); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGNumber(nsIDOMSVGNumber **_retval) { return _to CreateSVGNumber(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGLength(nsIDOMSVGLength **_retval) { return _to CreateSVGLength(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGAngle(nsIDOMSVGAngle **_retval) { return _to CreateSVGAngle(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGPoint(nsIDOMSVGPoint **_retval) { return _to CreateSVGPoint(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGMatrix(nsIDOMSVGMatrix **_retval) { return _to CreateSVGMatrix(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGRect(nsIDOMSVGRect **_retval) { return _to CreateSVGRect(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransform(nsIDOMSVGTransform **_retval) { return _to CreateSVGTransform(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransformFromMatrix(nsIDOMSVGMatrix *matrix, nsIDOMSVGTransform **_retval) { return _to CreateSVGTransformFromMatrix(matrix, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGString(nsAString & _retval) { return _to CreateSVGString(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGSVGELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SuspendRedraw(PRUint32 max_wait_milliseconds, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SuspendRedraw(max_wait_milliseconds, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD AnimationsPaused(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AnimationsPaused(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCurrentTime(float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCurrentTime(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetCurrentTime(float seconds) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentTime(seconds); } \
  NS_SCRIPTABLE NS_IMETHOD GetIntersectionList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIntersectionList(rect, referenceElement, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEnclosureList(nsIDOMSVGRect *rect, nsIDOMSVGElement *referenceElement, nsIDOMNodeList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnclosureList(rect, referenceElement, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CheckIntersection(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckIntersection(element, rect, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CheckEnclosure(nsIDOMSVGElement *element, nsIDOMSVGRect *rect, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckEnclosure(element, rect, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DeSelectAll(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->DeSelectAll(); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGNumber(nsIDOMSVGNumber **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGNumber(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGLength(nsIDOMSVGLength **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGLength(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGAngle(nsIDOMSVGAngle **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGAngle(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGPoint(nsIDOMSVGPoint **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGPoint(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGMatrix(nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGMatrix(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGRect(nsIDOMSVGRect **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGRect(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransform(nsIDOMSVGTransform **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGTransform(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGTransformFromMatrix(nsIDOMSVGMatrix *matrix, nsIDOMSVGTransform **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGTransformFromMatrix(matrix, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateSVGString(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateSVGString(_retval); } \
