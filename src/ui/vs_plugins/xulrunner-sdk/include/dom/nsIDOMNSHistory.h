/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMNSHistory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSHistory : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMNSHISTORY_IID)
   ...
   */
  /* void go (); */
  NS_SCRIPTABLE NS_IMETHOD Go(void) = 0;

};

  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMNSHistory, NS_IDOMNSHISTORY_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMNSHISTORY \
  NS_SCRIPTABLE NS_IMETHOD Go(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNSHISTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD Go(void) { return _to Go(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNSHISTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD Go(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Go(); } 
