/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMJSWindow.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMJSWindow : public nsISupports {
 public: 
   ...
   */
  /* long setTimeout (); */
  NS_SCRIPTABLE NS_IMETHOD SetTimeout(PRInt32 *_retval) = 0;

  /* long setInterval (); */
  NS_SCRIPTABLE NS_IMETHOD SetInterval(PRInt32 *_retval) = 0;
   ...
   */
  /* DOMString prompt (); */
  NS_SCRIPTABLE NS_IMETHOD Prompt(nsAString & _retval) = 0;
   ...
   */
  /* nsIDOMWindow open (); */
  NS_SCRIPTABLE NS_IMETHOD Open(nsIDOMWindow **_retval) = 0;

  /* nsIDOMWindow openDialog (); */
  NS_SCRIPTABLE NS_IMETHOD OpenDialog(nsIDOMWindow **_retval) = 0;
  ...
  /* boolean find (); */
  NS_SCRIPTABLE NS_IMETHOD Find(PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOMJSWINDOW \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTimeout(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetInterval(PRInt32 *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Prompt(nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD Open(nsIDOMWindow **_retval); \
  NS_SCRIPTABLE NS_IMETHOD OpenDialog(nsIDOMWindow **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetFrames(nsIDOMWindow * *aFrames); \
  NS_SCRIPTABLE NS_IMETHOD Find(PRBool *_retval); 
...
#define NS_FORWARD_NSIDOMJSWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTimeout(PRInt32 *_retval) { return _to SetTimeout(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetInterval(PRInt32 *_retval) { return _to SetInterval(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Prompt(nsAString & _retval) { return _to Prompt(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Open(nsIDOMWindow **_retval) { return _to Open(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD OpenDialog(nsIDOMWindow **_retval) { return _to OpenDialog(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetFrames(nsIDOMWindow * *aFrames) { return _to GetFrames(aFrames); } \
  NS_SCRIPTABLE NS_IMETHOD Find(PRBool *_retval) { return _to Find(_retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMJSWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTimeout(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTimeout(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetInterval(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetInterval(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Prompt(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Prompt(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Open(nsIDOMWindow **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Open(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD OpenDialog(nsIDOMWindow **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenDialog(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetFrames(nsIDOMWindow * *aFrames) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFrames(aFrames); } \
  NS_SCRIPTABLE NS_IMETHOD Find(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Find(_retval); } 
