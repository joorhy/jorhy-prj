/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/svg/nsIDOMSVGLocatable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGLocatable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBBox(nsIDOMSVGRect **_retval) = 0;

  /* nsIDOMSVGMatrix getCTM (); */
  NS_SCRIPTABLE NS_IMETHOD GetCTM(nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix getScreenCTM (); */
  NS_SCRIPTABLE NS_IMETHOD GetScreenCTM(nsIDOMSVGMatrix **_retval) = 0;

  /* nsIDOMSVGMatrix getTransformToElement (in nsIDOMSVGElement element); */
  NS_SCRIPTABLE NS_IMETHOD GetTransformToElement(nsIDOMSVGElement *element, nsIDOMSVGMatrix **_retval) = 0;
...
#define NS_DECL_NSIDOMSVGLOCATABLE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBBox(nsIDOMSVGRect **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetCTM(nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetScreenCTM(nsIDOMSVGMatrix **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetTransformToElement(nsIDOMSVGElement *element, nsIDOMSVGMatrix **_retval); 
...
#define NS_FORWARD_NSIDOMSVGLOCATABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBBox(nsIDOMSVGRect **_retval) { return _to GetBBox(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCTM(nsIDOMSVGMatrix **_retval) { return _to GetCTM(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetScreenCTM(nsIDOMSVGMatrix **_retval) { return _to GetScreenCTM(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransformToElement(nsIDOMSVGElement *element, nsIDOMSVGMatrix **_retval) { return _to GetTransformToElement(element, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSVGLOCATABLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBBox(nsIDOMSVGRect **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBBox(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCTM(nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCTM(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetScreenCTM(nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScreenCTM(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransformToElement(nsIDOMSVGElement *element, nsIDOMSVGMatrix **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransformToElement(element, _retval); } 
