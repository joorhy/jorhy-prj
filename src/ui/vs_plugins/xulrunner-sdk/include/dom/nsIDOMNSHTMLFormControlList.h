/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/html/nsIDOMNSHTMLFormControlList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSHTMLFormControlList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsISupports **_retval) = 0;
...
#define NS_DECL_NSIDOMNSHTMLFORMCONTROLLIST \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsISupports **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNSHTMLFORMCONTROLLIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsISupports **_retval) { return _to NamedItem(name, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNSHTMLFORMCONTROLLIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD NamedItem(const nsAString & name, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NamedItem(name, _retval); } 
