/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/events/nsIDOMNSUIEvent.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSUIEvent : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPreventDefault(PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOMNSUIEVENT \
  NS_SCRIPTABLE NS_IMETHOD GetPreventDefault(PRBool *_retval); \
...
#define NS_FORWARD_NSIDOMNSUIEVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetPreventDefault(PRBool *_retval) { return _to GetPreventDefault(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMNSUIEVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetPreventDefault(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPreventDefault(_retval); } \
