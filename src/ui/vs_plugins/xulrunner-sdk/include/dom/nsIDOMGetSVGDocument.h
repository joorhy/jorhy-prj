/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/svg/nsIDOMGetSVGDocument.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMGetSVGDocument : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSVGDocument(nsIDOMSVGDocument **_retval) = 0;
...
#define NS_DECL_NSIDOMGETSVGDOCUMENT \
  NS_SCRIPTABLE NS_IMETHOD GetSVGDocument(nsIDOMSVGDocument **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGETSVGDOCUMENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSVGDocument(nsIDOMSVGDocument **_retval) { return _to GetSVGDocument(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGETSVGDOCUMENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSVGDocument(nsIDOMSVGDocument **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSVGDocument(_retval); } 
