/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMNavigator.idl
 */
...
#define NS_IDOMNAVIGATOR_IID_STR "8e150a70-3e51-45df-bee3-77505fbe016c"

#define NS_IDOMNAVIGATOR_IID \
  {0x8e150a70, 0x3e51, 0x45df, \
    { 0xbe, 0xe3, 0x77, 0x50, 0x5f, 0xbe, 0x01, 0x6c }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNavigator : public nsISupports {
 public: 
  ...
  /* boolean javaEnabled (); */
  NS_SCRIPTABLE NS_IMETHOD JavaEnabled(PRBool *_retval) = 0;

  /* boolean taintEnabled (); */
  NS_SCRIPTABLE NS_IMETHOD TaintEnabled(PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOMNAVIGATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD JavaEnabled(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD TaintEnabled(PRBool *_retval); 
...
#define NS_FORWARD_NSIDOMNAVIGATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD JavaEnabled(PRBool *_retval) { return _to JavaEnabled(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD TaintEnabled(PRBool *_retval) { return _to TaintEnabled(_retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMNAVIGATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD JavaEnabled(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->JavaEnabled(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD TaintEnabled(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->TaintEnabled(_retval); } 
