/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/xul/nsIDOMXULCommandDispatcher.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXULCommandDispatcher : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllers(nsIControllers **_retval) = 0;
...
#define NS_DECL_NSIDOMXULCOMMANDDISPATCHER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllers(nsIControllers **_retval); \
...
#define NS_FORWARD_NSIDOMXULCOMMANDDISPATCHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllers(nsIControllers **_retval) { return _to GetControllers(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULCOMMANDDISPATCHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllers(nsIControllers **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControllers(_retval); } \
