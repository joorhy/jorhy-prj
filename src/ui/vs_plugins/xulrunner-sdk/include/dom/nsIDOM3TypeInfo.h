/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/core/nsIDOM3TypeInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOM3TypeInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDerivedFrom(const nsAString & typeNamespaceArg, const nsAString & typeNameArg, PRUint32 derivationMethod, PRBool *_retval) = 0;
...
#define NS_DECL_NSIDOM3TYPEINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDerivedFrom(const nsAString & typeNamespaceArg, const nsAString & typeNameArg, PRUint32 derivationMethod, PRBool *_retval); 
...
#define NS_FORWARD_NSIDOM3TYPEINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDerivedFrom(const nsAString & typeNamespaceArg, const nsAString & typeNameArg, PRUint32 derivationMethod, PRBool *_retval) { return _to IsDerivedFrom(typeNamespaceArg, typeNameArg, derivationMethod, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOM3TYPEINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDerivedFrom(const nsAString & typeNamespaceArg, const nsAString & typeNameArg, PRUint32 derivationMethod, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsDerivedFrom(typeNamespaceArg, typeNameArg, derivationMethod, _retval); } 
...
/* boolean isDerivedFrom (in DOMString typeNamespaceArg, in DOMString typeNameArg, in unsigned long derivationMethod); */
NS_IMETHODIMP nsDOM3TypeInfo::IsDerivedFrom(const nsAString & typeNamespaceArg, const nsAString & typeNameArg, PRUint32 derivationMethod, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
