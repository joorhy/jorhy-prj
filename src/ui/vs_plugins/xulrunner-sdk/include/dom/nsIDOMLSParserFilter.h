/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/ls/nsIDOMLSParserFilter.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMLSParserFilter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD StartElement(nsIDOMElement *elementArg, PRUint16 *_retval) = 0;

  /* unsigned short acceptNode (in nsIDOMNode nodeArg); */
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *nodeArg, PRUint16 *_retval) = 0;
...
#define NS_DECL_NSIDOMLSPARSERFILTER \
  NS_SCRIPTABLE NS_IMETHOD StartElement(nsIDOMElement *elementArg, PRUint16 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *nodeArg, PRUint16 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetWhatToShow(PRUint32 *aWhatToShow); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMLSPARSERFILTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD StartElement(nsIDOMElement *elementArg, PRUint16 *_retval) { return _to StartElement(elementArg, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *nodeArg, PRUint16 *_retval) { return _to AcceptNode(nodeArg, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMLSPARSERFILTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD StartElement(nsIDOMElement *elementArg, PRUint16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartElement(elementArg, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AcceptNode(nsIDOMNode *nodeArg, PRUint16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AcceptNode(nodeArg, _retval); } \
