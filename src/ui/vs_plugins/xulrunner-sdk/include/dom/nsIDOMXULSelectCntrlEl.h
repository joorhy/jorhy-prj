/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/xul/nsIDOMXULSelectCntrlEl.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXULSelectControlElement : public nsIDOMXULControlElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AppendItem(const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval) = 0;

  /* nsIDOMXULSelectControlItemElement insertItemAt (in long index, in DOMString label, in DOMString value); */
  NS_SCRIPTABLE NS_IMETHOD InsertItemAt(PRInt32 index, const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval) = 0;

  /* nsIDOMXULSelectControlItemElement removeItemAt (in long index); */
  NS_SCRIPTABLE NS_IMETHOD RemoveItemAt(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMXULSelectControlItemElement *item, PRInt32 *_retval) = 0;

  /* nsIDOMXULSelectControlItemElement getItemAtIndex (in long index); */
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) = 0;
...
#define NS_DECL_NSIDOMXULSELECTCONTROLELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD AppendItem(const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval); \
  NS_SCRIPTABLE NS_IMETHOD InsertItemAt(PRInt32 index, const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval); \
  NS_SCRIPTABLE NS_IMETHOD RemoveItemAt(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetItemCount(PRUint32 *aItemCount); \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMXULSelectControlItemElement *item, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval); 
...
#define NS_FORWARD_NSIDOMXULSELECTCONTROLELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AppendItem(const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval) { return _to AppendItem(label, value, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD InsertItemAt(PRInt32 index, const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval) { return _to InsertItemAt(index, label, value, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveItemAt(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) { return _to RemoveItemAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetItemCount(PRUint32 *aItemCount) { return _to GetItemCount(aItemCount); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMXULSelectControlItemElement *item, PRInt32 *_retval) { return _to GetIndexOfItem(item, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) { return _to GetItemAtIndex(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMXULSELECTCONTROLELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AppendItem(const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AppendItem(label, value, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD InsertItemAt(PRInt32 index, const nsAString & label, const nsAString & value, nsIDOMXULSelectControlItemElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertItemAt(index, label, value, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveItemAt(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveItemAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetItemCount(PRUint32 *aItemCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemCount(aItemCount); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMXULSelectControlItemElement *item, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOfItem(item, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAtIndex(index, _retval); } 
...
/* long getIndexOfItem (in nsIDOMXULSelectControlItemElement item); */
NS_IMETHODIMP nsDOMXULSelectControlElement::GetIndexOfItem(nsIDOMXULSelectControlItemElement *item, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMXULSelectControlItemElement getItemAtIndex (in long index); */
NS_IMETHODIMP nsDOMXULSelectControlElement::GetItemAtIndex(PRInt32 index, nsIDOMXULSelectControlItemElement **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
