/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/xpath/nsIDOMXPathExpression.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMXPathExpression : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval) = 0;
...
#define NS_DECL_NSIDOMXPATHEXPRESSION \
  NS_SCRIPTABLE NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMXPATHEXPRESSION(_to) \
  NS_SCRIPTABLE NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval) { return _to Evaluate(contextNode, type, result, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMXPATHEXPRESSION(_to) \
  NS_SCRIPTABLE NS_IMETHOD Evaluate(nsIDOMNode *contextNode, PRUint16 type, nsISupports *result, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Evaluate(contextNode, type, result, _retval); } 
