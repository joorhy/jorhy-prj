/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMNSLocation.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNSLocation : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMNSLOCATION_IID)

  /* void reload (); */
  NS_SCRIPTABLE NS_IMETHOD Reload(void) = 0;

};

  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMNSLocation, NS_IDOMNSLOCATION_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMNSLOCATION \
  NS_SCRIPTABLE NS_IMETHOD Reload(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNSLOCATION(_to) \
  NS_SCRIPTABLE NS_IMETHOD Reload(void) { return _to Reload(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNSLOCATION(_to) \
  NS_SCRIPTABLE NS_IMETHOD Reload(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Reload(); } 
