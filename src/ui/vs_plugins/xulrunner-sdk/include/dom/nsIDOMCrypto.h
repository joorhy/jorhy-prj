/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/base/nsIDOMCrypto.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMCrypto : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateCRMFRequest(nsIDOMCRMFObject **_retval) = 0;

  /* DOMString importUserCertificates (in DOMString nickname, in DOMString cmmfResponse, in boolean doForcedBackup); */
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, PRBool doForcedBackup, nsAString & _retval) = 0;

  /* DOMString popChallengeResponse (in DOMString challenge); */
  NS_SCRIPTABLE NS_IMETHOD PopChallengeResponse(const nsAString & challenge, nsAString & _retval) = 0;

  /* DOMString random (in long numBytes); */
  NS_SCRIPTABLE NS_IMETHOD Random(PRInt32 numBytes, nsAString & _retval) = 0;

  /* DOMString signText (in DOMString stringToSign, in DOMString caOption); */
  NS_SCRIPTABLE NS_IMETHOD SignText(const nsAString & stringToSign, const nsAString & caOption, nsAString & _retval) = 0;

  /* void alert (in DOMString message); */
  NS_SCRIPTABLE NS_IMETHOD Alert(const nsAString & message) = 0;
...
#define NS_DECL_NSIDOMCRYPTO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateCRMFRequest(nsIDOMCRMFObject **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, PRBool doForcedBackup, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD PopChallengeResponse(const nsAString & challenge, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD Random(PRInt32 numBytes, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD SignText(const nsAString & stringToSign, const nsAString & caOption, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD Alert(const nsAString & message); \
...
#define NS_FORWARD_NSIDOMCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateCRMFRequest(nsIDOMCRMFObject **_retval) { return _to GenerateCRMFRequest(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, PRBool doForcedBackup, nsAString & _retval) { return _to ImportUserCertificates(nickname, cmmfResponse, doForcedBackup, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD PopChallengeResponse(const nsAString & challenge, nsAString & _retval) { return _to PopChallengeResponse(challenge, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Random(PRInt32 numBytes, nsAString & _retval) { return _to Random(numBytes, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SignText(const nsAString & stringToSign, const nsAString & caOption, nsAString & _retval) { return _to SignText(stringToSign, caOption, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Alert(const nsAString & message) { return _to Alert(message); } \
...
#define NS_FORWARD_SAFE_NSIDOMCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateCRMFRequest(nsIDOMCRMFObject **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GenerateCRMFRequest(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ImportUserCertificates(const nsAString & nickname, const nsAString & cmmfResponse, PRBool doForcedBackup, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ImportUserCertificates(nickname, cmmfResponse, doForcedBackup, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD PopChallengeResponse(const nsAString & challenge, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PopChallengeResponse(challenge, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Random(PRInt32 numBytes, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Random(numBytes, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SignText(const nsAString & stringToSign, const nsAString & caOption, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SignText(stringToSign, caOption, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Alert(const nsAString & message) { return !_to ? NS_ERROR_NULL_POINTER : _to->Alert(message); } \
