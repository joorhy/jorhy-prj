/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/xbl/nsIDOMDocumentXBL.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDocumentXBL : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousNodes(nsIDOMElement *elt, nsIDOMNodeList **_retval) = 0;

  /* nsIDOMElement getAnonymousElementByAttribute (in nsIDOMElement elt, in DOMString attrName, in DOMString attrValue); */
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousElementByAttribute(nsIDOMElement *elt, const nsAString & attrName, const nsAString & attrValue, nsIDOMElement **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBindingParent(nsIDOMNode *node, nsIDOMElement **_retval) = 0;
...
#define NS_DECL_NSIDOMDOCUMENTXBL \
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousNodes(nsIDOMElement *elt, nsIDOMNodeList **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousElementByAttribute(nsIDOMElement *elt, const nsAString & attrName, const nsAString & attrValue, nsIDOMElement **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBindingParent(nsIDOMNode *node, nsIDOMElement **_retval); \
...
#define NS_FORWARD_NSIDOMDOCUMENTXBL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousNodes(nsIDOMElement *elt, nsIDOMNodeList **_retval) { return _to GetAnonymousNodes(elt, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousElementByAttribute(nsIDOMElement *elt, const nsAString & attrName, const nsAString & attrValue, nsIDOMElement **_retval) { return _to GetAnonymousElementByAttribute(elt, attrName, attrValue, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBindingParent(nsIDOMNode *node, nsIDOMElement **_retval) { return _to GetBindingParent(node, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMDOCUMENTXBL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousNodes(nsIDOMElement *elt, nsIDOMNodeList **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnonymousNodes(elt, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnonymousElementByAttribute(nsIDOMElement *elt, const nsAString & attrName, const nsAString & attrValue, nsIDOMElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnonymousElementByAttribute(elt, attrName, attrValue, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBindingParent(nsIDOMNode *node, nsIDOMElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBindingParent(node, _retval); } \
