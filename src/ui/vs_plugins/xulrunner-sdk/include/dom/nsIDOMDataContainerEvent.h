/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/dom/public/idl/events/nsIDOMDataContainerEvent.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDataContainerEvent : public nsIDOMEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetData(const nsAString & key, nsIVariant **_retval) = 0;
...
#define NS_DECL_NSIDOMDATACONTAINEREVENT \
  NS_SCRIPTABLE NS_IMETHOD GetData(const nsAString & key, nsIVariant **_retval); \
...
#define NS_FORWARD_NSIDOMDATACONTAINEREVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetData(const nsAString & key, nsIVariant **_retval) { return _to GetData(key, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMDATACONTAINEREVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetData(const nsAString & key, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetData(key, _retval); } \
