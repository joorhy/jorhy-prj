/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/storage/public/mozIStorageResultSet.idl
 */
...
#define NS_DECL_MOZISTORAGERESULTSET \
  NS_IMETHOD GetNextRow(mozIStorageRow * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISTORAGERESULTSET(_to) \
  NS_IMETHOD GetNextRow(mozIStorageRow * *_retval) { return _to GetNextRow(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISTORAGERESULTSET(_to) \
  NS_IMETHOD GetNextRow(mozIStorageRow * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNextRow(_retval); } 
