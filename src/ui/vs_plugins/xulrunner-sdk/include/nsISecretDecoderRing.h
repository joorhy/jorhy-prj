/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsISecretDecoderRing.idl
 */
...
#define NS_DECL_NSISECRETDECODERRING \
  NS_IMETHOD Encrypt(unsigned char *data, int32_t dataLen, unsigned char **result, int32_t *_retval); \
  NS_IMETHOD Decrypt(unsigned char *data, int32_t dataLen, unsigned char **result, int32_t *_retval); \
...
#define NS_FORWARD_NSISECRETDECODERRING(_to) \
  NS_IMETHOD Encrypt(unsigned char *data, int32_t dataLen, unsigned char **result, int32_t *_retval) { return _to Encrypt(data, dataLen, result, _retval); } \
  NS_IMETHOD Decrypt(unsigned char *data, int32_t dataLen, unsigned char **result, int32_t *_retval) { return _to Decrypt(data, dataLen, result, _retval); } \
...
#define NS_FORWARD_SAFE_NSISECRETDECODERRING(_to) \
  NS_IMETHOD Encrypt(unsigned char *data, int32_t dataLen, unsigned char **result, int32_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Encrypt(data, dataLen, result, _retval); } \
  NS_IMETHOD Decrypt(unsigned char *data, int32_t dataLen, unsigned char **result, int32_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Decrypt(data, dataLen, result, _retval); } \
