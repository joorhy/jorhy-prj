/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/editor/txtsvc/public/nsITextServicesFilter.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITextServicesFilter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval) = 0;
...
#define NS_DECL_NSITEXTSERVICESFILTER \
  NS_SCRIPTABLE NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITEXTSERVICESFILTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval) { return _to Skip(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITEXTSERVICESFILTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Skip(nsIDOMNode *aNode, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Skip(aNode, _retval); } 
...
/* boolean skip (in nsIDOMNode aNode); */
NS_IMETHODIMP nsTextServicesFilter::Skip(nsIDOMNode *aNode, PRBool *_retval)
{
