/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/extensions/spellcheck/idl/mozISpellI18NManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozISpellI18NManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUtil(const PRUnichar *language, mozISpellI18NUtil **_retval) = 0;
...
#define NS_DECL_MOZISPELLI18NMANAGER \
  NS_SCRIPTABLE NS_IMETHOD GetUtil(const PRUnichar *language, mozISpellI18NUtil **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISPELLI18NMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUtil(const PRUnichar *language, mozISpellI18NUtil **_retval) { return _to GetUtil(language, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISPELLI18NMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUtil(const PRUnichar *language, mozISpellI18NUtil **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUtil(language, _retval); } 
