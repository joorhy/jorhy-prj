/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/extensions/spellcheck/idl/mozIPersonalDictionary.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIPersonalDictionary : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, const PRUnichar *lang, PRBool *_retval) = 0;
...
/**
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCorrection(const PRUnichar *word, PRUnichar ***words, PRUint32 *count) = 0;
...
#define NS_DECL_MOZIPERSONALDICTIONARY \
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, const PRUnichar *lang, PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCorrection(const PRUnichar *word, PRUnichar ***words, PRUint32 *count); 
...
#define NS_FORWARD_MOZIPERSONALDICTIONARY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, const PRUnichar *lang, PRBool *_retval) { return _to Check(word, lang, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCorrection(const PRUnichar *word, PRUnichar ***words, PRUint32 *count) { return _to GetCorrection(word, words, count); } 
...
#define NS_FORWARD_SAFE_MOZIPERSONALDICTIONARY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, const PRUnichar *lang, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Check(word, lang, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCorrection(const PRUnichar *word, PRUnichar ***words, PRUint32 *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCorrection(word, words, count); } 
...
/* boolean check (in wstring word, in wstring lang); */
NS_IMETHODIMP _MYCLASS_::Check(const PRUnichar *word, const PRUnichar *lang, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getCorrection (in wstring word, [array, size_is (count)] out wstring words, out PRUint32 count); */
NS_IMETHODIMP _MYCLASS_::GetCorrection(const PRUnichar *word, PRUnichar ***words, PRUint32 *count)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
