/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/extensions/spellcheck/idl/mozISpellCheckingEngine.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozISpellCheckingEngine : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDictionaryList(PRUnichar ***dictionaries, PRUint32 *count) = 0;

  /**
   * check a word
   */
  /* boolean check (in wstring word); */
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, PRBool *_retval) = 0;

  /**
   * get a list of suggestions for a misspelled word
   */
  /* void suggest (in wstring word, [array, size_is (count)] out wstring suggestions, out PRUint32 count); */
  NS_SCRIPTABLE NS_IMETHOD Suggest(const PRUnichar *word, PRUnichar ***suggestions, PRUint32 *count) = 0;
...
#define NS_DECL_MOZISPELLCHECKINGENGINE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDictionaryList(PRUnichar ***dictionaries, PRUint32 *count); \
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD Suggest(const PRUnichar *word, PRUnichar ***suggestions, PRUint32 *count); 
...
#define NS_FORWARD_MOZISPELLCHECKINGENGINE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDictionaryList(PRUnichar ***dictionaries, PRUint32 *count) { return _to GetDictionaryList(dictionaries, count); } \
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, PRBool *_retval) { return _to Check(word, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Suggest(const PRUnichar *word, PRUnichar ***suggestions, PRUint32 *count) { return _to Suggest(word, suggestions, count); } 
...
#define NS_FORWARD_SAFE_MOZISPELLCHECKINGENGINE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDictionaryList(PRUnichar ***dictionaries, PRUint32 *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDictionaryList(dictionaries, count); } \
  NS_SCRIPTABLE NS_IMETHOD Check(const PRUnichar *word, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Check(word, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Suggest(const PRUnichar *word, PRUnichar ***suggestions, PRUint32 *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->Suggest(word, suggestions, count); } 
...
/* void getDictionaryList ([array, size_is (count)] out wstring dictionaries, out PRUint32 count); */
NS_IMETHODIMP _MYCLASS_::GetDictionaryList(PRUnichar ***dictionaries, PRUint32 *count)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean check (in wstring word); */
NS_IMETHODIMP _MYCLASS_::Check(const PRUnichar *word, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void suggest (in wstring word, [array, size_is (count)] out wstring suggestions, out PRUint32 count); */
NS_IMETHODIMP _MYCLASS_::Suggest(const PRUnichar *word, PRUnichar ***suggestions, PRUint32 *count)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
