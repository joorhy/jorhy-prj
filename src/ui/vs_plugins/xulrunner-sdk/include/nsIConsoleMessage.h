/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpcom/base/nsIConsoleMessage.idl
 */
...
class NS_NO_VTABLE nsIConsoleMessage : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetMessageMoz(PRUnichar * *aMessage) = 0;
...
#define NS_DECL_NSICONSOLEMESSAGE \
  NS_IMETHOD GetMessageMoz(PRUnichar * *aMessage); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONSOLEMESSAGE(_to) \
  NS_IMETHOD GetMessageMoz(PRUnichar * *aMessage) { return _to GetMessageMoz(aMessage); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONSOLEMESSAGE(_to) \
  NS_IMETHOD GetMessageMoz(PRUnichar * *aMessage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMessageMoz(aMessage); } 
