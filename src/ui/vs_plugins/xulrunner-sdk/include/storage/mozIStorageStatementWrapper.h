/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/storage/public/mozIStorageStatementWrapper.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIStorageStatementWrapper : public nsISupports {
 public: 
  ...
  /* boolean step (); */
  NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval) = 0;
...
#define NS_DECL_MOZISTORAGESTATEMENTWRAPPER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval); \
...
#define NS_FORWARD_MOZISTORAGESTATEMENTWRAPPER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval) { return _to Step(_retval); } \
...
#define NS_FORWARD_SAFE_MOZISTORAGESTATEMENTWRAPPER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Step(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Step(_retval); } \
...
/* boolean step (); */
NS_IMETHODIMP _MYCLASS_::Step(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
