/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/storage/public/mozIStorageDataSet.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIStorageDataSet : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRowEnumerator(nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_MOZISTORAGEDATASET \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRowEnumerator(nsISimpleEnumerator **_retval); 
...
#define NS_FORWARD_MOZISTORAGEDATASET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRowEnumerator(nsISimpleEnumerator **_retval) { return _to GetRowEnumerator(_retval); } 
...
#define NS_FORWARD_SAFE_MOZISTORAGEDATASET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRowEnumerator(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowEnumerator(_retval); } 
...
/* nsISimpleEnumerator getRowEnumerator (); */
NS_IMETHODIMP _MYCLASS_::GetRowEnumerator(nsISimpleEnumerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
