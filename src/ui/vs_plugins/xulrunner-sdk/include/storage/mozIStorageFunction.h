/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/storage/public/mozIStorageFunction.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIStorageFunction : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnFunctionCall(mozIStorageValueArray *aFunctionArguments, nsIVariant **_retval) = 0;
...
#define NS_DECL_MOZISTORAGEFUNCTION \
  NS_SCRIPTABLE NS_IMETHOD OnFunctionCall(mozIStorageValueArray *aFunctionArguments, nsIVariant **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZISTORAGEFUNCTION(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnFunctionCall(mozIStorageValueArray *aFunctionArguments, nsIVariant **_retval) { return _to OnFunctionCall(aFunctionArguments, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZISTORAGEFUNCTION(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnFunctionCall(mozIStorageValueArray *aFunctionArguments, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnFunctionCall(aFunctionArguments, _retval); } 
