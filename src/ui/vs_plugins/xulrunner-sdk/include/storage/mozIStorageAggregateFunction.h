/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/storage/public/mozIStorageAggregateFunction.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIStorageAggregateFunction : public nsISupports {
 public: 
   ...
   */
  /* nsIVariant onFinal (); */
  NS_SCRIPTABLE NS_IMETHOD OnFinal(nsIVariant **_retval) = 0;
...
#define NS_DECL_MOZISTORAGEAGGREGATEFUNCTION \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnFinal(nsIVariant **_retval); 
...
#define NS_FORWARD_MOZISTORAGEAGGREGATEFUNCTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnFinal(nsIVariant **_retval) { return _to OnFinal(_retval); } 
...
#define NS_FORWARD_SAFE_MOZISTORAGEAGGREGATEFUNCTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnFinal(nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnFinal(_retval); } 
