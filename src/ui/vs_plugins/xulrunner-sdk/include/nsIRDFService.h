/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/nsIRDFService.idl
 */
...
#define NS_DECL_NSIRDFSERVICE \
  ...
  NS_IMETHOD GetLiteral(const PRUnichar * aValue, nsIRDFLiteral * *_retval); \
...
#define NS_FORWARD_NSIRDFSERVICE(_to) \
  ...
  NS_IMETHOD GetLiteral(const PRUnichar * aValue, nsIRDFLiteral * *_retval) { return _to GetLiteral(aValue, _retval); } \
...
#define NS_FORWARD_SAFE_NSIRDFSERVICE(_to) \
  ...
  NS_IMETHOD GetLiteral(const PRUnichar * aValue, nsIRDFLiteral * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLiteral(aValue, _retval); } \
