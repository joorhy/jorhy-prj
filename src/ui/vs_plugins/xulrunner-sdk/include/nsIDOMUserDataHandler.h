/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/core/nsIDOMUserDataHandler.idl
 */
...
class NS_NO_VTABLE nsIDOMUserDataHandler : public nsISupports {
 public: 
  ...
  NS_IMETHOD Handle(uint16_t operation, const nsAString & key, nsIVariant *data, nsIDOMNode *src, nsIDOMNode *dst) = 0;
...
#define NS_DECL_NSIDOMUSERDATAHANDLER \
  NS_IMETHOD Handle(uint16_t operation, const nsAString & key, nsIVariant *data, nsIDOMNode *src, nsIDOMNode *dst); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMUSERDATAHANDLER(_to) \
  NS_IMETHOD Handle(uint16_t operation, const nsAString & key, nsIVariant *data, nsIDOMNode *src, nsIDOMNode *dst) { return _to Handle(operation, key, data, src, dst); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMUSERDATAHANDLER(_to) \
  NS_IMETHOD Handle(uint16_t operation, const nsAString & key, nsIVariant *data, nsIDOMNode *src, nsIDOMNode *dst) { return !_to ? NS_ERROR_NULL_POINTER : _to->Handle(operation, key, data, src, dst); } 
...
/* void handle (in unsigned short operation, in DOMString key, in nsIVariant data, in nsIDOMNode src, in nsIDOMNode dst); */
NS_IMETHODIMP nsDOMUserDataHandler::Handle(uint16_t operation, const nsAString & key, nsIVariant *data, nsIDOMNode *src, nsIDOMNode *dst)
{
