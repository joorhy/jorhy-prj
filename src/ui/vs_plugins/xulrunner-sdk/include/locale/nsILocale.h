/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/intl/locale/idl/nsILocale.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILocale : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) = 0;
...
#define NS_DECL_NSILOCALE \
  NS_SCRIPTABLE NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSILOCALE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) { return _to GetCategory(category, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSILOCALE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetCategory(const nsAString & category, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCategory(category, _retval); } 
