/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/mozapps/update/nsIUpdateService.idl
 */
...
#define NS_IUPDATEPATCH_IID_STR "1134957d-9449-481b-a515-4d88b9998278"

#define NS_IUPDATEPATCH_IID \
  {0x1134957d, 0x9449, 0x481b, \
    { 0xa5, 0x15, 0x4d, 0x88, 0xb9, 0x99, 0x82, 0x78 }}
...
#define NS_IUPDATE_IID_STR "8f7185a7-056a-45a8-985c-1cb39cf7b7a8"

#define NS_IUPDATE_IID \
  {0x8f7185a7, 0x056a, 0x45a8, \
    { 0x98, 0x5c, 0x1c, 0xb3, 0x9c, 0xf7, 0xb7, 0xa8 }}
...
class NS_NO_VTABLE nsIUpdate : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetShowSurvey(bool *aShowSurvey) = 0;
  NS_IMETHOD SetShowSurvey(bool aShowSurvey) = 0;
...
#define NS_DECL_NSIUPDATE \
  ...
  NS_IMETHOD GetShowSurvey(bool *aShowSurvey); \
  NS_IMETHOD SetShowSurvey(bool aShowSurvey); \
...
#define NS_FORWARD_NSIUPDATE(_to) \
  ...
  NS_IMETHOD GetShowSurvey(bool *aShowSurvey) { return _to GetShowSurvey(aShowSurvey); } \
  NS_IMETHOD SetShowSurvey(bool aShowSurvey) { return _to SetShowSurvey(aShowSurvey); } \
...
#define NS_FORWARD_SAFE_NSIUPDATE(_to) \
  ...
  NS_IMETHOD GetShowSurvey(bool *aShowSurvey) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowSurvey(aShowSurvey); } \
  NS_IMETHOD SetShowSurvey(bool aShowSurvey) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowSurvey(aShowSurvey); } \
...
/* attribute boolean showSurvey; */
NS_IMETHODIMP nsUpdate::GetShowSurvey(bool *aShowSurvey)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsUpdate::SetShowSurvey(bool aShowSurvey)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_IAPPLICATIONUPDATESERVICE_IID_STR "900b4a18-3bef-4f3e-bcf5-84dce0021c6d"

#define NS_IAPPLICATIONUPDATESERVICE_IID \
  {0x900b4a18, 0x3bef, 0x4f3e, \
    { 0xbc, 0xf5, 0x84, 0xdc, 0xe0, 0x02, 0x1c, 0x6d }}
...
class NS_NO_VTABLE nsIApplicationUpdateService : public nsISupports {
 public: 
  ...
  NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update) = 0;
...
#define NS_DECL_NSIAPPLICATIONUPDATESERVICE \
  ...
  NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update); \
...
#define NS_FORWARD_NSIAPPLICATIONUPDATESERVICE(_to) \
  ...
  NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update) { return _to ApplyUpdateInBackground(update); } \
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONUPDATESERVICE(_to) \
  ...
  NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update) { return !_to ? NS_ERROR_NULL_POINTER : _to->ApplyUpdateInBackground(update); } \
...
/* void applyUpdateInBackground (in nsIUpdate update); */
NS_IMETHODIMP nsApplicationUpdateService::ApplyUpdateInBackground(nsIUpdate *update)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
