/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libpref/public/nsIPref.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPref : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyCharPref(const char *pref, char **_retval) = 0;

  /* string CopyDefaultCharPref (in string pref); */
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultCharPref(const char *pref, char **_retval) = 0;

  /* boolean GetDefaultBoolPref (in string pref); */
  NS_SCRIPTABLE NS_IMETHOD GetDefaultBoolPref(const char *pref, PRBool *_retval) = 0;

  /* long GetDefaultIntPref (in string pref); */
  NS_SCRIPTABLE NS_IMETHOD GetDefaultIntPref(const char *pref, PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyUnicharPref(const char *pref, PRUnichar **_retval) = 0;

  /* wstring CopyDefaultUnicharPref (in string pref); */
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultUnicharPref(const char *pref, PRUnichar **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalizedUnicharPref(const char *pref, PRUnichar **_retval) = 0;

  /* wstring getDefaultLocalizedUnicharPref (in string pref); */
  NS_SCRIPTABLE NS_IMETHOD GetDefaultLocalizedUnicharPref(const char *pref, PRUnichar **_retval) = 0;

  /* nsIFileSpec GetFilePref (in string pref); */
  NS_SCRIPTABLE NS_IMETHOD GetFilePref(const char *pref, nsIFileSpec **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFileXPref(const char *pref, nsILocalFile **_retval) = 0;
...
#define NS_DECL_NSIPREF \
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyCharPref(const char *pref, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultCharPref(const char *pref, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultBoolPref(const char *pref, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultIntPref(const char *pref, PRInt32 *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyUnicharPref(const char *pref, PRUnichar **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultUnicharPref(const char *pref, PRUnichar **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalizedUnicharPref(const char *pref, PRUnichar **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultLocalizedUnicharPref(const char *pref, PRUnichar **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetFilePref(const char *pref, nsIFileSpec **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetFilePref(const char *pref, nsIFileSpec *value, PRBool setDefault); \
  NS_SCRIPTABLE NS_IMETHOD GetFileXPref(const char *pref, nsILocalFile **_retval); \
...
#define NS_FORWARD_NSIPREF(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyCharPref(const char *pref, char **_retval) { return _to CopyCharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultCharPref(const char *pref, char **_retval) { return _to CopyDefaultCharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultBoolPref(const char *pref, PRBool *_retval) { return _to GetDefaultBoolPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultIntPref(const char *pref, PRInt32 *_retval) { return _to GetDefaultIntPref(pref, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyUnicharPref(const char *pref, PRUnichar **_retval) { return _to CopyUnicharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultUnicharPref(const char *pref, PRUnichar **_retval) { return _to CopyDefaultUnicharPref(pref, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalizedUnicharPref(const char *pref, PRUnichar **_retval) { return _to GetLocalizedUnicharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultLocalizedUnicharPref(const char *pref, PRUnichar **_retval) { return _to GetDefaultLocalizedUnicharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetFilePref(const char *pref, nsIFileSpec **_retval) { return _to GetFilePref(pref, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFileXPref(const char *pref, nsILocalFile **_retval) { return _to GetFileXPref(pref, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPREF(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyCharPref(const char *pref, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyCharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultCharPref(const char *pref, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyDefaultCharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultBoolPref(const char *pref, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDefaultBoolPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultIntPref(const char *pref, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDefaultIntPref(pref, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CopyUnicharPref(const char *pref, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyUnicharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CopyDefaultUnicharPref(const char *pref, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CopyDefaultUnicharPref(pref, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalizedUnicharPref(const char *pref, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalizedUnicharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDefaultLocalizedUnicharPref(const char *pref, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDefaultLocalizedUnicharPref(pref, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetFilePref(const char *pref, nsIFileSpec **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFilePref(pref, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFileXPref(const char *pref, nsILocalFile **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFileXPref(pref, _retval); } \
