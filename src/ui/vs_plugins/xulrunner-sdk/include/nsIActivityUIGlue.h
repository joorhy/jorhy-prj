/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/activities/interfaces/nsIActivityUIGlue.idl
 */
...
class NS_NO_VTABLE nsIActivityUIGlue : public nsISupports {
 public: 
  ...
  NS_IMETHOD ChooseActivity(const nsAString & title, const JS::Value & activities, nsIActivityUIGlueCallback *onresult) = 0;
...
#define NS_DECL_NSIACTIVITYUIGLUE \
  NS_IMETHOD ChooseActivity(const nsAString & title, const JS::Value & activities, nsIActivityUIGlueCallback *onresult); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIACTIVITYUIGLUE(_to) \
  NS_IMETHOD ChooseActivity(const nsAString & title, const JS::Value & activities, nsIActivityUIGlueCallback *onresult) { return _to ChooseActivity(title, activities, onresult); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIACTIVITYUIGLUE(_to) \
  NS_IMETHOD ChooseActivity(const nsAString & title, const JS::Value & activities, nsIActivityUIGlueCallback *onresult) { return !_to ? NS_ERROR_NULL_POINTER : _to->ChooseActivity(title, activities, onresult); } 
...
/* void chooseActivity (in DOMString title, in jsval activities, in nsIActivityUIGlueCallback onresult); */
NS_IMETHODIMP nsActivityUIGlue::ChooseActivity(const nsAString & title, const JS::Value & activities, nsIActivityUIGlueCallback *onresult)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
