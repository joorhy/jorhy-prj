/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/xul/document/public/nsIControllers.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIControllers : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllerForCommand(const char *command, nsIController **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveControllerAt(PRUint32 index, nsIController **_retval) = 0;

  /* nsIController getControllerAt (in unsigned long index); */
  NS_SCRIPTABLE NS_IMETHOD GetControllerAt(PRUint32 index, nsIController **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllerId(nsIController *controller, PRUint32 *_retval) = 0;

  /* nsIController getControllerById (in unsigned long controllerID); */
  NS_SCRIPTABLE NS_IMETHOD GetControllerById(PRUint32 controllerID, nsIController **_retval) = 0;

  /* unsigned long getControllerCount (); */
  NS_SCRIPTABLE NS_IMETHOD GetControllerCount(PRUint32 *_retval) = 0;
...
#define NS_DECL_NSICONTROLLERS \
  NS_SCRIPTABLE NS_IMETHOD GetControllerForCommand(const char *command, nsIController **_retval); \
  NS_SCRIPTABLE NS_IMETHOD InsertControllerAt(PRUint32 index, nsIController *controller); \
  NS_SCRIPTABLE NS_IMETHOD RemoveControllerAt(PRUint32 index, nsIController **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetControllerAt(PRUint32 index, nsIController **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllerId(nsIController *controller, PRUint32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetControllerById(PRUint32 controllerID, nsIController **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetControllerCount(PRUint32 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTROLLERS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetControllerForCommand(const char *command, nsIController **_retval) { return _to GetControllerForCommand(command, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveControllerAt(PRUint32 index, nsIController **_retval) { return _to RemoveControllerAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetControllerAt(PRUint32 index, nsIController **_retval) { return _to GetControllerAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllerId(nsIController *controller, PRUint32 *_retval) { return _to GetControllerId(controller, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetControllerById(PRUint32 controllerID, nsIController **_retval) { return _to GetControllerById(controllerID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetControllerCount(PRUint32 *_retval) { return _to GetControllerCount(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTROLLERS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetControllerForCommand(const char *command, nsIController **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControllerForCommand(command, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveControllerAt(PRUint32 index, nsIController **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveControllerAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetControllerAt(PRUint32 index, nsIController **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControllerAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetControllerId(nsIController *controller, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControllerId(controller, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetControllerById(PRUint32 controllerID, nsIController **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControllerById(controllerID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetControllerCount(PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetControllerCount(_retval); } 
