/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/xul/document/public/nsIController.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIController : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *command, PRBool *_retval) = 0;

  /* boolean supportsCommand (in string command); */
  NS_SCRIPTABLE NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval) = 0;
...
#define NS_DECL_NSICONTROLLER \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *command, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval); \
...
#define NS_FORWARD_NSICONTROLLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *command, PRBool *_retval) { return _to IsCommandEnabled(command, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval) { return _to SupportsCommand(command, _retval); } \
...
#define NS_FORWARD_SAFE_NSICONTROLLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *command, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandEnabled(command, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SupportsCommand(command, _retval); } \
...
/* boolean isCommandEnabled (in string command); */
NS_IMETHODIMP nsController::IsCommandEnabled(const char *command, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean supportsCommand (in string command); */
NS_IMETHODIMP nsController::SupportsCommand(const char *command, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIControllerCommandGroup : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval) = 0;

  /* nsISimpleEnumerator getGroupsEnumerator (); */
  NS_SCRIPTABLE NS_IMETHOD GetGroupsEnumerator(nsISimpleEnumerator **_retval) = 0;

  /* nsISimpleEnumerator getEnumeratorForGroup (in string aGroup); */
  NS_SCRIPTABLE NS_IMETHOD GetEnumeratorForGroup(const char *aGroup, nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_NSICONTROLLERCOMMANDGROUP \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetGroupsEnumerator(nsISimpleEnumerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetEnumeratorForGroup(const char *aGroup, nsISimpleEnumerator **_retval); 
...
#define NS_FORWARD_NSICONTROLLERCOMMANDGROUP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval) { return _to IsCommandInGroup(aCommand, aGroup, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetGroupsEnumerator(nsISimpleEnumerator **_retval) { return _to GetGroupsEnumerator(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEnumeratorForGroup(const char *aGroup, nsISimpleEnumerator **_retval) { return _to GetEnumeratorForGroup(aGroup, _retval); } 
...
#define NS_FORWARD_SAFE_NSICONTROLLERCOMMANDGROUP(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandInGroup(aCommand, aGroup, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetGroupsEnumerator(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGroupsEnumerator(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEnumeratorForGroup(const char *aGroup, nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnumeratorForGroup(aGroup, _retval); } 
...
/* boolean isCommandInGroup (in string aCommand, in string aGroup); */
NS_IMETHODIMP nsControllerCommandGroup::IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
