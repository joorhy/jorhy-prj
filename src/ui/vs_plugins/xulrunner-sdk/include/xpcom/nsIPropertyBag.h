/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/ds/nsIPropertyBag.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPropertyBag : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, nsIVariant **_retval) = 0;
...
#define NS_DECL_NSIPROPERTYBAG \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, nsIVariant **_retval); 
...
#define NS_FORWARD_NSIPROPERTYBAG(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, nsIVariant **_retval) { return _to GetProperty(name, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPROPERTYBAG(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const nsAString & name, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProperty(name, _retval); } 
