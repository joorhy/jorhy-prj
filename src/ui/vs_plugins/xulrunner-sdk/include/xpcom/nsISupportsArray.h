/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/ds/nsISupportsArray.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISupportsArray : public nsICollection {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval) = 0;

  /* long GetIndexOfStartingAt (in nsISupports aPossibleElement, in unsigned long aStartIndex); */
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfStartingAt(nsISupports *aPossibleElement, PRUint32 aStartIndex, PRInt32 *_retval) = 0;

  /* long GetLastIndexOf (in nsISupports aPossibleElement); */
  NS_SCRIPTABLE NS_IMETHOD GetLastIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISupportsArray **_retval) = 0;
...
#define NS_DECL_NSISUPPORTSARRAY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfStartingAt(nsISupports *aPossibleElement, PRUint32 aStartIndex, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetLastIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISupportsArray **_retval); \
...
#define NS_FORWARD_NSISUPPORTSARRAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval) { return _to GetIndexOf(aPossibleElement, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfStartingAt(nsISupports *aPossibleElement, PRUint32 aStartIndex, PRInt32 *_retval) { return _to GetIndexOfStartingAt(aPossibleElement, aStartIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLastIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval) { return _to GetLastIndexOf(aPossibleElement, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISupportsArray **_retval) { return _to Clone(_retval); } \
...
#define NS_FORWARD_SAFE_NSISUPPORTSARRAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOf(aPossibleElement, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfStartingAt(nsISupports *aPossibleElement, PRUint32 aStartIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOfStartingAt(aPossibleElement, aStartIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLastIndexOf(nsISupports *aPossibleElement, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastIndexOf(aPossibleElement, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clone(nsISupportsArray **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Clone(_retval); } \
