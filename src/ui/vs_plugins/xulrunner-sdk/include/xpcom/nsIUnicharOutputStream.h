/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsIUnicharOutputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUnicharOutputStream : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval) = 0;
...
#define NS_DECL_NSIUNICHAROUTPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval); \
...
#define NS_FORWARD_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval) { return _to Write(aCount, c, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval) { return _to WriteString(str, _retval); } \
...
#define NS_FORWARD_SAFE_NSIUNICHAROUTPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD Write(PRUint32 aCount, const PRUnichar *c, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Write(aCount, c, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD WriteString(const nsAString & str, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteString(str, _retval); } \
