/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/ds/nsICollection.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICollection : public nsISerializable {
 public: 
  ...
  /* PRUint32 Count (); */
  NS_SCRIPTABLE NS_IMETHOD Count(PRUint32 *_retval) = 0;

  /* nsISupports GetElementAt (in PRUint32 index); */
  NS_SCRIPTABLE NS_IMETHOD GetElementAt(PRUint32 index, nsISupports **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(nsIEnumerator **_retval) = 0;
...
#define NS_DECL_NSICOLLECTION \
  NS_SCRIPTABLE NS_IMETHOD Count(PRUint32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetElementAt(PRUint32 index, nsISupports **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(nsIEnumerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Clear(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICOLLECTION(_to) \
  NS_SCRIPTABLE NS_IMETHOD Count(PRUint32 *_retval) { return _to Count(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetElementAt(PRUint32 index, nsISupports **_retval) { return _to GetElementAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(nsIEnumerator **_retval) { return _to Enumerate(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD Clear(void) { return _to Clear(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICOLLECTION(_to) \
  NS_SCRIPTABLE NS_IMETHOD Count(PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Count(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetElementAt(PRUint32 index, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElementAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(nsIEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enumerate(_retval); } \
