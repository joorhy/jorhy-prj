/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/system/nsIGConfService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGConfService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, PRBool *_retval) = 0;

  /* AUTF8String getString (in AUTF8String key); */
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & key, nsACString & _retval) = 0;

  /* long getInt (in AUTF8String key); */
  NS_SCRIPTABLE NS_IMETHOD GetInt(const nsACString & key, PRInt32 *_retval) = 0;

  /* float getFloat (in AUTF8String key); */
  NS_SCRIPTABLE NS_IMETHOD GetFloat(const nsACString & key, float *_retval) = 0;

  /* nsIArray getStringList (in AUTF8String key); */
  NS_SCRIPTABLE NS_IMETHOD GetStringList(const nsACString & key, nsIArray **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, PRBool *enabled, nsACString & _retval) = 0;

  /* boolean handlerRequiresTerminal (in AUTF8String scheme); */
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, PRBool *_retval) = 0;
...
#define NS_DECL_NSIGCONFSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & key, nsACString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetInt(const nsACString & key, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetFloat(const nsACString & key, float *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetStringList(const nsACString & key, nsIArray **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, PRBool *enabled, nsACString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, PRBool *_retval); \
...
#define NS_FORWARD_NSIGCONFSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, PRBool *_retval) { return _to GetBool(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & key, nsACString & _retval) { return _to GetString(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetInt(const nsACString & key, PRInt32 *_retval) { return _to GetInt(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetFloat(const nsACString & key, float *_retval) { return _to GetFloat(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStringList(const nsACString & key, nsIArray **_retval) { return _to GetStringList(key, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, PRBool *enabled, nsACString & _retval) { return _to GetAppForProtocol(scheme, enabled, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, PRBool *_retval) { return _to HandlerRequiresTerminal(scheme, _retval); } \
...
#define NS_FORWARD_SAFE_NSIGCONFSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetBool(const nsACString & key, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBool(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & key, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetString(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetInt(const nsACString & key, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetInt(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetFloat(const nsACString & key, float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFloat(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStringList(const nsACString & key, nsIArray **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringList(key, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAppForProtocol(const nsACString & scheme, PRBool *enabled, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAppForProtocol(scheme, enabled, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandlerRequiresTerminal(const nsACString & scheme, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandlerRequiresTerminal(scheme, _retval); } \
