/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/ds/nsIStringEnumerator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIStringEnumerator : public nsISupports {
 public: 
  ...
  /* boolean hasMore (); */
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval) = 0;

  /* AString getNext (); */
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsAString & _retval) = 0;
...
#define NS_DECL_NSISTRINGENUMERATOR \
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISTRINGENUMERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval) { return _to HasMore(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsAString & _retval) { return _to GetNext(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISTRINGENUMERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasMore(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNext(_retval); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUTF8StringEnumerator : public nsISupports {
 public: 
  ...
  /* AUTF8String getNext (); */
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsACString & _retval) = 0;
...
#define NS_DECL_NSIUTF8STRINGENUMERATOR \
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsACString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUTF8STRINGENUMERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval) { return _to HasMore(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsACString & _retval) { return _to GetNext(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUTF8STRINGENUMERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD HasMore(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasMore(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNext(_retval); } 
