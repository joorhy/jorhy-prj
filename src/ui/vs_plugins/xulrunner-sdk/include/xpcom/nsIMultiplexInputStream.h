/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsIMultiplexInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMultiplexInputStream : public nsIInputStream {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval) = 0;
...
#define NS_DECL_NSIMULTIPLEXINPUTSTREAM \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval); 
...
#define NS_FORWARD_NSIMULTIPLEXINPUTSTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval) { return _to GetStream(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIMULTIPLEXINPUTSTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStream(PRUint32 index, nsIInputStream **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStream(index, _retval); } 
