/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/ds/nsIPersistentProperties2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPersistentProperties : public nsIProperties {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStringProperty(const nsACString & key, nsAString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetStringProperty(const nsACString & key, const nsAString & value, nsAString & _retval) = 0;
...
#define NS_DECL_NSIPERSISTENTPROPERTIES \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStringProperty(const nsACString & key, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD SetStringProperty(const nsACString & key, const nsAString & value, nsAString & _retval); 
...
#define NS_FORWARD_NSIPERSISTENTPROPERTIES(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStringProperty(const nsACString & key, nsAString & _retval) { return _to GetStringProperty(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetStringProperty(const nsACString & key, const nsAString & value, nsAString & _retval) { return _to SetStringProperty(key, value, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPERSISTENTPROPERTIES(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStringProperty(const nsACString & key, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringProperty(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetStringProperty(const nsACString & key, const nsAString & value, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStringProperty(key, value, _retval); } 
