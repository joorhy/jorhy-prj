/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/system/nsIGnomeVFSService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGnomeVFSService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMimeTypeFromExtension(const nsACString & extension, nsACString & _retval) = 0;

  /* nsIGnomeVFSMimeApp getAppForMimeType (in AUTF8String mimeType); */
  NS_SCRIPTABLE NS_IMETHOD GetAppForMimeType(const nsACString & mimeType, nsIGnomeVFSMimeApp **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDescriptionForMimeType(const nsACString & mimeType, nsACString & _retval) = 0;
...
#define NS_DECL_NSIGNOMEVFSSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMimeTypeFromExtension(const nsACString & extension, nsACString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetAppForMimeType(const nsACString & mimeType, nsIGnomeVFSMimeApp **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetAppForMimeType(const nsACString & mimeType, const nsACString & id); \
  NS_SCRIPTABLE NS_IMETHOD GetDescriptionForMimeType(const nsACString & mimeType, nsACString & _retval); \
...
#define NS_FORWARD_NSIGNOMEVFSSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMimeTypeFromExtension(const nsACString & extension, nsACString & _retval) { return _to GetMimeTypeFromExtension(extension, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAppForMimeType(const nsACString & mimeType, nsIGnomeVFSMimeApp **_retval) { return _to GetAppForMimeType(mimeType, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDescriptionForMimeType(const nsACString & mimeType, nsACString & _retval) { return _to GetDescriptionForMimeType(mimeType, _retval); } \
...
#define NS_FORWARD_SAFE_NSIGNOMEVFSSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMimeTypeFromExtension(const nsACString & extension, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMimeTypeFromExtension(extension, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetAppForMimeType(const nsACString & mimeType, nsIGnomeVFSMimeApp **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAppForMimeType(mimeType, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDescriptionForMimeType(const nsACString & mimeType, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDescriptionForMimeType(mimeType, _retval); } \
