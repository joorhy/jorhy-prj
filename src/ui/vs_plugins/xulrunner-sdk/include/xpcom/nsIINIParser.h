/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/ds/nsIINIParser.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIINIParser : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSections(nsIUTF8StringEnumerator **_retval) = 0;

  /**
   * Enumerates the keys available within a section.
   */
  /* nsIUTF8StringEnumerator getKeys (in AUTF8String aSection); */
  NS_SCRIPTABLE NS_IMETHOD GetKeys(const nsACString & aSection, nsIUTF8StringEnumerator **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & aSection, const nsACString & aKey, nsACString & _retval) = 0;
...
#define NS_DECL_NSIINIPARSER \
  NS_SCRIPTABLE NS_IMETHOD GetSections(nsIUTF8StringEnumerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetKeys(const nsACString & aSection, nsIUTF8StringEnumerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & aSection, const nsACString & aKey, nsACString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIINIPARSER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSections(nsIUTF8StringEnumerator **_retval) { return _to GetSections(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetKeys(const nsACString & aSection, nsIUTF8StringEnumerator **_retval) { return _to GetKeys(aSection, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & aSection, const nsACString & aKey, nsACString & _retval) { return _to GetString(aSection, aKey, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIINIPARSER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSections(nsIUTF8StringEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSections(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetKeys(const nsACString & aSection, nsIUTF8StringEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeys(aSection, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetString(const nsACString & aSection, const nsACString & aKey, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetString(aSection, aKey, _retval); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIINIParserFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsILocalFile *aINIFile, nsIINIParser **_retval) = 0;
...
#define NS_DECL_NSIINIPARSERFACTORY \
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsILocalFile *aINIFile, nsIINIParser **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIINIPARSERFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsILocalFile *aINIFile, nsIINIParser **_retval) { return _to CreateINIParser(aINIFile, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIINIPARSERFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsILocalFile *aINIFile, nsIINIParser **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateINIParser(aINIFile, _retval); } 
...
/* nsIINIParser createINIParser (in nsILocalFile aINIFile); */
NS_IMETHODIMP nsINIParserFactory::CreateINIParser(nsILocalFile *aINIFile, nsIINIParser **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
