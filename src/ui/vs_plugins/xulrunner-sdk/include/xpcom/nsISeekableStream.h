/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsISeekableStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISeekableStream : public nsISupports {
 public: 
  ...
  /**
     ...
     */
  /* long long tell (); */
  NS_SCRIPTABLE NS_IMETHOD Tell(PRInt64 *_retval) = 0;
...
#define NS_DECL_NSISEEKABLESTREAM \
  ...
  NS_SCRIPTABLE NS_IMETHOD Tell(PRInt64 *_retval); \
...
#define NS_FORWARD_NSISEEKABLESTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Tell(PRInt64 *_retval) { return _to Tell(_retval); } \
...
#define NS_FORWARD_SAFE_NSISEEKABLESTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Tell(PRInt64 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Tell(_retval); } \
