/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/components/nsIModuleLoader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIModuleLoader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD LoadModule(nsILocalFile *aFile, nsIModule **_retval) = 0;
...
#define NS_DECL_NSIMODULELOADER \
  NS_SCRIPTABLE NS_IMETHOD LoadModule(nsILocalFile *aFile, nsIModule **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMODULELOADER(_to) \
  NS_SCRIPTABLE NS_IMETHOD LoadModule(nsILocalFile *aFile, nsIModule **_retval) { return _to LoadModule(aFile, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMODULELOADER(_to) \
  NS_SCRIPTABLE NS_IMETHOD LoadModule(nsILocalFile *aFile, nsIModule **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadModule(aFile, _retval); } 
...
/* nsIModule loadModule (in nsILocalFile aFile); */
NS_IMETHODIMP nsModuleLoader::LoadModule(nsILocalFile *aFile, nsIModule **_retval)
{
