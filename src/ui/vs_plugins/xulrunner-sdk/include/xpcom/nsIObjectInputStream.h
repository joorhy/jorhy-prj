/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsIObjectInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIObjectInputStream : public nsIBinaryInputStream {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadObject(PRBool aIsStrongRef, nsISupports **_retval) = 0;
...
#define NS_DECL_NSIOBJECTINPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD ReadObject(PRBool aIsStrongRef, nsISupports **_retval); \
...
#define NS_FORWARD_NSIOBJECTINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadObject(PRBool aIsStrongRef, nsISupports **_retval) { return _to ReadObject(aIsStrongRef, _retval); } \
...
#define NS_FORWARD_SAFE_NSIOBJECTINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadObject(PRBool aIsStrongRef, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadObject(aIsStrongRef, _retval); } \
