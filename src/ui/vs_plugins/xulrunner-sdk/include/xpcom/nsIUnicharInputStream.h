/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsIUnicharInputStream.idl
 */
...
/**
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadString(PRUint32 aCount, nsAString & aString, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSIUNICHARINPUTSTREAM \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadString(PRUint32 aCount, nsAString & aString, PRUint32 *_retval); \
...
#define NS_FORWARD_NSIUNICHARINPUTSTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadString(PRUint32 aCount, nsAString & aString, PRUint32 *_retval) { return _to ReadString(aCount, aString, _retval); } \
...
#define NS_FORWARD_SAFE_NSIUNICHARINPUTSTREAM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadString(PRUint32 aCount, nsAString & aString, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadString(aCount, aString, _retval); } \
