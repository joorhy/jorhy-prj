/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/threads/nsIEnvironment.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEnvironment : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsAString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval) = 0;
...
#define NS_DECL_NSIENVIRONMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval); 
...
#define NS_FORWARD_NSIENVIRONMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsAString & _retval) { return _to Get(aName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval) { return _to Exists(aName, _retval); } 
...
#define NS_FORWARD_SAFE_NSIENVIRONMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(aName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Exists(const nsAString & aName, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Exists(aName, _retval); } 
