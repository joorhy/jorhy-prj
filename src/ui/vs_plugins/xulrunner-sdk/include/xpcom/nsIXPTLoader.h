/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/reflect/xptinfo/public/nsIXPTLoader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPTLoader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval) = 0;
...
#define NS_DECL_NSIXPTLOADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval); 
...
#define NS_FORWARD_NSIXPTLOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval) { return _to LoadEntry(file, name, _retval); } 
...
#define NS_FORWARD_SAFE_NSIXPTLOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD LoadEntry(nsILocalFile *file, const char *name, nsIInputStream **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadEntry(file, name, _retval); } 
