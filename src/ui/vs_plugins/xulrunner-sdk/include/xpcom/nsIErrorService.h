/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/base/nsIErrorService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIErrorService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundle(PRInt16 errorModule, char **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundleKey(nsresult error, char **_retval) = 0;
...
#define NS_DECL_NSIERRORSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundle(PRInt16 errorModule, char **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundleKey(nsresult error, char **_retval); 
...
#define NS_FORWARD_NSIERRORSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundle(PRInt16 errorModule, char **_retval) { return _to GetErrorStringBundle(errorModule, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundleKey(nsresult error, char **_retval) { return _to GetErrorStringBundleKey(error, _retval); } 
...
#define NS_FORWARD_SAFE_NSIERRORSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundle(PRInt16 errorModule, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetErrorStringBundle(errorModule, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetErrorStringBundleKey(nsresult error, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetErrorStringBundleKey(error, _retval); } 
