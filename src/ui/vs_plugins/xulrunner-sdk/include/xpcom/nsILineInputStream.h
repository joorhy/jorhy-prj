/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsILineInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILineInputStream : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsACString & aLine, PRBool *_retval) = 0;
...
#define NS_DECL_NSILINEINPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsACString & aLine, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSILINEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsACString & aLine, PRBool *_retval) { return _to ReadLine(aLine, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSILINEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsACString & aLine, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadLine(aLine, _retval); } 
