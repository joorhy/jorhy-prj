/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/io/nsIUnicharLineInputStream.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUnicharLineInputStream : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine, PRBool *_retval) = 0;
...
#define NS_DECL_NSIUNICHARLINEINPUTSTREAM \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUNICHARLINEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine, PRBool *_retval) { return _to ReadLine(aLine, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUNICHARLINEINPUTSTREAM(_to) \
  NS_SCRIPTABLE NS_IMETHOD ReadLine(nsAString & aLine, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadLine(aLine, _retval); } 
