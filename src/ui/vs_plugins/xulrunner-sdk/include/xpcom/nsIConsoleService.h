/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpcom/base/nsIConsoleService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIConsoleService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMessageArray(nsIConsoleMessage ***messages, PRUint32 *count) = 0;
...
#define NS_DECL_NSICONSOLESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMessageArray(nsIConsoleMessage ***messages, PRUint32 *count); \
...
#define NS_FORWARD_NSICONSOLESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMessageArray(nsIConsoleMessage ***messages, PRUint32 *count) { return _to GetMessageArray(messages, count); } \
...
#define NS_FORWARD_SAFE_NSICONSOLESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMessageArray(nsIConsoleMessage ***messages, PRUint32 *count) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMessageArray(messages, count); } \
