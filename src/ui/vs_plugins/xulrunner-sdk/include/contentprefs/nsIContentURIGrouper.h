/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/contentprefs/public/nsIContentURIGrouper.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIContentURIGrouper : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval) = 0;
...
#define NS_DECL_NSICONTENTURIGROUPER \
  NS_SCRIPTABLE NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTENTURIGROUPER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval) { return _to Group(aURI, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTENTURIGROUPER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Group(aURI, _retval); } 
