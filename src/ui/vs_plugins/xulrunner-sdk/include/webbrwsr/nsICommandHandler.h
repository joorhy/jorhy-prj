/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/browser/webBrowser/nsICommandHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICommandHandler : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Exec(const char *aCommand, const char *aParameters, char **_retval) = 0;

  /* string query (in string aCommand, in string aParameters); */
  NS_SCRIPTABLE NS_IMETHOD Query(const char *aCommand, const char *aParameters, char **_retval) = 0;
...
#define NS_DECL_NSICOMMANDHANDLER \
  NS_SCRIPTABLE NS_IMETHOD Exec(const char *aCommand, const char *aParameters, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Query(const char *aCommand, const char *aParameters, char **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICOMMANDHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Exec(const char *aCommand, const char *aParameters, char **_retval) { return _to Exec(aCommand, aParameters, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Query(const char *aCommand, const char *aParameters, char **_retval) { return _to Query(aCommand, aParameters, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICOMMANDHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Exec(const char *aCommand, const char *aParameters, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Exec(aCommand, aParameters, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Query(const char *aCommand, const char *aParameters, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Query(aCommand, aParameters, _retval); } 
