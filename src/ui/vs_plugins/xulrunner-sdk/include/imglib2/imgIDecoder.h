/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libpr0n/public/imgIDecoder.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgIDecoder : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFrom(nsIInputStream *inStr, PRUint32 count, PRUint32 *_retval) = 0;
...
#define NS_DECL_IMGIDECODER \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFrom(nsIInputStream *inStr, PRUint32 count, PRUint32 *_retval); 
...
#define NS_FORWARD_IMGIDECODER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFrom(nsIInputStream *inStr, PRUint32 count, PRUint32 *_retval) { return _to WriteFrom(inStr, count, _retval); } 
...
#define NS_FORWARD_SAFE_IMGIDECODER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFrom(nsIInputStream *inStr, PRUint32 count, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteFrom(inStr, count, _retval); } 
