/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libpr0n/public/imgIContainer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgIContainer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFrameAt(PRUint32 index, gfxIImageFrame **_retval) = 0;
...
#define NS_DECL_IMGICONTAINER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFrameAt(PRUint32 index, gfxIImageFrame **_retval); \
...
#define NS_FORWARD_IMGICONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFrameAt(PRUint32 index, gfxIImageFrame **_retval) { return _to GetFrameAt(index, _retval); } \
...
#define NS_FORWARD_SAFE_IMGICONTAINER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFrameAt(PRUint32 index, gfxIImageFrame **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFrameAt(index, _retval); } \
