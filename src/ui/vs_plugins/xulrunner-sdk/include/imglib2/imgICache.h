/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libpr0n/public/imgICache.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgICache : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties **_retval) = 0;
...
#define NS_DECL_IMGICACHE \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties **_retval); 
...
#define NS_FORWARD_IMGICACHE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties **_retval) { return _to FindEntryProperties(uri, _retval); } 
...
#define NS_FORWARD_SAFE_IMGICACHE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIProperties **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindEntryProperties(uri, _retval); } 
