/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libpr0n/public/imgILoader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE imgILoader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char *mimeType, PRBool *_retval) = 0;
...
#define NS_DECL_IMGILOADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char *mimeType, PRBool *_retval); 
...
#define NS_FORWARD_IMGILOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char *mimeType, PRBool *_retval) { return _to SupportImageWithMimeType(mimeType, _retval); } 
...
#define NS_FORWARD_SAFE_IMGILOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SupportImageWithMimeType(const char *mimeType, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SupportImageWithMimeType(mimeType, _retval); } 
