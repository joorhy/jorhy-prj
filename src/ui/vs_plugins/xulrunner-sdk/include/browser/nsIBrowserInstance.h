/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpfe/browser/public/nsIBrowserInstance.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserInstance : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD StartPageCycler(PRBool *_retval) = 0;
...
#define NS_DECL_NSIBROWSERINSTANCE \
  NS_SCRIPTABLE NS_IMETHOD StartPageCycler(PRBool *_retval); \
...
#define NS_FORWARD_NSIBROWSERINSTANCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD StartPageCycler(PRBool *_retval) { return _to StartPageCycler(_retval); } \
...
#define NS_FORWARD_SAFE_NSIBROWSERINSTANCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD StartPageCycler(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartPageCycler(_retval); } \
...
/* boolean startPageCycler (); */
NS_IMETHODIMP nsBrowserInstance::StartPageCycler(PRBool *_retval)
{
