/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsIPKCS11Module.idl
 */
...
class NS_NO_VTABLE nsIPKCS11Module : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetLibName(PRUnichar * *aLibName) = 0;
...
#define NS_DECL_NSIPKCS11MODULE \
  ...
  NS_IMETHOD GetLibName(PRUnichar * *aLibName); \
...
#define NS_FORWARD_NSIPKCS11MODULE(_to) \
  ...
  NS_IMETHOD GetLibName(PRUnichar * *aLibName) { return _to GetLibName(aLibName); } \
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULE(_to) \
  ...
  NS_IMETHOD GetLibName(PRUnichar * *aLibName) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLibName(aLibName); } \
