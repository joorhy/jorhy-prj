/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/places/public/nsITaggingService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaggingService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIsForTag(const nsAString & aTag, nsIVariant **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTagsForURI(nsIURI *aURI, PRUint32 *length, PRUnichar ***aTags) = 0;
...
#define NS_DECL_NSITAGGINGSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIsForTag(const nsAString & aTag, nsIVariant **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetTagsForURI(nsIURI *aURI, PRUint32 *length, PRUnichar ***aTags); \
...
#define NS_FORWARD_NSITAGGINGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIsForTag(const nsAString & aTag, nsIVariant **_retval) { return _to GetURIsForTag(aTag, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTagsForURI(nsIURI *aURI, PRUint32 *length, PRUnichar ***aTags) { return _to GetTagsForURI(aURI, length, aTags); } \
...
#define NS_FORWARD_SAFE_NSITAGGINGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIsForTag(const nsAString & aTag, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURIsForTag(aTag, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTagsForURI(nsIURI *aURI, PRUint32 *length, PRUnichar ***aTags) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTagsForURI(aURI, length, aTags); } \
...
/* void getTagsForURI (in nsIURI aURI, out unsigned long length, [array, size_is (length), retval] out wstring aTags); */
NS_IMETHODIMP nsTaggingService::GetTagsForURI(nsIURI *aURI, PRUint32 *length, PRUnichar ***aTags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
