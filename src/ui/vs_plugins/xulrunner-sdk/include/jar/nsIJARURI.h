/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libjar/nsIJARURI.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJARURI : public nsIURL {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneWithJARFile(nsIURI *jarFile, nsIJARURI **_retval) = 0;
...
#define NS_DECL_NSIJARURI \
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneWithJARFile(nsIURI *jarFile, nsIJARURI **_retval); 
...
#define NS_FORWARD_NSIJARURI(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneWithJARFile(nsIURI *jarFile, nsIJARURI **_retval) { return _to CloneWithJARFile(jarFile, _retval); } 
...
#define NS_FORWARD_SAFE_NSIJARURI(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneWithJARFile(nsIURI *jarFile, nsIJARURI **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CloneWithJARFile(jarFile, _retval); } 
