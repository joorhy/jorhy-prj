/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/modules/libjar/nsIJAR.idl
 */
...
class NS_NO_VTABLE nsIJAR : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetCertificatePrincipal(const char *aEntryName, nsIPrincipal **aPrincipal) = 0;
...
#define NS_DECL_NSIJAR \
  NS_IMETHOD GetCertificatePrincipal(const char *aEntryName, nsIPrincipal **aPrincipal); \
  NS_IMETHOD GetManifestEntriesCount(PRUint32 *aManifestEntriesCount); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJAR(_to) \
  NS_IMETHOD GetCertificatePrincipal(const char *aEntryName, nsIPrincipal **aPrincipal) { return _to GetCertificatePrincipal(aEntryName, aPrincipal); } \
...
#define NS_FORWARD_SAFE_NSIJAR(_to) \
  NS_IMETHOD GetCertificatePrincipal(const char *aEntryName, nsIPrincipal **aPrincipal) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCertificatePrincipal(aEntryName, aPrincipal); } \
...
/* void getCertificatePrincipal (in string aEntryName, out nsIPrincipal aPrincipal); */
NS_IMETHODIMP nsJAR::GetCertificatePrincipal(const char *aEntryName, nsIPrincipal **aPrincipal)
{
