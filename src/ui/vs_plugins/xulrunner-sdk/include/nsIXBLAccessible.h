/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/accessible/public/nsIXBLAccessible.idl
 */
...
class NS_NO_VTABLE nsIXBLAccessible : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IXBLACCESSIBLE_IID)

  /* readonly attribute DOMString accessibleName; */
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName) = 0;
...
#define NS_DECL_NSIXBLACCESSIBLE \
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXBLACCESSIBLE(_to) \
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName) { return _to GetAccessibleName(aAccessibleName); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXBLACCESSIBLE(_to) \
  NS_IMETHOD GetAccessibleName(nsAString & aAccessibleName) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAccessibleName(aAccessibleName); } 
