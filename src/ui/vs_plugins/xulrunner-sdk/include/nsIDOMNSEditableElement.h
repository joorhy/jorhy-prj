/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/core/nsIDOMNSEditableElement.idl
 */
...
#define NS_DECL_NSIDOMNSEDITABLEELEMENT \
  ...
  NS_IMETHOD SetUserInput(const nsAString & input); 
...
#define NS_FORWARD_NSIDOMNSEDITABLEELEMENT(_to) \
  ...
  NS_IMETHOD SetUserInput(const nsAString & input) { return _to SetUserInput(input); } 
...
#define NS_FORWARD_SAFE_NSIDOMNSEDITABLEELEMENT(_to) \
  ...
  NS_IMETHOD SetUserInput(const nsAString & input) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetUserInput(input); } 
