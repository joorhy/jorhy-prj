/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/content/base/public/nsIFrameLoader.idl
 */
...
class NS_NO_VTABLE nsIFrameLoader : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetDelayRemoteDialogs(bool *aDelayRemoteDialogs) = 0;
  NS_IMETHOD SetDelayRemoteDialogs(bool aDelayRemoteDialogs) = 0;
...
#define NS_DECL_NSIFRAMELOADER \
  ...
  NS_IMETHOD GetDelayRemoteDialogs(bool *aDelayRemoteDialogs); \
  NS_IMETHOD SetDelayRemoteDialogs(bool aDelayRemoteDialogs); \
...
#define NS_FORWARD_NSIFRAMELOADER(_to) \
  ...
  NS_IMETHOD GetDelayRemoteDialogs(bool *aDelayRemoteDialogs) { return _to GetDelayRemoteDialogs(aDelayRemoteDialogs); } \
  NS_IMETHOD SetDelayRemoteDialogs(bool aDelayRemoteDialogs) { return _to SetDelayRemoteDialogs(aDelayRemoteDialogs); } \
...
#define NS_FORWARD_SAFE_NSIFRAMELOADER(_to) \
  ...
  NS_IMETHOD GetDelayRemoteDialogs(bool *aDelayRemoteDialogs) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDelayRemoteDialogs(aDelayRemoteDialogs); } \
  NS_IMETHOD SetDelayRemoteDialogs(bool aDelayRemoteDialogs) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDelayRemoteDialogs(aDelayRemoteDialogs); } \
...
/* attribute boolean delayRemoteDialogs; */
NS_IMETHODIMP nsFrameLoader::GetDelayRemoteDialogs(bool *aDelayRemoteDialogs)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsFrameLoader::SetDelayRemoteDialogs(bool aDelayRemoteDialogs)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
