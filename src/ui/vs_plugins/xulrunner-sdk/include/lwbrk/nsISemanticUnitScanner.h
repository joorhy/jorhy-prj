/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/intl/lwbrk/idl/nsISemanticUnitScanner.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISemanticUnitScanner : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval) = 0;
...
#define NS_DECL_NSISEMANTICUNITSCANNER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval); 
...
#define NS_FORWARD_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval) { return _to Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
...
#define NS_FORWARD_SAFE_NSISEMANTICUNITSCANNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Next(const PRUnichar *text, PRInt32 length, PRInt32 pos, PRBool isLastBuffer, PRInt32 *begin, PRInt32 *end, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Next(text, length, pos, isLastBuffer, begin, end, _retval); } 
