/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/editor/idl/nsPIEditorTransaction.idl
 */
...
class NS_NO_VTABLE nsPIEditorTransaction : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_PIEDITORTRANSACTION_IID)

  /* readonly attribute DOMString txnDescription; */
  NS_IMETHOD GetTxnDescription(nsAString & aTxnDescription) = 0;
...
#define NS_FORWARD_NSPIEDITORTRANSACTION(_to) \
  NS_IMETHOD GetTxnDescription(nsAString & aTxnDescription) { return _to GetTxnDescription(aTxnDescription); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSPIEDITORTRANSACTION(_to) \
  NS_IMETHOD GetTxnDescription(nsAString & aTxnDescription) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTxnDescription(aTxnDescription); } 
