/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpinstall/public/nsIXPIDialogService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPIDialogService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ConfirmInstall(nsIDOMWindow *parent, const PRUnichar **packageList, PRUint32 count, PRBool *_retval) = 0;
...
#define NS_DECL_NSIXPIDIALOGSERVICE \
  NS_SCRIPTABLE NS_IMETHOD ConfirmInstall(nsIDOMWindow *parent, const PRUnichar **packageList, PRUint32 count, PRBool *_retval); \
...
#define NS_FORWARD_NSIXPIDIALOGSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConfirmInstall(nsIDOMWindow *parent, const PRUnichar **packageList, PRUint32 count, PRBool *_retval) { return _to ConfirmInstall(parent, packageList, count, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXPIDIALOGSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConfirmInstall(nsIDOMWindow *parent, const PRUnichar **packageList, PRUint32 count, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConfirmInstall(parent, packageList, count, _retval); } \
...
/* boolean confirmInstall (in nsIDOMWindow parent, [array, size_is (count)] in wstring packageList, in unsigned long count); */
NS_IMETHODIMP nsXPIDialogService::ConfirmInstall(nsIDOMWindow *parent, const PRUnichar **packageList, PRUint32 count, PRBool *_retval)
{
