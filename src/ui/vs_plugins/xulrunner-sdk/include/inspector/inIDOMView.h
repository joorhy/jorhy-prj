/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/inspector/public/inIDOMView.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE inIDOMView : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNodeFromRowIndex(PRInt32 rowIndex, nsIDOMNode **_retval) = 0;

  /* long getRowIndexFromNode (in nsIDOMNode node); */
  NS_SCRIPTABLE NS_IMETHOD GetRowIndexFromNode(nsIDOMNode *node, PRInt32 *_retval) = 0;
...
#define NS_DECL_INIDOMVIEW \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNodeFromRowIndex(PRInt32 rowIndex, nsIDOMNode **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetRowIndexFromNode(nsIDOMNode *node, PRInt32 *_retval); \
...
#define NS_FORWARD_INIDOMVIEW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNodeFromRowIndex(PRInt32 rowIndex, nsIDOMNode **_retval) { return _to GetNodeFromRowIndex(rowIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetRowIndexFromNode(nsIDOMNode *node, PRInt32 *_retval) { return _to GetRowIndexFromNode(node, _retval); } \
...
#define NS_FORWARD_SAFE_INIDOMVIEW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNodeFromRowIndex(PRInt32 rowIndex, nsIDOMNode **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNodeFromRowIndex(rowIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetRowIndexFromNode(nsIDOMNode *node, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowIndexFromNode(node, _retval); } \
