/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/inspector/public/inISearchProcess.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE inISearchProcess : public nsISupports {
 public: 
  ...
  /* boolean searchStep (); */
  NS_SCRIPTABLE NS_IMETHOD SearchStep(PRBool *_retval) = 0;

  /* AString getStringResultAt (in long aIndex); */
  NS_SCRIPTABLE NS_IMETHOD GetStringResultAt(PRInt32 aIndex, nsAString & _retval) = 0;

  /* long getIntResultAt (in long aIndex); */
  NS_SCRIPTABLE NS_IMETHOD GetIntResultAt(PRInt32 aIndex, PRInt32 *_retval) = 0;

  /* unsigned long getUIntResultAt (in long aIndex); */
  NS_SCRIPTABLE NS_IMETHOD GetUIntResultAt(PRInt32 aIndex, PRUint32 *_retval) = 0;
...
#define NS_DECL_INISEARCHPROCESS \
  ...
  NS_SCRIPTABLE NS_IMETHOD SearchStep(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetStringResultAt(PRInt32 aIndex, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetIntResultAt(PRInt32 aIndex, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetUIntResultAt(PRInt32 aIndex, PRUint32 *_retval); 
...
#define NS_FORWARD_INISEARCHPROCESS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SearchStep(PRBool *_retval) { return _to SearchStep(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStringResultAt(PRInt32 aIndex, nsAString & _retval) { return _to GetStringResultAt(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIntResultAt(PRInt32 aIndex, PRInt32 *_retval) { return _to GetIntResultAt(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetUIntResultAt(PRInt32 aIndex, PRUint32 *_retval) { return _to GetUIntResultAt(aIndex, _retval); } 
...
#define NS_FORWARD_SAFE_INISEARCHPROCESS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SearchStep(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SearchStep(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStringResultAt(PRInt32 aIndex, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringResultAt(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIntResultAt(PRInt32 aIndex, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIntResultAt(aIndex, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetUIntResultAt(PRInt32 aIndex, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUIntResultAt(aIndex, _retval); } 
...
/* boolean searchStep (); */
NS_IMETHODIMP inSearchProcess::SearchStep(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString getStringResultAt (in long aIndex); */
NS_IMETHODIMP inSearchProcess::GetStringResultAt(PRInt32 aIndex, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long getIntResultAt (in long aIndex); */
NS_IMETHODIMP inSearchProcess::GetIntResultAt(PRInt32 aIndex, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* unsigned long getUIntResultAt (in long aIndex); */
NS_IMETHODIMP inSearchProcess::GetUIntResultAt(PRInt32 aIndex, PRUint32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
