/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsIURIWithPrincipal.idl
 */
...
class NS_NO_VTABLE nsIURIWithPrincipal : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri) = 0;
...
#define NS_DECL_NSIURIWITHPRINCIPAL \
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri); 
...
#define NS_FORWARD_NSIURIWITHPRINCIPAL(_to) \
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri) { return _to GetPrincipalUri(aPrincipalUri); } 
...
#define NS_FORWARD_SAFE_NSIURIWITHPRINCIPAL(_to) \
  ...
  NS_IMETHOD GetPrincipalUri(nsIURI * *aPrincipalUri) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrincipalUri(aPrincipalUri); } 
