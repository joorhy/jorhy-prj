/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/typeaheadfind/public/nsITypeAheadFind.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITypeAheadFind : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, PRBool aLinksOnly, PRUint16 *_retval) = 0;

  /* unsigned short findAgain (in boolean findBackwards, in boolean aLinksOnly); */
  NS_SCRIPTABLE NS_IMETHOD FindAgain(PRBool findBackwards, PRBool aLinksOnly, PRUint16 *_retval) = 0;
...
#define NS_DECL_NSITYPEAHEADFIND \
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, PRBool aLinksOnly, PRUint16 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD FindAgain(PRBool findBackwards, PRBool aLinksOnly, PRUint16 *_retval); \
...
#define NS_FORWARD_NSITYPEAHEADFIND(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, PRBool aLinksOnly, PRUint16 *_retval) { return _to Find(aSearchString, aLinksOnly, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindAgain(PRBool findBackwards, PRBool aLinksOnly, PRUint16 *_retval) { return _to FindAgain(findBackwards, aLinksOnly, _retval); } \
...
#define NS_FORWARD_SAFE_NSITYPEAHEADFIND(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Find(const nsAString & aSearchString, PRBool aLinksOnly, PRUint16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Find(aSearchString, aLinksOnly, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD FindAgain(PRBool findBackwards, PRBool aLinksOnly, PRUint16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindAgain(findBackwards, aLinksOnly, _retval); } \
...
/* unsigned short findAgain (in boolean findBackwards, in boolean aLinksOnly); */
NS_IMETHODIMP nsTypeAheadFind::FindAgain(PRBool findBackwards, PRBool aLinksOnly, PRUint16 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
