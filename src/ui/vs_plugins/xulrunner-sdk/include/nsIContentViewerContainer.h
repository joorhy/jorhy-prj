/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/docshell/base/nsIContentViewerContainer.idl
 */
...
class NS_NO_VTABLE nsIContentViewerContainer : public nsISupports {
 public: 
  ...
  NS_IMETHOD Embed(nsIContentViewer *aDocViewer, const char * aCommand, nsISupports *aExtraInfo) = 0;

  /* void setIsPrinting (in boolean aIsPrinting); */
  NS_IMETHOD SetIsPrinting(bool aIsPrinting) = 0;
...
#define NS_DECL_NSICONTENTVIEWERCONTAINER \
  NS_IMETHOD Embed(nsIContentViewer *aDocViewer, const char * aCommand, nsISupports *aExtraInfo); \
  NS_IMETHOD SetIsPrinting(bool aIsPrinting); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTENTVIEWERCONTAINER(_to) \
  NS_IMETHOD Embed(nsIContentViewer *aDocViewer, const char * aCommand, nsISupports *aExtraInfo) { return _to Embed(aDocViewer, aCommand, aExtraInfo); } \
  NS_IMETHOD SetIsPrinting(bool aIsPrinting) { return _to SetIsPrinting(aIsPrinting); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTENTVIEWERCONTAINER(_to) \
  NS_IMETHOD Embed(nsIContentViewer *aDocViewer, const char * aCommand, nsISupports *aExtraInfo) { return !_to ? NS_ERROR_NULL_POINTER : _to->Embed(aDocViewer, aCommand, aExtraInfo); } \
  NS_IMETHOD SetIsPrinting(bool aIsPrinting) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsPrinting(aIsPrinting); } 
...
/* void setIsPrinting (in boolean aIsPrinting); */
NS_IMETHODIMP nsContentViewerContainer::SetIsPrinting(bool aIsPrinting)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
