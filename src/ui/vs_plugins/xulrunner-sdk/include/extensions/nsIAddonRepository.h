/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/mozapps/extensions/public/nsIAddonRepository.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAddonRepository : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRecommendedURL(nsAString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchURL(const nsAString & aSearchTerms, nsAString & _retval) = 0;
...
#define NS_DECL_NSIADDONREPOSITORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRecommendedURL(nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetSearchURL(const nsAString & aSearchTerms, nsAString & _retval); \
...
#define NS_FORWARD_NSIADDONREPOSITORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRecommendedURL(nsAString & _retval) { return _to GetRecommendedURL(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSearchURL(const nsAString & aSearchTerms, nsAString & _retval) { return _to GetSearchURL(aSearchTerms, _retval); } \
...
#define NS_FORWARD_SAFE_NSIADDONREPOSITORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRecommendedURL(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRecommendedURL(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSearchURL(const nsAString & aSearchTerms, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSearchURL(aSearchTerms, _retval); } \
...
/* AString getRecommendedURL (); */
NS_IMETHODIMP nsAddonRepository::GetRecommendedURL(nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString getSearchURL (in AString aSearchTerms); */
NS_IMETHODIMP nsAddonRepository::GetSearchURL(const nsAString & aSearchTerms, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
