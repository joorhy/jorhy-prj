/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/js/src/xpconnect/idl/nsIActiveXSecurityPolicy.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIActiveXSecurityPolicy : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHostingFlags(const char *aContext, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSIACTIVEXSECURITYPOLICY \
  NS_SCRIPTABLE NS_IMETHOD GetHostingFlags(const char *aContext, PRUint32 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIACTIVEXSECURITYPOLICY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetHostingFlags(const char *aContext, PRUint32 *_retval) { return _to GetHostingFlags(aContext, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIACTIVEXSECURITYPOLICY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetHostingFlags(const char *aContext, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHostingFlags(aContext, _retval); } 
...
/* unsigned long getHostingFlags (in string aContext); */
NS_IMETHODIMP nsActiveXSecurityPolicy::GetHostingFlags(const char *aContext, PRUint32 *_retval)
{
