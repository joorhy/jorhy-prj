/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/js/src/xpconnect/idl/nsIXPConnect.idl
 */
...
class nsIXPConnect : public nsISupports {
 public: 
  ...
  NS_IMETHOD EvalInSandboxObject(const nsAString & source, JSContext * cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, jsval *_retval) = 0;
...
/* [noscript] JSVal evalInSandboxObject (in AString source, in JSContextPtr cx, in nsIXPConnectJSObjectHolder sandbox, in PRBool returnStringOnly); */
NS_IMETHODIMP nsXPConnect::EvalInSandboxObject(const nsAString & source, JSContext * cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, jsval *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* starting interface:    nsIXPConnect_1_9_0_BRANCH */
#define NS_IXPCONNECT_1_9_0_BRANCH_IID_STR "2f82dcf3-b2b3-4841-8a00-6080c45c0a4c"

#define NS_IXPCONNECT_1_9_0_BRANCH_IID \
  {0x2f82dcf3, 0xb2b3, 0x4841, \
    { 0x8a, 0x00, 0x60, 0x80, 0xc4, 0x5c, 0x0a, 0x4c }}

class NS_NO_VTABLE nsIXPConnect_1_9_0_BRANCH : public nsIXPConnect {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IXPCONNECT_1_9_0_BRANCH_IID)
  ...
  NS_IMETHOD GetWrapperForObject(JSContext * aJSContext, JSObject * aObject, JSObject * aScope, nsIPrincipal *aPrincipal, PRUint32 aFilenameFlags, jsval *_retval) = 0;

};

  NS_DEFINE_STATIC_IID_ACCESSOR(nsIXPConnect_1_9_0_BRANCH, NS_IXPCONNECT_1_9_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXPCONNECT_1_9_0_BRANCH \
  NS_IMETHOD GetWrapperForObject(JSContext * aJSContext, JSObject * aObject, JSObject * aScope, nsIPrincipal *aPrincipal, PRUint32 aFilenameFlags, jsval *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPCONNECT_1_9_0_BRANCH(_to) \
  NS_IMETHOD GetWrapperForObject(JSContext * aJSContext, JSObject * aObject, JSObject * aScope, nsIPrincipal *aPrincipal, PRUint32 aFilenameFlags, jsval *_retval) { return _to GetWrapperForObject(aJSContext, aObject, aScope, aPrincipal, aFilenameFlags, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPCONNECT_1_9_0_BRANCH(_to) \
  NS_IMETHOD GetWrapperForObject(JSContext * aJSContext, JSObject * aObject, JSObject * aScope, nsIPrincipal *aPrincipal, PRUint32 aFilenameFlags, jsval *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWrapperForObject(aJSContext, aObject, aScope, aPrincipal, aFilenameFlags, _retval); } 

#if 0
/* Use the code below as a template for the implementation class for this interface. */

/* Header file */
class nsXPConnect_1_9_0_BRANCH : public nsIXPConnect_1_9_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIXPCONNECT_1_9_0_BRANCH

  nsXPConnect_1_9_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsXPConnect_1_9_0_BRANCH, nsIXPConnect_1_9_0_BRANCH)

nsXPConnect_1_9_0_BRANCH::nsXPConnect_1_9_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* [noscript] JSVal getWrapperForObject (in JSContextPtr aJSContext, in JSObjectPtr aObject, in JSObjectPtr aScope, in nsIPrincipal aPrincipal, in unsigned long aFilenameFlags); */
NS_IMETHODIMP nsXPConnect_1_9_0_BRANCH::GetWrapperForObject(JSContext * aJSContext, JSObject * aObject, JSObject * aScope, nsIPrincipal *aPrincipal, PRUint32 aFilenameFlags, jsval *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
