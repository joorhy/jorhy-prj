/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/js/src/xpconnect/idl/nsIJSContextStack.idl
 */
...
class NS_NO_VTABLE nsIJSContextStackIterator : public nsISupports {
 public: 
  ...
  /**
     ...
     */
  /* boolean done (); */
  NS_IMETHOD Done(PRBool *_retval) = 0;
...
#define NS_DECL_NSIJSCONTEXTSTACKITERATOR \
  ...
  NS_IMETHOD Done(PRBool *_retval); \
...
#define NS_FORWARD_NSIJSCONTEXTSTACKITERATOR(_to) \
  ...
  NS_IMETHOD Done(PRBool *_retval) { return _to Done(_retval); } \
...
#define NS_FORWARD_SAFE_NSIJSCONTEXTSTACKITERATOR(_to) \
  ...
  NS_IMETHOD Done(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Done(_retval); } \
...
/* boolean done (); */
NS_IMETHODIMP nsJSContextStackIterator::Done(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
