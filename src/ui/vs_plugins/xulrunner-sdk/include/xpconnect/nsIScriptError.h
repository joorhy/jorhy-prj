/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/js/src/xpconnect/idl/nsIScriptError.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptError : public nsIConsoleMessage {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ToString(nsACString & _retval) = 0;
...
#define NS_DECL_NSISCRIPTERROR \
  ...
  NS_SCRIPTABLE NS_IMETHOD ToString(nsACString & _retval); 
...
#define NS_FORWARD_NSISCRIPTERROR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ToString(nsACString & _retval) { return _to ToString(_retval); } 
...
#define NS_FORWARD_SAFE_NSISCRIPTERROR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ToString(nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToString(_retval); } 
