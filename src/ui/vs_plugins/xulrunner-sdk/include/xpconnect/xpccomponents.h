/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/js/src/xpconnect/idl/xpccomponents.idl
 */
...
/* xpcIJSWeakReference getWeakReference (); */
NS_IMETHODIMP nsXPCComponents_Utils::GetWeakReference(xpcIJSWeakReference **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isSuccessCode (in nsresult result); */
NS_IMETHODIMP nsXPCComponents::IsSuccessCode(nsresult result, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
