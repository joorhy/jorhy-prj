/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsINSSCertCache.idl
 */
...
#define NS_DECL_NSINSSCERTCACHE \
  ...
  NS_IMETHOD CacheCertList(nsIX509CertList *list); \
  NS_IMETHOD GetX509CachedCerts(nsIX509CertList * *_retval); \
...
#define NS_FORWARD_NSINSSCERTCACHE(_to) \
  ...
  NS_IMETHOD CacheCertList(nsIX509CertList *list) { return _to CacheCertList(list); } \
  NS_IMETHOD GetX509CachedCerts(nsIX509CertList * *_retval) { return _to GetX509CachedCerts(_retval); } \
...
#define NS_FORWARD_SAFE_NSINSSCERTCACHE(_to) \
  ...
  NS_IMETHOD CacheCertList(nsIX509CertList *list) { return !_to ? NS_ERROR_NULL_POINTER : _to->CacheCertList(list); } \
  NS_IMETHOD GetX509CachedCerts(nsIX509CertList * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetX509CachedCerts(_retval); } \
  NS_IMETHOD_(void *) GetCachedCerts(void); 
