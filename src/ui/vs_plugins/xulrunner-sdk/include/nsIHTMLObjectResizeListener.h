/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/editor/idl/nsIHTMLObjectResizeListener.idl
 */
...
#define NS_DECL_NSIHTMLOBJECTRESIZELISTENER \
  NS_IMETHOD OnStartResizing(nsIDOMElement *aElement); \
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, int32_t aOldWidth, int32_t aOldHeight, int32_t aNewWidth, int32_t aNewHeight); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTMLOBJECTRESIZELISTENER(_to) \
  NS_IMETHOD OnStartResizing(nsIDOMElement *aElement) { return _to OnStartResizing(aElement); } \
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, int32_t aOldWidth, int32_t aOldHeight, int32_t aNewWidth, int32_t aNewHeight) { return _to OnEndResizing(aElement, aOldWidth, aOldHeight, aNewWidth, aNewHeight); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIHTMLOBJECTRESIZELISTENER(_to) \
  NS_IMETHOD OnStartResizing(nsIDOMElement *aElement) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStartResizing(aElement); } \
  NS_IMETHOD OnEndResizing(nsIDOMElement *aElement, int32_t aOldWidth, int32_t aOldHeight, int32_t aNewWidth, int32_t aNewHeight) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnEndResizing(aElement, aOldWidth, aOldHeight, aNewWidth, aNewHeight); } 
