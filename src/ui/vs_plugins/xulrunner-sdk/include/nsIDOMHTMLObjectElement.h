/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/html/nsIDOMHTMLObjectElement.idl
 */
...
#define NS_IDOMHTMLOBJECTELEMENT_IID_STR "a70595dd-68a5-41f5-ab52-73a47d98bd78"

#define NS_IDOMHTMLOBJECTELEMENT_IID \
  {0xa70595dd, 0x68a5, 0x41f5, \
    { 0xab, 0x52, 0x73, 0xa4, 0x7d, 0x98, 0xbd, 0x78 }}
...
#define NS_DECL_NSIDOMHTMLOBJECTELEMENT \
  ...
  NS_IMETHOD GetDeclare(bool *aDeclare); \
  NS_IMETHOD SetDeclare(bool aDeclare); \
...
#define NS_FORWARD_NSIDOMHTMLOBJECTELEMENT(_to) \
  ...
  NS_IMETHOD GetDeclare(bool *aDeclare) { return _to GetDeclare(aDeclare); } \
  NS_IMETHOD SetDeclare(bool aDeclare) { return _to SetDeclare(aDeclare); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLOBJECTELEMENT(_to) \
  ...
  NS_IMETHOD GetDeclare(bool *aDeclare) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDeclare(aDeclare); } \
  NS_IMETHOD SetDeclare(bool aDeclare) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDeclare(aDeclare); } \
