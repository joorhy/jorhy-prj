/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/base/nsIContentViewer.idl
 */
...
#define NS_ICONTENTVIEWER_IID_STR "89653afe-182f-401f-9f3c-8858d91387cd"

#define NS_ICONTENTVIEWER_IID \
  {0x89653afe, 0x182f, 0x401f, \
    { 0x9f, 0x3c, 0x88, 0x58, 0xd9, 0x13, 0x87, 0xcd }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIContentViewer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD PermitUnload(PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD RequestWindowClose(PRBool *_retval) = 0;
...
#define NS_DECL_NSICONTENTVIEWER \
  ...
  NS_SCRIPTABLE NS_IMETHOD PermitUnload(PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD RequestWindowClose(PRBool *_retval); \
...
#define NS_FORWARD_NSICONTENTVIEWER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PermitUnload(PRBool *_retval) { return _to PermitUnload(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RequestWindowClose(PRBool *_retval) { return _to RequestWindowClose(_retval); } \
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PermitUnload(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PermitUnload(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RequestWindowClose(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RequestWindowClose(_retval); } \
