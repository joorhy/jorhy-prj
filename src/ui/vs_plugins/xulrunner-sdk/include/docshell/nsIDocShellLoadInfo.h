/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/base/nsIDocShellLoadInfo.idl
 */
...
/* starting interface:    nsIDocShellLoadInfo_1_9_0_BRANCH */
#define NS_IDOCSHELLLOADINFO_1_9_0_BRANCH_IID_STR "b66d94ba-4457-41b1-9507-79c1cd873da0"

#define NS_IDOCSHELLLOADINFO_1_9_0_BRANCH_IID \
  {0xb66d94ba, 0x4457, 0x41b1, \
    { 0x95, 0x07, 0x79, 0xc1, 0xcd, 0x87, 0x3d, 0xa0 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIDocShellLoadInfo_1_9_0_BRANCH : public nsIDocShellLoadInfo {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOCSHELLLOADINFO_1_9_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDocShellLoadInfo_1_9_0_BRANCH, NS_IDOCSHELLLOADINFO_1_9_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOCSHELLLOADINFO_1_9_0_BRANCH \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOCSHELLLOADINFO_1_9_0_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOCSHELLLOADINFO_1_9_0_BRANCH(_to) \
...
/* Header file */
class nsDocShellLoadInfo_1_9_0_BRANCH : public nsIDocShellLoadInfo_1_9_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIDOCSHELLLOADINFO_1_9_0_BRANCH

  nsDocShellLoadInfo_1_9_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDocShellLoadInfo_1_9_0_BRANCH, nsIDocShellLoadInfo_1_9_0_BRANCH)

nsDocShellLoadInfo_1_9_0_BRANCH::nsDocShellLoadInfo_1_9_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* attribute boolean ownerIsExplicit; */
NS_IMETHODIMP nsDocShellLoadInfo_1_9_0_BRANCH::GetOwnerIsExplicit(PRBool *aOwnerIsExplicit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDocShellLoadInfo_1_9_0_BRANCH::SetOwnerIsExplicit(PRBool aOwnerIsExplicit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
