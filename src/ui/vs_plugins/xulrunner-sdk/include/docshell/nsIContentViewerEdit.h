/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/base/nsIContentViewerEdit.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIContentViewerEdit : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval) = 0;
...
#define NS_DECL_NSICONTENTVIEWEREDIT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval); \
...
#define NS_FORWARD_NSICONTENTVIEWEREDIT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval) { return _to GetContents(aMimeType, aSelectionOnly, _retval); } \
...
#define NS_FORWARD_SAFE_NSICONTENTVIEWEREDIT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetContents(const char *aMimeType, PRBool aSelectionOnly, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetContents(aMimeType, aSelectionOnly, _retval); } \
