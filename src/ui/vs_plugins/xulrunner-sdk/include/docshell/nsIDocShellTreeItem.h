/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/base/nsIDocShellTreeItem.idl
 */
 ...
 */
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar *name, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD FindItemWithName(const PRUnichar *name, nsISupports *aRequestor, nsIDocShellTreeItem *aOriginalRequestor, nsIDocShellTreeItem **_retval) = 0;
...
#define NS_DECL_NSIDOCSHELLTREEITEM \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar *name, PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindItemWithName(const PRUnichar *name, nsISupports *aRequestor, nsIDocShellTreeItem *aOriginalRequestor, nsIDocShellTreeItem **_retval); \
...
#define NS_FORWARD_NSIDOCSHELLTREEITEM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar *name, PRBool *_retval) { return _to NameEquals(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindItemWithName(const PRUnichar *name, nsISupports *aRequestor, nsIDocShellTreeItem *aOriginalRequestor, nsIDocShellTreeItem **_retval) { return _to FindItemWithName(name, aRequestor, aOriginalRequestor, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOCSHELLTREEITEM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD NameEquals(const PRUnichar *name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NameEquals(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD FindItemWithName(const PRUnichar *name, nsISupports *aRequestor, nsIDocShellTreeItem *aOriginalRequestor, nsIDocShellTreeItem **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindItemWithName(name, aRequestor, aOriginalRequestor, _retval); } \
