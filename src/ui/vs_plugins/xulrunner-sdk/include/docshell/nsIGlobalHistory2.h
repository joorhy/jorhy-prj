/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/docshell/base/nsIGlobalHistory2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGlobalHistory2 : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, PRBool *_retval) = 0;
...
#define NS_DECL_NSIGLOBALHISTORY2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, PRBool *_retval); \
...
#define NS_FORWARD_NSIGLOBALHISTORY2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, PRBool *_retval) { return _to IsVisited(aURI, _retval); } \
...
#define NS_FORWARD_SAFE_NSIGLOBALHISTORY2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsVisited(aURI, _retval); } \
