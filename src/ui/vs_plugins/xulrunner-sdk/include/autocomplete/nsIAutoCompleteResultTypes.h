/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/autocomplete/public/nsIAutoCompleteResultTypes.idl
 */
...
class NS_NO_VTABLE nsIAutoCompleteMdbResult : public nsIAutoCompleteBaseResult {
 public: 
  ...
  NS_IMETHOD GetRowAt(PRUint32 rowIndex, nsIMdbRow **_retval) = 0;

  /* AString getRowValue (in nsIMdbRow row, in mdb_column col); */
  NS_IMETHOD GetRowValue(nsIMdbRow *row, mdb_column col, nsAString & _retval) = 0;

  /* AUTF8String getUTF8RowValue (in nsIMdbRow row, in mdb_column col); */
  NS_IMETHOD GetUTF8RowValue(nsIMdbRow *row, mdb_column col, nsACString & _retval) = 0;

  /* long getIntRowValue (in nsIMdbRow row, in mdb_column col); */
  NS_IMETHOD GetIntRowValue(nsIMdbRow *row, mdb_column col, PRInt32 *_retval) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETEMDBRESULT \
  ...
  NS_IMETHOD GetRowAt(PRUint32 rowIndex, nsIMdbRow **_retval); \
  NS_IMETHOD GetRowValue(nsIMdbRow *row, mdb_column col, nsAString & _retval); \
  NS_IMETHOD GetUTF8RowValue(nsIMdbRow *row, mdb_column col, nsACString & _retval); \
  NS_IMETHOD GetIntRowValue(nsIMdbRow *row, mdb_column col, PRInt32 *_retval); 
...
#define NS_FORWARD_NSIAUTOCOMPLETEMDBRESULT(_to) \
  ...
  NS_IMETHOD GetRowAt(PRUint32 rowIndex, nsIMdbRow **_retval) { return _to GetRowAt(rowIndex, _retval); } \
  NS_IMETHOD GetRowValue(nsIMdbRow *row, mdb_column col, nsAString & _retval) { return _to GetRowValue(row, col, _retval); } \
  NS_IMETHOD GetUTF8RowValue(nsIMdbRow *row, mdb_column col, nsACString & _retval) { return _to GetUTF8RowValue(row, col, _retval); } \
  NS_IMETHOD GetIntRowValue(nsIMdbRow *row, mdb_column col, PRInt32 *_retval) { return _to GetIntRowValue(row, col, _retval); } 
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETEMDBRESULT(_to) \
  ...
  NS_IMETHOD GetRowAt(PRUint32 rowIndex, nsIMdbRow **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowAt(rowIndex, _retval); } \
  NS_IMETHOD GetRowValue(nsIMdbRow *row, mdb_column col, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowValue(row, col, _retval); } \
  NS_IMETHOD GetUTF8RowValue(nsIMdbRow *row, mdb_column col, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUTF8RowValue(row, col, _retval); } \
  NS_IMETHOD GetIntRowValue(nsIMdbRow *row, mdb_column col, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIntRowValue(row, col, _retval); } 
...
/* nsIMdbRow getRowAt (in unsigned long rowIndex); */
NS_IMETHODIMP nsAutoCompleteMdbResult::GetRowAt(PRUint32 rowIndex, nsIMdbRow **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString getRowValue (in nsIMdbRow row, in mdb_column col); */
NS_IMETHODIMP nsAutoCompleteMdbResult::GetRowValue(nsIMdbRow *row, mdb_column col, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AUTF8String getUTF8RowValue (in nsIMdbRow row, in mdb_column col); */
NS_IMETHODIMP nsAutoCompleteMdbResult::GetUTF8RowValue(nsIMdbRow *row, mdb_column col, nsACString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long getIntRowValue (in nsIMdbRow row, in mdb_column col); */
NS_IMETHODIMP nsAutoCompleteMdbResult::GetIntRowValue(nsIMdbRow *row, mdb_column col, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
