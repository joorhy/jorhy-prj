/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/autocomplete/public/nsIAutoCompleteController.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteController : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(PRBool aIsPopupSelection, PRBool *_retval) = 0;

  /* boolean handleEscape (); */
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, PRBool *_retval) = 0;

  /* boolean handleDelete (); */
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(PRBool *_retval) = 0;

  /* AString getValueAt (in long index); */
  NS_SCRIPTABLE NS_IMETHOD GetValueAt(PRInt32 index, nsAString & _retval) = 0;

  /* AString getCommentAt (in long index); */
  NS_SCRIPTABLE NS_IMETHOD GetCommentAt(PRInt32 index, nsAString & _retval) = 0;

  /* AString getStyleAt (in long index); */
  NS_SCRIPTABLE NS_IMETHOD GetStyleAt(PRInt32 index, nsAString & _retval) = 0;

  /* AString getImageAt (in long index); */
  NS_SCRIPTABLE NS_IMETHOD GetImageAt(PRInt32 index, nsAString & _retval) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETECONTROLLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(PRBool aIsPopupSelection, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetValueAt(PRInt32 index, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetCommentAt(PRInt32 index, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetStyleAt(PRInt32 index, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetImageAt(PRInt32 index, nsAString & _retval); \
...
#define NS_FORWARD_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(PRBool aIsPopupSelection, PRBool *_retval) { return _to HandleEnter(aIsPopupSelection, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(PRBool *_retval) { return _to HandleEscape(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, PRBool *_retval) { return _to HandleKeyNavigation(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(PRBool *_retval) { return _to HandleDelete(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetValueAt(PRInt32 index, nsAString & _retval) { return _to GetValueAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCommentAt(PRInt32 index, nsAString & _retval) { return _to GetCommentAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStyleAt(PRInt32 index, nsAString & _retval) { return _to GetStyleAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetImageAt(PRInt32 index, nsAString & _retval) { return _to GetImageAt(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleEnter(PRBool aIsPopupSelection, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEnter(aIsPopupSelection, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleEscape(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEscape(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyNavigation(PRUint32 key, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleKeyNavigation(key, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HandleDelete(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleDelete(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetValueAt(PRInt32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValueAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCommentAt(PRInt32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCommentAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStyleAt(PRInt32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStyleAt(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetImageAt(PRInt32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageAt(index, _retval); } \
...
/* boolean handleEnter (in boolean aIsPopupSelection); */
NS_IMETHODIMP nsAutoCompleteController::HandleEnter(PRBool aIsPopupSelection, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean handleKeyNavigation (in unsigned long key); */
NS_IMETHODIMP nsAutoCompleteController::HandleKeyNavigation(PRUint32 key, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* AString getImageAt (in long index); */
NS_IMETHODIMP nsAutoCompleteController::GetImageAt(PRInt32 index, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
