/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/autocomplete/public/nsIAutoCompleteInput.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteInput : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchAt(PRUint32 index, nsACString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD OnTextEntered(PRBool *_retval) = 0;

  /* boolean onTextReverted (); */
  NS_SCRIPTABLE NS_IMETHOD OnTextReverted(PRBool *_retval) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETEINPUT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchAt(PRUint32 index, nsACString & _retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnTextEntered(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD OnTextReverted(PRBool *_retval); \
...
#define NS_FORWARD_NSIAUTOCOMPLETEINPUT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchAt(PRUint32 index, nsACString & _retval) { return _to GetSearchAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnTextEntered(PRBool *_retval) { return _to OnTextEntered(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnTextReverted(PRBool *_retval) { return _to OnTextReverted(_retval); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETEINPUT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchAt(PRUint32 index, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSearchAt(index, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnTextEntered(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnTextEntered(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnTextReverted(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnTextReverted(_retval); } \
