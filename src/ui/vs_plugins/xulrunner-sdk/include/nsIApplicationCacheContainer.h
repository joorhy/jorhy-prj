/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsIApplicationCacheContainer.idl
 */
...
class NS_NO_VTABLE nsIApplicationCacheContainer : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetApplicationCache(nsIApplicationCache * *aApplicationCache) = 0;
  NS_IMETHOD SetApplicationCache(nsIApplicationCache *aApplicationCache) = 0;
...
#define NS_DECL_NSIAPPLICATIONCACHECONTAINER \
  NS_IMETHOD GetApplicationCache(nsIApplicationCache * *aApplicationCache); \
  NS_IMETHOD SetApplicationCache(nsIApplicationCache *aApplicationCache); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAPPLICATIONCACHECONTAINER(_to) \
  NS_IMETHOD GetApplicationCache(nsIApplicationCache * *aApplicationCache) { return _to GetApplicationCache(aApplicationCache); } \
  NS_IMETHOD SetApplicationCache(nsIApplicationCache *aApplicationCache) { return _to SetApplicationCache(aApplicationCache); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAPPLICATIONCACHECONTAINER(_to) \
  NS_IMETHOD GetApplicationCache(nsIApplicationCache * *aApplicationCache) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetApplicationCache(aApplicationCache); } \
  NS_IMETHOD SetApplicationCache(nsIApplicationCache *aApplicationCache) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetApplicationCache(aApplicationCache); } 
