/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/uriloader/prefetch/nsIPrefetchService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrefetchService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateQueue(PRBool aIncludeNormalItems, PRBool aIncludeOfflineItems, nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_NSIPREFETCHSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateQueue(PRBool aIncludeNormalItems, PRBool aIncludeOfflineItems, nsISimpleEnumerator **_retval); 
...
#define NS_FORWARD_NSIPREFETCHSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateQueue(PRBool aIncludeNormalItems, PRBool aIncludeOfflineItems, nsISimpleEnumerator **_retval) { return _to EnumerateQueue(aIncludeNormalItems, aIncludeOfflineItems, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPREFETCHSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateQueue(PRBool aIncludeNormalItems, PRBool aIncludeOfflineItems, nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateQueue(aIncludeNormalItems, aIncludeOfflineItems, _retval); } 
...
/* nsISimpleEnumerator enumerateQueue (in boolean aIncludeNormalItems, in boolean aIncludeOfflineItems); */
NS_IMETHODIMP nsPrefetchService::EnumerateQueue(PRBool aIncludeNormalItems, PRBool aIncludeOfflineItems, nsISimpleEnumerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
