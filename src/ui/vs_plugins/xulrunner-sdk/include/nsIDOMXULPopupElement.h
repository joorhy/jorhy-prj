/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/xul/nsIDOMXULPopupElement.idl
 */
...
#define NS_DECL_NSIDOMXULPOPUPELEMENT \
  ...
  NS_IMETHOD ShowPopup(uint16_t alignment, nsIDOMElement *target, nsIDOMElement *anchor); \
...
#define NS_FORWARD_NSIDOMXULPOPUPELEMENT(_to) \
  ...
  NS_IMETHOD ShowPopup(uint16_t alignment, nsIDOMElement *target, nsIDOMElement *anchor) { return _to ShowPopup(alignment, target, anchor); } \
...
#define NS_FORWARD_SAFE_NSIDOMXULPOPUPELEMENT(_to) \
  ...
  NS_IMETHOD ShowPopup(uint16_t alignment, nsIDOMElement *target, nsIDOMElement *anchor) { return !_to ? NS_ERROR_NULL_POINTER : _to->ShowPopup(alignment, target, anchor); } \
