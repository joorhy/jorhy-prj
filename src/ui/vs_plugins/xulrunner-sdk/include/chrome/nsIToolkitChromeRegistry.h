/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/chrome/public/nsIToolkitChromeRegistry.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIToolkitChromeRegistry : public nsIXULChromeRegistry {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalesForPackage(const nsACString & aPackage, nsIUTF8StringEnumerator **_retval) = 0;
...
#define NS_DECL_NSITOOLKITCHROMEREGISTRY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalesForPackage(const nsACString & aPackage, nsIUTF8StringEnumerator **_retval); 
...
#define NS_FORWARD_NSITOOLKITCHROMEREGISTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalesForPackage(const nsACString & aPackage, nsIUTF8StringEnumerator **_retval) { return _to GetLocalesForPackage(aPackage, _retval); } 
...
#define NS_FORWARD_SAFE_NSITOOLKITCHROMEREGISTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalesForPackage(const nsACString & aPackage, nsIUTF8StringEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalesForPackage(aPackage, _retval); } 
