/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsICMSDecoder.idl
 */
...
class NS_NO_VTABLE nsICMSDecoder : public nsISupports {
 public: 
  ...
  NS_IMETHOD Update(const char * aBuf, int32_t aLen) = 0;

  /* void finish (out nsICMSMessage msg); */
  NS_IMETHOD Finish(nsICMSMessage * *msg) = 0;
...
#define NS_DECL_NSICMSDECODER \
  ...
  NS_IMETHOD Update(const char * aBuf, int32_t aLen); \
  NS_IMETHOD Finish(nsICMSMessage * *msg); 
...
#define NS_FORWARD_NSICMSDECODER(_to) \
  ...
  NS_IMETHOD Update(const char * aBuf, int32_t aLen) { return _to Update(aBuf, aLen); } \
  NS_IMETHOD Finish(nsICMSMessage * *msg) { return _to Finish(msg); } 
...
#define NS_FORWARD_SAFE_NSICMSDECODER(_to) \
  ...
  NS_IMETHOD Update(const char * aBuf, int32_t aLen) { return !_to ? NS_ERROR_NULL_POINTER : _to->Update(aBuf, aLen); } \
  NS_IMETHOD Finish(nsICMSMessage * *msg) { return !_to ? NS_ERROR_NULL_POINTER : _to->Finish(msg); } 
...
/* void update (in string aBuf, in long aLen); */
NS_IMETHODIMP nsCMSDecoder::Update(const char * aBuf, int32_t aLen)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void finish (out nsICMSMessage msg); */
NS_IMETHODIMP nsCMSDecoder::Finish(nsICMSMessage * *msg)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
