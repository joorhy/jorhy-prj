/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/toolkit/components/feeds/public/nsIFeedTextConstruct.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFeedTextConstruct : public nsISupports {
 public: 
   ...
   */
  /* AString plainText (); */
  NS_SCRIPTABLE NS_IMETHOD PlainText(nsAString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateDocumentFragment(nsIDOMElement *element, nsIDOMDocumentFragment **_retval) = 0;
...
#define NS_DECL_NSIFEEDTEXTCONSTRUCT \
  ...
  NS_SCRIPTABLE NS_IMETHOD PlainText(nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateDocumentFragment(nsIDOMElement *element, nsIDOMDocumentFragment **_retval); 
...
#define NS_FORWARD_NSIFEEDTEXTCONSTRUCT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PlainText(nsAString & _retval) { return _to PlainText(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateDocumentFragment(nsIDOMElement *element, nsIDOMDocumentFragment **_retval) { return _to CreateDocumentFragment(element, _retval); } 
...
#define NS_FORWARD_SAFE_NSIFEEDTEXTCONSTRUCT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PlainText(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->PlainText(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateDocumentFragment(nsIDOMElement *element, nsIDOMDocumentFragment **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateDocumentFragment(element, _retval); } 
