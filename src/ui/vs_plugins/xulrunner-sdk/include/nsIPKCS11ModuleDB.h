/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsIPKCS11ModuleDB.idl
 */
...
class NS_NO_VTABLE nsIPKCS11ModuleDB : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS) = 0;

  /* void toggleFIPSMode (); */
  NS_IMETHOD ToggleFIPSMode(void) = 0;

  /* readonly attribute boolean isFIPSEnabled; */
  NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled) = 0;
...
#define NS_DECL_NSIPKCS11MODULEDB \
  ...
  NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS); \
  NS_IMETHOD ToggleFIPSMode(void); \
  NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled); 
...
#define NS_FORWARD_NSIPKCS11MODULEDB(_to) \
  ...
  NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS) { return _to GetCanToggleFIPS(aCanToggleFIPS); } \
  NS_IMETHOD ToggleFIPSMode(void) { return _to ToggleFIPSMode(); } \
  NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled) { return _to GetIsFIPSEnabled(aIsFIPSEnabled); } 
...
#define NS_FORWARD_SAFE_NSIPKCS11MODULEDB(_to) \
  ...
  NS_IMETHOD GetCanToggleFIPS(bool *aCanToggleFIPS) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanToggleFIPS(aCanToggleFIPS); } \
  NS_IMETHOD ToggleFIPSMode(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToggleFIPSMode(); } \
  NS_IMETHOD GetIsFIPSEnabled(bool *aIsFIPSEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFIPSEnabled(aIsFIPSEnabled); } 
