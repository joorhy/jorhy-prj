/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/xul/base/public/nsIScrollBoxObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScrollBoxObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height) = 0;
...
#define NS_DECL_NSISCROLLBOXOBJECT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height); \
...
#define NS_FORWARD_NSISCROLLBOXOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height) { return _to GetScrolledSize(width, height); } \
...
#define NS_FORWARD_SAFE_NSISCROLLBOXOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrolledSize(PRInt32 *width, PRInt32 *height) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScrolledSize(width, height); } \
