/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/xul/base/public/nsIMenuBoxObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMenuBoxObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval) = 0;
...
#define NS_DECL_NSIMENUBOXOBJECT \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval); 
...
#define NS_FORWARD_NSIMENUBOXOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval) { return _to HandleKeyPress(keyEvent, _retval); } 
...
#define NS_FORWARD_SAFE_NSIMENUBOXOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleKeyPress(nsIDOMKeyEvent *keyEvent, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleKeyPress(keyEvent, _retval); } 
