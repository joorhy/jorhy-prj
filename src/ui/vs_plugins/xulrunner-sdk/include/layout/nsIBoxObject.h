/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/xul/base/public/nsIBoxObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBoxObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsSupports(const PRUnichar *propertyName, nsISupports **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const PRUnichar *propertyName, PRUnichar **_retval) = 0;
...
#define NS_DECL_NSIBOXOBJECT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsSupports(const PRUnichar *propertyName, nsISupports **_retval); \
  NS_SCRIPTABLE NS_IMETHOD SetPropertyAsSupports(const PRUnichar *propertyName, nsISupports *value); \
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const PRUnichar *propertyName, PRUnichar **_retval); \
...
#define NS_FORWARD_NSIBOXOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsSupports(const PRUnichar *propertyName, nsISupports **_retval) { return _to GetPropertyAsSupports(propertyName, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const PRUnichar *propertyName, PRUnichar **_retval) { return _to GetProperty(propertyName, _retval); } \
...
#define NS_FORWARD_SAFE_NSIBOXOBJECT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyAsSupports(const PRUnichar *propertyName, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPropertyAsSupports(propertyName, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProperty(const PRUnichar *propertyName, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProperty(propertyName, _retval); } \
