/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/xul/base/public/nsIListBoxObject.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIListBoxObject : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetListboxBody(nsIListBoxObject * *aListboxBody) = 0;

  /* long getRowCount (); */
  NS_SCRIPTABLE NS_IMETHOD GetRowCount(PRInt32 *_retval) = 0;

  /* long getNumberOfVisibleRows (); */
  NS_SCRIPTABLE NS_IMETHOD GetNumberOfVisibleRows(PRInt32 *_retval) = 0;

  /* long getIndexOfFirstVisibleRow (); */
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfFirstVisibleRow(PRInt32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMElement **_retval) = 0;

  /* long getIndexOfItem (in nsIDOMElement item); */
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMElement *item, PRInt32 *_retval) = 0;
...
#define NS_DECL_NSILISTBOXOBJECT \
  NS_SCRIPTABLE NS_IMETHOD GetListboxBody(nsIListBoxObject * *aListboxBody); \
  NS_SCRIPTABLE NS_IMETHOD GetRowCount(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetNumberOfVisibleRows(PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfFirstVisibleRow(PRInt32 *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMElement **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMElement *item, PRInt32 *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSILISTBOXOBJECT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetListboxBody(nsIListBoxObject * *aListboxBody) { return _to GetListboxBody(aListboxBody); } \
  NS_SCRIPTABLE NS_IMETHOD GetRowCount(PRInt32 *_retval) { return _to GetRowCount(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNumberOfVisibleRows(PRInt32 *_retval) { return _to GetNumberOfVisibleRows(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfFirstVisibleRow(PRInt32 *_retval) { return _to GetIndexOfFirstVisibleRow(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMElement **_retval) { return _to GetItemAtIndex(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMElement *item, PRInt32 *_retval) { return _to GetIndexOfItem(item, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSILISTBOXOBJECT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetListboxBody(nsIListBoxObject * *aListboxBody) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetListboxBody(aListboxBody); } \
  NS_SCRIPTABLE NS_IMETHOD GetRowCount(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRowCount(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNumberOfVisibleRows(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNumberOfVisibleRows(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfFirstVisibleRow(PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOfFirstVisibleRow(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItemAtIndex(PRInt32 index, nsIDOMElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAtIndex(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetIndexOfItem(nsIDOMElement *item, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexOfItem(item, _retval); } 
