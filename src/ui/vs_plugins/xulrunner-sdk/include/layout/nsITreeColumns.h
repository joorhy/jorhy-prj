/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/xul/base/src/tree/public/nsITreeColumns.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITreeColumn : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsITreeColumn **_retval) = 0;

  /* nsITreeColumn getPrevious (); */
  NS_SCRIPTABLE NS_IMETHOD GetPrevious(nsITreeColumn **_retval) = 0;
...
#define NS_DECL_NSITREECOLUMN \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetPrevious(nsITreeColumn **_retval); \
...
#define NS_FORWARD_NSITREECOLUMN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsITreeColumn **_retval) { return _to GetNext(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrevious(nsITreeColumn **_retval) { return _to GetPrevious(_retval); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNext(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrevious(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrevious(_retval); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITreeColumns : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstColumn(nsITreeColumn **_retval) = 0;

  /* nsITreeColumn getLastColumn (); */
  NS_SCRIPTABLE NS_IMETHOD GetLastColumn(nsITreeColumn **_retval) = 0;

  /**
   * Attribute based column getters.
   */
  /* nsITreeColumn getPrimaryColumn (); */
  NS_SCRIPTABLE NS_IMETHOD GetPrimaryColumn(nsITreeColumn **_retval) = 0;

  /* nsITreeColumn getSortedColumn (); */
  NS_SCRIPTABLE NS_IMETHOD GetSortedColumn(nsITreeColumn **_retval) = 0;

  /* nsITreeColumn getKeyColumn (); */
  NS_SCRIPTABLE NS_IMETHOD GetKeyColumn(nsITreeColumn **_retval) = 0;

  /**
   * Get the column for the given element.
   */
  /* nsITreeColumn getColumnFor (in nsIDOMElement element); */
  NS_SCRIPTABLE NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn **_retval) = 0;

  /**
   * Parametric column getters.
   */
  /* nsITreeColumn getNamedColumn (in AString id); */
  NS_SCRIPTABLE NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn **_retval) = 0;

  /* nsITreeColumn getColumnAt (in long index); */
  NS_SCRIPTABLE NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval) = 0;
...
#define NS_DECL_NSITREECOLUMNS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstColumn(nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetLastColumn(nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetPrimaryColumn(nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetSortedColumn(nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetKeyColumn(nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval); \
...
#define NS_FORWARD_NSITREECOLUMNS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstColumn(nsITreeColumn **_retval) { return _to GetFirstColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLastColumn(nsITreeColumn **_retval) { return _to GetLastColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrimaryColumn(nsITreeColumn **_retval) { return _to GetPrimaryColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSortedColumn(nsITreeColumn **_retval) { return _to GetSortedColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetKeyColumn(nsITreeColumn **_retval) { return _to GetKeyColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn **_retval) { return _to GetColumnFor(element, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn **_retval) { return _to GetNamedColumn(id, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval) { return _to GetColumnAt(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSITREECOLUMNS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFirstColumn(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFirstColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLastColumn(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPrimaryColumn(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPrimaryColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSortedColumn(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSortedColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetKeyColumn(nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeyColumn(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetColumnFor(nsIDOMElement *element, nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetColumnFor(element, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetNamedColumn(const nsAString & id, nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNamedColumn(id, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetColumnAt(PRInt32 index, nsITreeColumn **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetColumnAt(index, _retval); } \
