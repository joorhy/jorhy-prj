/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/layout/base/nsIStyleSheetService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIStyleSheetService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SheetRegistered(nsIURI *sheetURI, PRUint32 type, PRBool *_retval) = 0;
...
#define NS_DECL_NSISTYLESHEETSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD SheetRegistered(nsIURI *sheetURI, PRUint32 type, PRBool *_retval); \
...
#define NS_FORWARD_NSISTYLESHEETSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SheetRegistered(nsIURI *sheetURI, PRUint32 type, PRBool *_retval) { return _to SheetRegistered(sheetURI, type, _retval); } \
...
#define NS_FORWARD_SAFE_NSISTYLESHEETSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SheetRegistered(nsIURI *sheetURI, PRUint32 type, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SheetRegistered(sheetURI, type, _retval); } \
