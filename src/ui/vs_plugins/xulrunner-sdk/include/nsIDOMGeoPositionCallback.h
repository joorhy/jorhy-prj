/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/geolocation/nsIDOMGeoPositionCallback.idl
 */
...
#define NS_DECL_NSIDOMGEOPOSITIONCALLBACK \
  NS_IMETHOD HandleEvent(nsIDOMGeoPosition *position); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGEOPOSITIONCALLBACK(_to) \
  NS_IMETHOD HandleEvent(nsIDOMGeoPosition *position) { return _to HandleEvent(position); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGEOPOSITIONCALLBACK(_to) \
  NS_IMETHOD HandleEvent(nsIDOMGeoPosition *position) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEvent(position); } 
