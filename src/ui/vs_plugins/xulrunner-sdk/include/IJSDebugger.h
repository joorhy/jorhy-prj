/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/js/ductwork/debugger/IJSDebugger.idl
 */
...
class NS_NO_VTABLE IJSDebugger : public nsISupports {
 public: 
  ...
  NS_IMETHOD AddClass(const JS::Value & global, JSContext* cx) = 0;
...
#define NS_DECL_IJSDEBUGGER \
  NS_IMETHOD AddClass(const JS::Value & global, JSContext* cx); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_IJSDEBUGGER(_to) \
  NS_IMETHOD AddClass(const JS::Value & global, JSContext* cx) { return _to AddClass(global, cx); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_IJSDEBUGGER(_to) \
  NS_IMETHOD AddClass(const JS::Value & global, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddClass(global, cx); } 
...
/* [implicit_jscontext] void addClass (in jsval global); */
NS_IMETHODIMP _MYCLASS_::AddClass(const JS::Value & global, JSContext* cx)
{
