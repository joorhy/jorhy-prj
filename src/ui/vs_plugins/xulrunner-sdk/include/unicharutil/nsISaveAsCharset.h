/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/intl/unicharutil/idl/nsISaveAsCharset.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISaveAsCharset : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Convert(const PRUnichar *inString, char **_retval) = 0;
...
#define NS_DECL_NSISAVEASCHARSET \
  ...
  NS_SCRIPTABLE NS_IMETHOD Convert(const PRUnichar *inString, char **_retval); 
...
#define NS_FORWARD_NSISAVEASCHARSET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Convert(const PRUnichar *inString, char **_retval) { return _to Convert(inString, _retval); } 
...
#define NS_FORWARD_SAFE_NSISAVEASCHARSET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Convert(const PRUnichar *inString, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Convert(inString, _retval); } 
