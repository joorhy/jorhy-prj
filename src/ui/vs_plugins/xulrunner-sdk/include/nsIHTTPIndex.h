/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpfe/components/directory/nsIHTTPIndex.idl
 */
...
class NS_NO_VTABLE nsIHTTPIndex : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IHTTPINDEX_IID)

  /* readonly attribute string BaseURL; */
  NS_IMETHOD GetBaseURL(char * *aBaseURL) = 0;
...
#define NS_DECL_NSIHTTPINDEX \
  NS_IMETHOD GetBaseURL(char * *aBaseURL); \
...
#define NS_FORWARD_NSIHTTPINDEX(_to) \
  NS_IMETHOD GetBaseURL(char * *aBaseURL) { return _to GetBaseURL(aBaseURL); } \
...
#define NS_FORWARD_SAFE_NSIHTTPINDEX(_to) \
  NS_IMETHOD GetBaseURL(char * *aBaseURL) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBaseURL(aBaseURL); } \
