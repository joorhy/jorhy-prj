/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/components/commandhandler/public/nsIControllerCommand.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIControllerCommand : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval) = 0;
...
#define NS_DECL_NSICONTROLLERCOMMAND \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval); \
...
#define NS_FORWARD_NSICONTROLLERCOMMAND(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval) { return _to IsCommandEnabled(aCommandName, aCommandContext, _retval); } \
...
#define NS_FORWARD_SAFE_NSICONTROLLERCOMMAND(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandEnabled(aCommandName, aCommandContext, _retval); } \
...
/* boolean isCommandEnabled (in string aCommandName, in nsISupports aCommandContext); */
NS_IMETHODIMP nsControllerCommand::IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval)
{
