/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/components/commandhandler/public/nsICommandManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICommandManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) = 0;

  /* boolean isCommandEnabled (in string aCommandName, in nsIDOMWindow aTargetWindow); */
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) = 0;
...
#define NS_DECL_NSICOMMANDMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval); \
...
#define NS_FORWARD_NSICOMMANDMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return _to IsCommandSupported(aCommandName, aTargetWindow, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return _to IsCommandEnabled(aCommandName, aTargetWindow, _retval); } \
...
#define NS_FORWARD_SAFE_NSICOMMANDMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandSupported(aCommandName, aTargetWindow, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandEnabled(aCommandName, aTargetWindow, _retval); } \
...
/* boolean isCommandSupported (in string aCommandName, in nsIDOMWindow aTargetWindow); */
NS_IMETHODIMP nsCommandManager::IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isCommandEnabled (in string aCommandName, in nsIDOMWindow aTargetWindow); */
NS_IMETHODIMP nsCommandManager::IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
