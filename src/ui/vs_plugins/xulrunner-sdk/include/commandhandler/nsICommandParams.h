/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/embedding/components/commandhandler/public/nsICommandParams.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICommandParams : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval) = 0;

  /* boolean getBooleanValue (in string name); */
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval) = 0;

  /* long getLongValue (in string name); */
  NS_SCRIPTABLE NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval) = 0;

  /* double getDoubleValue (in string name); */
  NS_SCRIPTABLE NS_IMETHOD GetDoubleValue(const char *name, double *_retval) = 0;

  /* AString getStringValue (in string name); */
  NS_SCRIPTABLE NS_IMETHOD GetStringValue(const char *name, nsAString & _retval) = 0;

  /* string getCStringValue (in string name); */
  NS_SCRIPTABLE NS_IMETHOD GetCStringValue(const char *name, char **_retval) = 0;

  /* nsISupports getISupportsValue (in string name); */
  NS_SCRIPTABLE NS_IMETHOD GetISupportsValue(const char *name, nsISupports **_retval) = 0;
   ...
   */
  /* string getNext (); */
  NS_SCRIPTABLE NS_IMETHOD GetNext(char **_retval) = 0;
...
#define NS_DECL_NSICOMMANDPARAMS \
  NS_SCRIPTABLE NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetDoubleValue(const char *name, double *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetStringValue(const char *name, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetCStringValue(const char *name, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetISupportsValue(const char *name, nsISupports **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(char **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICOMMANDPARAMS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval) { return _to GetValueType(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval) { return _to GetBooleanValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval) { return _to GetLongValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDoubleValue(const char *name, double *_retval) { return _to GetDoubleValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStringValue(const char *name, nsAString & _retval) { return _to GetStringValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCStringValue(const char *name, char **_retval) { return _to GetCStringValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetISupportsValue(const char *name, nsISupports **_retval) { return _to GetISupportsValue(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(char **_retval) { return _to GetNext(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICOMMANDPARAMS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValueType(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBooleanValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLongValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetDoubleValue(const char *name, double *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDoubleValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetStringValue(const char *name, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStringValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCStringValue(const char *name, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCStringValue(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetISupportsValue(const char *name, nsISupports **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetISupportsValue(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNext(_retval); } 
...
/* boolean hasMoreElements (); */
NS_IMETHODIMP nsCommandParams::HasMoreElements(PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
