/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/base/public/nsIDOMFileList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMFileList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMFile **_retval) = 0;
...
#define NS_DECL_NSIDOMFILELIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMFile **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMFILELIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMFile **_retval) { return _to Item(index, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMFILELIST(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMFile **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } 
...
/* nsIDOMFile item (in unsigned long index); */
NS_IMETHODIMP nsDOMFileList::Item(PRUint32 index, nsIDOMFile **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
