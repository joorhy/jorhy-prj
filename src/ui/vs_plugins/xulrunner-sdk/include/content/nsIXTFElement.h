/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/xtf/public/nsIXTFElement.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXTFElement : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptingInterfaces(PRUint32 *count, nsIID * **array) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleDefault(nsIDOMEvent *aEvent, PRBool *_retval) = 0;
...
#define NS_DECL_NSIXTFELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptingInterfaces(PRUint32 *count, nsIID * **array); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleDefault(nsIDOMEvent *aEvent, PRBool *_retval); \
...
#define NS_FORWARD_NSIXTFELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptingInterfaces(PRUint32 *count, nsIID * **array) { return _to GetScriptingInterfaces(count, array); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleDefault(nsIDOMEvent *aEvent, PRBool *_retval) { return _to HandleDefault(aEvent, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXTFELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptingInterfaces(PRUint32 *count, nsIID * **array) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScriptingInterfaces(count, array); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleDefault(nsIDOMEvent *aEvent, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleDefault(aEvent, _retval); } \
