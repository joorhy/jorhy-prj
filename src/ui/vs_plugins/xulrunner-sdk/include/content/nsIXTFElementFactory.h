/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/xtf/public/nsIXTFElementFactory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXTFElementFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval) = 0;
...
#define NS_DECL_NSIXTFELEMENTFACTORY \
  NS_SCRIPTABLE NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXTFELEMENTFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval) { return _to CreateElement(tagName, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXTFELEMENTFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateElement(const nsAString & tagName, nsIXTFElement **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateElement(tagName, _retval); } 
