/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/html/document/public/nsIWyciwygChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWyciwygChannel : public nsIChannel {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAndSource(PRInt32 *aSource, nsACString & _retval) = 0;
...
#define NS_DECL_NSIWYCIWYGCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAndSource(PRInt32 *aSource, nsACString & _retval); 
...
#define NS_FORWARD_NSIWYCIWYGCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAndSource(PRInt32 *aSource, nsACString & _retval) { return _to GetCharsetAndSource(aSource, _retval); } 
...
#define NS_FORWARD_SAFE_NSIWYCIWYGCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAndSource(PRInt32 *aSource, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetAndSource(aSource, _retval); } 
...
/* ACString getCharsetAndSource (out long aSource); */
NS_IMETHODIMP nsWyciwygChannel::GetCharsetAndSource(PRInt32 *aSource, nsACString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
