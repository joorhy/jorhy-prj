/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/xml/document/public/nsIXPointer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPointerResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval) = 0;
...
#define NS_DECL_NSIXPOINTERRESULT \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPOINTERRESULT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval) { return _to Item(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPOINTERRESULT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMRange **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } \
