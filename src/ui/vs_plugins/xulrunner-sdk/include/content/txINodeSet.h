/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/xslt/public/txINodeSet.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE txINodeSet : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemAsNumber(PRUint32 index, double *_retval) = 0;

  /* DOMString itemAsString (in unsigned long index); */
  NS_SCRIPTABLE NS_IMETHOD ItemAsString(PRUint32 index, nsAString & _retval) = 0;
  ...
  NS_IMETHOD_(txAExprResult *) GetTxNodeSet(void) = 0;
...
#define NS_DECL_TXINODESET \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemAsNumber(PRUint32 index, double *_retval); \
  NS_SCRIPTABLE NS_IMETHOD ItemAsString(PRUint32 index, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength); \
  NS_SCRIPTABLE NS_IMETHOD Add(nsIDOMNode *node); \
  NS_IMETHOD_(txAExprResult *) GetTxNodeSet(void); 
...
#define NS_FORWARD_TXINODESET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemAsNumber(PRUint32 index, double *_retval) { return _to ItemAsNumber(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ItemAsString(PRUint32 index, nsAString & _retval) { return _to ItemAsString(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return _to GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Add(nsIDOMNode *node) { return _to Add(node); } \
  NS_IMETHOD_(txAExprResult *) GetTxNodeSet(void) { return _to GetTxNodeSet(); } 
...
#define NS_FORWARD_SAFE_TXINODESET(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ItemAsNumber(PRUint32 index, double *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ItemAsNumber(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ItemAsString(PRUint32 index, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ItemAsString(index, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetLength(PRUint32 *aLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLength(aLength); } \
  NS_SCRIPTABLE NS_IMETHOD Add(nsIDOMNode *node) { return !_to ? NS_ERROR_NULL_POINTER : _to->Add(node); } \
  NS_IMETHOD_(txAExprResult *) GetTxNodeSet(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTxNodeSet(); } 
...
/* nsIDOMNode item (in unsigned long index); */
NS_IMETHODIMP txNodeSet::Item(PRUint32 index, nsIDOMNode **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* double itemAsNumber (in unsigned long index); */
NS_IMETHODIMP txNodeSet::ItemAsNumber(PRUint32 index, double *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString itemAsString (in unsigned long index); */
NS_IMETHODIMP txNodeSet::ItemAsString(PRUint32 index, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript, notxpcom] txAExprResultPtr getTxNodeSet (); */
NS_IMETHODIMP_(txAExprResult *) txNodeSet::GetTxNodeSet()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
