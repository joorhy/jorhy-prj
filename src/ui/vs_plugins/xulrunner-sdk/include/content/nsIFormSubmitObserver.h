/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/html/content/public/nsIFormSubmitObserver.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFormSubmitObserver : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindowInternal *window, nsIURI *actionURL, PRBool *cancelSubmit) = 0;
...
#define NS_DECL_NSIFORMSUBMITOBSERVER \
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindowInternal *window, nsIURI *actionURL, PRBool *cancelSubmit); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFORMSUBMITOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindowInternal *window, nsIURI *actionURL, PRBool *cancelSubmit) { return _to Notify(formNode, window, actionURL, cancelSubmit); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFORMSUBMITOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindowInternal *window, nsIURI *actionURL, PRBool *cancelSubmit) { return !_to ? NS_ERROR_NULL_POINTER : _to->Notify(formNode, window, actionURL, cancelSubmit); } 
...
/* void notify (in nsIDOMHTMLFormElement formNode, in nsIDOMWindowInternal window, in nsIURI actionURL, out boolean cancelSubmit); */
NS_IMETHODIMP nsFormSubmitObserver::Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindowInternal *window, nsIURI *actionURL, PRBool *cancelSubmit)
{
