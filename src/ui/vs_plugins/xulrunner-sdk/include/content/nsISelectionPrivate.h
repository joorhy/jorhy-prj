/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/base/public/nsISelectionPrivate.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISelectionPrivate : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsIEnumerator **_retval) = 0;

  /* wstring toStringWithFormat (in string formatType, in unsigned long flags, in PRInt32 wrapColumn); */
  NS_SCRIPTABLE NS_IMETHOD ToStringWithFormat(const char *formatType, PRUint32 flags, PRInt32 wrapColumn, PRUnichar **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTableSelectionType(nsIDOMRange *range, PRInt32 *_retval) = 0;
...
#define NS_DECL_NSISELECTIONPRIVATE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsIEnumerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD ToStringWithFormat(const char *formatType, PRUint32 flags, PRInt32 wrapColumn, PRUnichar **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTableSelectionType(nsIDOMRange *range, PRInt32 *_retval); \
...
#define NS_FORWARD_NSISELECTIONPRIVATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsIEnumerator **_retval) { return _to GetEnumerator(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ToStringWithFormat(const char *formatType, PRUint32 flags, PRInt32 wrapColumn, PRUnichar **_retval) { return _to ToStringWithFormat(formatType, flags, wrapColumn, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTableSelectionType(nsIDOMRange *range, PRInt32 *_retval) { return _to GetTableSelectionType(range, _retval); } \
...
#define NS_FORWARD_SAFE_NSISELECTIONPRIVATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnumerator(nsIEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnumerator(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ToStringWithFormat(const char *formatType, PRUint32 flags, PRInt32 wrapColumn, PRUnichar **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ToStringWithFormat(formatType, flags, wrapColumn, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTableSelectionType(nsIDOMRange *range, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTableSelectionType(range, _retval); } \
