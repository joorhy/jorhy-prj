/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/base/public/nsISelectionController.idl
 */
...
#define NS_ISELECTIONCONTROLLER_IID_STR "5f8f41cb-f182-4010-9e38-7c873e8e8a9f"

#define NS_ISELECTIONCONTROLLER_IID \
  {0x5f8f41cb, 0xf182, 0x4010, \
    { 0x9e, 0x38, 0x7c, 0x87, 0x3e, 0x8e, 0x8a, 0x9f }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISelectionController : public nsISelectionDisplay {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplaySelection(PRInt16 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelection(PRInt16 type, nsISelection **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaretEnabled(PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckVisibility(nsIDOMNode *node, PRInt16 startOffset, PRInt16 endOffset, PRBool *_retval) = 0;
...
#define NS_DECL_NSISELECTIONCONTROLLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplaySelection(PRInt16 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetSelection(PRInt16 type, nsISelection **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaretEnabled(PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckVisibility(nsIDOMNode *node, PRInt16 startOffset, PRInt16 endOffset, PRBool *_retval); 
...
#define NS_FORWARD_NSISELECTIONCONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplaySelection(PRInt16 *_retval) { return _to GetDisplaySelection(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSelection(PRInt16 type, nsISelection **_retval) { return _to GetSelection(type, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaretEnabled(PRBool *_retval) { return _to GetCaretEnabled(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckVisibility(nsIDOMNode *node, PRInt16 startOffset, PRInt16 endOffset, PRBool *_retval) { return _to CheckVisibility(node, startOffset, endOffset, _retval); } 
...
#define NS_FORWARD_SAFE_NSISELECTIONCONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplaySelection(PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDisplaySelection(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSelection(PRInt16 type, nsISelection **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelection(type, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCaretEnabled(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCaretEnabled(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckVisibility(nsIDOMNode *node, PRInt16 startOffset, PRInt16 endOffset, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckVisibility(node, startOffset, endOffset, _retval); } 
