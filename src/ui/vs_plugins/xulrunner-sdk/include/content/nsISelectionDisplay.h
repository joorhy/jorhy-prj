/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/base/public/nsISelectionDisplay.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISelectionDisplay : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectionFlags(PRInt16 *_retval) = 0;
...
#define NS_DECL_NSISELECTIONDISPLAY \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectionFlags(PRInt16 *_retval); 
...
#define NS_FORWARD_NSISELECTIONDISPLAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectionFlags(PRInt16 *_retval) { return _to GetSelectionFlags(_retval); } 
...
#define NS_FORWARD_SAFE_NSISELECTIONDISPLAY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSelectionFlags(PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSelectionFlags(_retval); } 
