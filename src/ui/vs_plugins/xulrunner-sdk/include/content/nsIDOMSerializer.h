/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/content/base/public/nsIDOMSerializer.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSerializer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SerializeToString(nsIDOMNode *root, nsAString & _retval) = 0;
...
#define NS_DECL_NSIDOMSERIALIZER \
  NS_SCRIPTABLE NS_IMETHOD SerializeToString(nsIDOMNode *root, nsAString & _retval); \
...
#define NS_FORWARD_NSIDOMSERIALIZER(_to) \
  NS_SCRIPTABLE NS_IMETHOD SerializeToString(nsIDOMNode *root, nsAString & _retval) { return _to SerializeToString(root, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMSERIALIZER(_to) \
  NS_SCRIPTABLE NS_IMETHOD SerializeToString(nsIDOMNode *root, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SerializeToString(root, _retval); } \
