/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/editor/idl/nsIDocumentStateListener.idl
 */
...
#define NS_DECL_NSIDOCUMENTSTATELISTENER \
  ...
  NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOCUMENTSTATELISTENER(_to) \
  NS_IMETHOD NotifyDocumentCreated(void) { return _to NotifyDocumentCreated(); } \
  NS_IMETHOD NotifyDocumentWillBeDestroyed(void) { return _to NotifyDocumentWillBeDestroyed(); } \
  NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty) { return _to NotifyDocumentStateChanged(nowDirty); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOCUMENTSTATELISTENER(_to) \
  NS_IMETHOD NotifyDocumentCreated(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyDocumentCreated(); } \
  NS_IMETHOD NotifyDocumentWillBeDestroyed(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyDocumentWillBeDestroyed(); } \
  NS_IMETHOD NotifyDocumentStateChanged(bool nowDirty) { return !_to ? NS_ERROR_NULL_POINTER : _to->NotifyDocumentStateChanged(nowDirty); } 
