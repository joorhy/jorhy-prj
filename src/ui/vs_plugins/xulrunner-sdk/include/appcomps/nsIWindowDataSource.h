/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/xpfe/components/windowds/nsIWindowDataSource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWindowDataSource : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval) = 0;
...
#define NS_DECL_NSIWINDOWDATASOURCE \
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINDOWDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval) { return _to GetWindowForResource(inResource, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINDOWDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWindowForResource(inResource, _retval); } 
...
/* nsIDOMWindowInternal getWindowForResource (in string inResource); */
NS_IMETHODIMP nsWindowDataSource::GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval)
{
