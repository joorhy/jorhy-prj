/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/nsIRDFInMemoryDataSource.idl
 */
...
class NS_NO_VTABLE nsIRDFInMemoryDataSource : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IRDFINMEMORYDATASOURCE_IID)

  /* void EnsureFastContainment (in nsIRDFResource aSource); */
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource) = 0;
...
#define NS_DECL_NSIRDFINMEMORYDATASOURCE \
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFINMEMORYDATASOURCE(_to) \
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource) { return _to EnsureFastContainment(aSource); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFINMEMORYDATASOURCE(_to) \
  NS_IMETHOD EnsureFastContainment(nsIRDFResource *aSource) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnsureFastContainment(aSource); } 
