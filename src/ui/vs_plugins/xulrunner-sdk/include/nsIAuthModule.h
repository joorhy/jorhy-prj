/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsIAuthModule.idl
 */
...
class NS_NO_VTABLE nsIAuthModule : public nsISupports {
 public: 
  ...
  NS_IMETHOD Init(const char * aServiceName, uint32_t aServiceFlags, const PRUnichar * aDomain, const PRUnichar * aUsername, const PRUnichar * aPassword) = 0;
...
#define NS_DECL_NSIAUTHMODULE \
  NS_IMETHOD Init(const char * aServiceName, uint32_t aServiceFlags, const PRUnichar * aDomain, const PRUnichar * aUsername, const PRUnichar * aPassword); \
...
#define NS_FORWARD_NSIAUTHMODULE(_to) \
  NS_IMETHOD Init(const char * aServiceName, uint32_t aServiceFlags, const PRUnichar * aDomain, const PRUnichar * aUsername, const PRUnichar * aPassword) { return _to Init(aServiceName, aServiceFlags, aDomain, aUsername, aPassword); } \
...
#define NS_FORWARD_SAFE_NSIAUTHMODULE(_to) \
  NS_IMETHOD Init(const char * aServiceName, uint32_t aServiceFlags, const PRUnichar * aDomain, const PRUnichar * aUsername, const PRUnichar * aPassword) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aServiceName, aServiceFlags, aDomain, aUsername, aPassword); } \
...
/* void init (in string aServiceName, in unsigned long aServiceFlags, in wstring aDomain, in wstring aUsername, in wstring aPassword); */
NS_IMETHODIMP nsAuthModule::Init(const char * aServiceName, uint32_t aServiceFlags, const PRUnichar * aDomain, const PRUnichar * aUsername, const PRUnichar * aPassword)
{
