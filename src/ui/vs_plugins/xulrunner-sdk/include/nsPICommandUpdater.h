/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/embedding/components/commandhandler/public/nsPICommandUpdater.idl
 */
...
#define NS_DECL_NSPICOMMANDUPDATER \
  ...
  NS_IMETHOD CommandStatusChanged(const char * aCommandName); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSPICOMMANDUPDATER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *aWindow) { return _to Init(aWindow); } \
  NS_IMETHOD CommandStatusChanged(const char * aCommandName) { return _to CommandStatusChanged(aCommandName); } 
...
#define NS_FORWARD_SAFE_NSPICOMMANDUPDATER(_to) \
  ...
  NS_IMETHOD CommandStatusChanged(const char * aCommandName) { return !_to ? NS_ERROR_NULL_POINTER : _to->CommandStatusChanged(aCommandName); } 
