/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/protocol/about/public/nsIAboutModule.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAboutModule : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIFlags(nsIURI *aURI, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSIABOUTMODULE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIFlags(nsIURI *aURI, PRUint32 *_retval); 
...
#define NS_FORWARD_NSIABOUTMODULE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIFlags(nsIURI *aURI, PRUint32 *_retval) { return _to GetURIFlags(aURI, _retval); } 
...
#define NS_FORWARD_SAFE_NSIABOUTMODULE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetURIFlags(nsIURI *aURI, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURIFlags(aURI, _retval); } 
...
/* unsigned long getURIFlags (in nsIURI aURI); */
NS_IMETHODIMP nsAboutModule::GetURIFlags(nsIURI *aURI, PRUint32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
