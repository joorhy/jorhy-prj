/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/socket/base/nsISocketProviderService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISocketProviderService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval) = 0;
...
#define NS_DECL_NSISOCKETPROVIDERSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISOCKETPROVIDERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval) { return _to GetSocketProvider(socketType, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISOCKETPROVIDERSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSocketProvider(const char *socketType, nsISocketProvider **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSocketProvider(socketType, _retval); } 
