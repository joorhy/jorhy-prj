/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsISocketTransport.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISocketTransport : public nsITransport {
 public: 
  ...
  /**
     ...
     */
  /* boolean isAlive (); */
  NS_SCRIPTABLE NS_IMETHOD IsAlive(PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTimeout(PRUint32 aType, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSISOCKETTRANSPORT \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsAlive(PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetTimeout(PRUint32 aType, PRUint32 *_retval); \
...
#define NS_FORWARD_NSISOCKETTRANSPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsAlive(PRBool *_retval) { return _to IsAlive(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTimeout(PRUint32 aType, PRUint32 *_retval) { return _to GetTimeout(aType, _retval); } \
...
#define NS_FORWARD_SAFE_NSISOCKETTRANSPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsAlive(PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsAlive(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetTimeout(PRUint32 aType, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTimeout(aType, _retval); } \
