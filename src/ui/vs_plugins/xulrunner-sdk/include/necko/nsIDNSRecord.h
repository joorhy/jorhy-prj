/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/dns/public/nsIDNSRecord.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDNSRecord : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextAddrAsString(nsACString & _retval) = 0;
...
#define NS_DECL_NSIDNSRECORD \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextAddrAsString(nsACString & _retval); \
...
#define NS_FORWARD_NSIDNSRECORD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextAddrAsString(nsACString & _retval) { return _to GetNextAddrAsString(_retval); } \
...
#define NS_FORWARD_SAFE_NSIDNSRECORD(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNextAddrAsString(nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNextAddrAsString(_retval); } \
