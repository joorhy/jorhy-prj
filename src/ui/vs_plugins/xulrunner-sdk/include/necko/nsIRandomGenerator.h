/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsIRandomGenerator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIRandomGenerator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateRandomBytes(PRUint32 aLength, PRUint8 **aBuffer) = 0;
...
#define NS_DECL_NSIRANDOMGENERATOR \
  NS_SCRIPTABLE NS_IMETHOD GenerateRandomBytes(PRUint32 aLength, PRUint8 **aBuffer); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRANDOMGENERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GenerateRandomBytes(PRUint32 aLength, PRUint8 **aBuffer) { return _to GenerateRandomBytes(aLength, aBuffer); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRANDOMGENERATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GenerateRandomBytes(PRUint32 aLength, PRUint8 **aBuffer) { return !_to ? NS_ERROR_NULL_POINTER : _to->GenerateRandomBytes(aLength, aBuffer); } 
...
/* void generateRandomBytes (in unsigned long aLength, [array, size_is (aLength), retval] out octet aBuffer); */
NS_IMETHODIMP nsRandomGenerator::GenerateRandomBytes(PRUint32 aLength, PRUint8 **aBuffer)
{
