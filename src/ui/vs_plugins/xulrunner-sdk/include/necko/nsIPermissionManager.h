/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsIPermissionManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPermissionManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, const char *type, PRUint32 *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD TestExactPermission(nsIURI *uri, const char *type, PRUint32 *_retval) = 0;
...
#define NS_DECL_NSIPERMISSIONMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, const char *type, PRUint32 *_retval); \
  NS_SCRIPTABLE NS_IMETHOD TestExactPermission(nsIURI *uri, const char *type, PRUint32 *_retval); \
...
#define NS_FORWARD_NSIPERMISSIONMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, const char *type, PRUint32 *_retval) { return _to TestPermission(uri, type, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD TestExactPermission(nsIURI *uri, const char *type, PRUint32 *_retval) { return _to TestExactPermission(uri, type, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPERMISSIONMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIURI *uri, const char *type, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->TestPermission(uri, type, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD TestExactPermission(nsIURI *uri, const char *type, PRUint32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->TestExactPermission(uri, type, _retval); } \
...
/* PRUint32 testExactPermission (in nsIURI uri, in string type); */
NS_IMETHODIMP nsPermissionManager::TestExactPermission(nsIURI *uri, const char *type, PRUint32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
