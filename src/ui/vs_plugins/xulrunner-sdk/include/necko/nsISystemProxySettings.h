/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsISystemProxySettings.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISystemProxySettings : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(nsIURI *aURI, nsACString & _retval) = 0;
...
#define NS_DECL_NSISYSTEMPROXYSETTINGS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(nsIURI *aURI, nsACString & _retval); 
...
#define NS_FORWARD_NSISYSTEMPROXYSETTINGS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(nsIURI *aURI, nsACString & _retval) { return _to GetProxyForURI(aURI, _retval); } 
...
#define NS_FORWARD_SAFE_NSISYSTEMPROXYSETTINGS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(nsIURI *aURI, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProxyForURI(aURI, _retval); } 
...
/* AUTF8String getProxyForURI (in nsIURI aURI); */
NS_IMETHODIMP nsSystemProxySettings::GetProxyForURI(nsIURI *aURI, nsACString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
