/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/protocol/res/public/nsIResProtocolHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIResProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubstitution(const nsACString & root, nsIURI **_retval) = 0;

  /**
     * Returns TRUE if the substitution exists and FALSE otherwise.
     */
  /* boolean hasSubstitution (in ACString root); */
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ResolveURI(nsIURI *resURI, nsACString & _retval) = 0;
...
#define NS_DECL_NSIRESPROTOCOLHANDLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubstitution(const nsACString & root, nsIURI **_retval); \
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD ResolveURI(nsIURI *resURI, nsACString & _retval); 
...
#define NS_FORWARD_NSIRESPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubstitution(const nsACString & root, nsIURI **_retval) { return _to GetSubstitution(root, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval) { return _to HasSubstitution(root, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ResolveURI(nsIURI *resURI, nsACString & _retval) { return _to ResolveURI(resURI, _retval); } 
...
#define NS_FORWARD_SAFE_NSIRESPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubstitution(const nsACString & root, nsIURI **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSubstitution(root, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasSubstitution(const nsACString & root, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasSubstitution(root, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ResolveURI(nsIURI *resURI, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ResolveURI(resURI, _retval); } 
