/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsIExternalProtocolHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExternalProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval) = 0;
...
#define NS_DECL_NSIEXTERNALPROTOCOLHANDLER \
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval) { return _to ExternalAppExistsForScheme(scheme, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExternalAppExistsForScheme(scheme, _retval); } 
