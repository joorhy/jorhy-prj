/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsISyncStreamListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISyncStreamListener : public nsIStreamListener {
 public: 
