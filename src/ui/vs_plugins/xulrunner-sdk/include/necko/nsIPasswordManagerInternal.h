/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsIPasswordManagerInternal.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPasswordManagerInternal : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD FindPasswordEntry(const nsACString & aHostURI, const nsAString & aUsername, const nsAString & aPassword, nsACString & aHostURIFound, nsAString & aUsernameFound, nsAString & aPasswordFound) = 0;
...
#define NS_DECL_NSIPASSWORDMANAGERINTERNAL \
  NS_SCRIPTABLE NS_IMETHOD FindPasswordEntry(const nsACString & aHostURI, const nsAString & aUsername, const nsAString & aPassword, nsACString & aHostURIFound, nsAString & aUsernameFound, nsAString & aPasswordFound); \
...
#define NS_FORWARD_NSIPASSWORDMANAGERINTERNAL(_to) \
  NS_SCRIPTABLE NS_IMETHOD FindPasswordEntry(const nsACString & aHostURI, const nsAString & aUsername, const nsAString & aPassword, nsACString & aHostURIFound, nsAString & aUsernameFound, nsAString & aPasswordFound) { return _to FindPasswordEntry(aHostURI, aUsername, aPassword, aHostURIFound, aUsernameFound, aPasswordFound); } \
...
#define NS_FORWARD_SAFE_NSIPASSWORDMANAGERINTERNAL(_to) \
  NS_SCRIPTABLE NS_IMETHOD FindPasswordEntry(const nsACString & aHostURI, const nsAString & aUsername, const nsAString & aPassword, nsACString & aHostURIFound, nsAString & aUsernameFound, nsAString & aPasswordFound) { return !_to ? NS_ERROR_NULL_POINTER : _to->FindPasswordEntry(aHostURI, aUsername, aPassword, aHostURIFound, aUsernameFound, aPasswordFound); } \
