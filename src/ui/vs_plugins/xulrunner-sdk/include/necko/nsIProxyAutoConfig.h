/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsIProxyAutoConfig.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProxyAutoConfig : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(const nsACString & aTestURI, const nsACString & aTestHost, nsACString & _retval) = 0;
...
#define NS_DECL_NSIPROXYAUTOCONFIG \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(const nsACString & aTestURI, const nsACString & aTestHost, nsACString & _retval); 
...
#define NS_FORWARD_NSIPROXYAUTOCONFIG(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(const nsACString & aTestURI, const nsACString & aTestHost, nsACString & _retval) { return _to GetProxyForURI(aTestURI, aTestHost, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPROXYAUTOCONFIG(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetProxyForURI(const nsACString & aTestURI, const nsACString & aTestHost, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetProxyForURI(aTestURI, aTestHost, _retval); } 
