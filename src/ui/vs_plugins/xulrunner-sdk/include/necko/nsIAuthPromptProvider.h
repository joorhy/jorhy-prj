/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsIAuthPromptProvider.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAuthPromptProvider : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAuthPrompt(PRUint32 aPromptReason, const nsIID & iid, void * *result) = 0;
...
#define NS_DECL_NSIAUTHPROMPTPROVIDER \
  NS_SCRIPTABLE NS_IMETHOD GetAuthPrompt(PRUint32 aPromptReason, const nsIID & iid, void * *result); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAUTHPROMPTPROVIDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAuthPrompt(PRUint32 aPromptReason, const nsIID & iid, void * *result) { return _to GetAuthPrompt(aPromptReason, iid, result); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAUTHPROMPTPROVIDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAuthPrompt(PRUint32 aPromptReason, const nsIID & iid, void * *result) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAuthPrompt(aPromptReason, iid, result); } 
...
/* void getAuthPrompt (in PRUint32 aPromptReason, in nsIIDRef iid, [iid_is (iid), retval] out nsQIResult result); */
NS_IMETHODIMP nsAuthPromptProvider::GetAuthPrompt(PRUint32 aPromptReason, const nsIID & iid, void * *result)
{
