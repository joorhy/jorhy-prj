/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/base/public/nsISecretDecoderRing.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISecretDecoderRing : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EncryptString(const char *text, char **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD DecryptString(const char *crypt, char **_retval) = 0;
...
#define NS_DECL_NSISECRETDECODERRING \
  ...
  NS_SCRIPTABLE NS_IMETHOD EncryptString(const char *text, char **_retval); \
  NS_SCRIPTABLE NS_IMETHOD DecryptString(const char *crypt, char **_retval); \
...
#define NS_FORWARD_NSISECRETDECODERRING(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EncryptString(const char *text, char **_retval) { return _to EncryptString(text, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DecryptString(const char *crypt, char **_retval) { return _to DecryptString(crypt, _retval); } \
...
#define NS_FORWARD_SAFE_NSISECRETDECODERRING(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EncryptString(const char *text, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EncryptString(text, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD DecryptString(const char *crypt, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->DecryptString(crypt, _retval); } \
