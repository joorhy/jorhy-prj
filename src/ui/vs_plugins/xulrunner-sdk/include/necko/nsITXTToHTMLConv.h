/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/netwerk/streamconv/public/nsITXTToHTMLConv.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITXTToHTMLConv : public nsIStreamConverter {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTitle(const PRUnichar *text) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(PRBool value) = 0;
...
#define NS_DECL_NSITXTTOHTMLCONV \
  NS_SCRIPTABLE NS_IMETHOD SetTitle(const PRUnichar *text); \
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(PRBool value); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITXTTOHTMLCONV(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetTitle(const PRUnichar *text) { return _to SetTitle(text); } \
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(PRBool value) { return _to PreFormatHTML(value); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITXTTOHTMLCONV(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetTitle(const PRUnichar *text) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTitle(text); } \
  NS_SCRIPTABLE NS_IMETHOD PreFormatHTML(PRBool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->PreFormatHTML(value); } 
