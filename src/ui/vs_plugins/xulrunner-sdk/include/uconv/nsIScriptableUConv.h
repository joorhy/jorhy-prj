/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/xr19rel/WINNT_5.2_Depend/mozilla/intl/uconv/idl/nsIScriptableUConv.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableUnicodeConverter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ConvertFromUnicode(const nsAString & aSrc, nsACString & _retval) = 0;
   ...
   */
  /* ACString Finish (); */
  NS_SCRIPTABLE NS_IMETHOD Finish(nsACString & _retval) = 0;

  /**
   * Converts the data from one Charset to Unicode.
   */
  /* AString ConvertToUnicode (in ACString aSrc); */
  NS_SCRIPTABLE NS_IMETHOD ConvertToUnicode(const nsACString & aSrc, nsAString & _retval) = 0;

  /**
   * Converts an array of bytes to a unicode string.
   */
  /* AString convertFromByteArray ([array, size_is (aCount), const] in octet aData, in unsigned long aCount); */
  NS_SCRIPTABLE NS_IMETHOD ConvertFromByteArray(const PRUint8 *aData, PRUint32 aCount, nsAString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ConvertToByteArray(const nsAString & aString, PRUint32 *aLen, PRUint8 **aData) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ConvertToInputStream(const nsAString & aString, nsIInputStream **_retval) = 0;
...
#define NS_DECL_NSISCRIPTABLEUNICODECONVERTER \
  NS_SCRIPTABLE NS_IMETHOD ConvertFromUnicode(const nsAString & aSrc, nsACString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD Finish(nsACString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD ConvertToUnicode(const nsACString & aSrc, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD ConvertFromByteArray(const PRUint8 *aData, PRUint32 aCount, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD ConvertToByteArray(const nsAString & aString, PRUint32 *aLen, PRUint8 **aData); \
  NS_SCRIPTABLE NS_IMETHOD ConvertToInputStream(const nsAString & aString, nsIInputStream **_retval); \
...
#define NS_FORWARD_NSISCRIPTABLEUNICODECONVERTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConvertFromUnicode(const nsAString & aSrc, nsACString & _retval) { return _to ConvertFromUnicode(aSrc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Finish(nsACString & _retval) { return _to Finish(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertToUnicode(const nsACString & aSrc, nsAString & _retval) { return _to ConvertToUnicode(aSrc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertFromByteArray(const PRUint8 *aData, PRUint32 aCount, nsAString & _retval) { return _to ConvertFromByteArray(aData, aCount, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertToByteArray(const nsAString & aString, PRUint32 *aLen, PRUint8 **aData) { return _to ConvertToByteArray(aString, aLen, aData); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertToInputStream(const nsAString & aString, nsIInputStream **_retval) { return _to ConvertToInputStream(aString, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEUNICODECONVERTER(_to) \
  NS_SCRIPTABLE NS_IMETHOD ConvertFromUnicode(const nsAString & aSrc, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertFromUnicode(aSrc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Finish(nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Finish(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertToUnicode(const nsACString & aSrc, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertToUnicode(aSrc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertFromByteArray(const PRUint8 *aData, PRUint32 aCount, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertFromByteArray(aData, aCount, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertToByteArray(const nsAString & aString, PRUint32 *aLen, PRUint8 **aData) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertToByteArray(aString, aLen, aData); } \
  NS_SCRIPTABLE NS_IMETHOD ConvertToInputStream(const nsAString & aString, nsIInputStream **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ConvertToInputStream(aString, _retval); } \
