...
{
	return "ry-ivs-media-player-misc::";
}
...
{   
	...
	CNPPluginMisc * pPlugin = new CNPPluginMisc(instance);
	if(pPlugin == NULL)
...
NPError NPP_Destroy (NPP instance, NPSavedData** save)
{
	...
	CNPPluginMisc * pPlugin = (CNPPluginMisc *)instance->pdata;
	if(pPlugin != NULL)
	{
		pPlugin->shut();
		delete pPlugin;
...
NPError	NPP_GetValue(NPP instance, NPPVariable variable, void *value)
{
	...
	CNPPluginMisc * plugin = (CNPPluginMisc *)instance->pdata;
	if(plugin == NULL)
		return NPERR_GENERIC_ERROR;
	...
	case NPPVpluginDescriptionString:
		*((char **)value) = "RY-MISC scriptability API plugin";
		break;
