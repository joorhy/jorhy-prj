...
IMPLEMENT_DYNAMIC(CNewToolTip, CWnd)

CNewToolTip::CNewToolTip()
{
...
BEGIN_MESSAGE_MAP(CNewToolTip, CWnd)
END_MESSAGE_MAP()



// CNewToolTip message handlers

BOOL CNewToolTip::AddTool(CWnd *pWnd,LPSTR lpszText)
{
	TOOLINFO ti;
	RECT rect;
...
BOOL CNewToolTip::AddTool(CWnd *pWnd,int nText)
{
	TOOLINFO ti;
	RECT rect;
	char text[32];
...
void CNewToolTip::Create(CWnd *parent)
{
