/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/xre/nsINativeAppSupport.idl
 */
...
#define NS_DECL_NSINATIVEAPPSUPPORT \
  NS_IMETHOD Start(bool *_retval); \
  NS_IMETHOD Enable(void); \
  NS_IMETHOD Stop(bool *_retval); \
...
#define NS_FORWARD_NSINATIVEAPPSUPPORT(_to) \
  NS_IMETHOD Start(bool *_retval) { return _to Start(_retval); } \
  NS_IMETHOD Enable(void) { return _to Enable(); } \
  NS_IMETHOD Stop(bool *_retval) { return _to Stop(_retval); } \
...
#define NS_FORWARD_SAFE_NSINATIVEAPPSUPPORT(_to) \
  NS_IMETHOD Start(bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Start(_retval); } \
  NS_IMETHOD Enable(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enable(); } \
  NS_IMETHOD Stop(bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Stop(_retval); } \
