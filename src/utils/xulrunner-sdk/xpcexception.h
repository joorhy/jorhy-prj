/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/js/xpconnect/idl/xpcexception.idl
 */
...
class NS_NO_VTABLE nsIXPCException : public nsIException {
 public: 
  ...
  NS_IMETHOD StealJSVal(jsval *_retval) = 0;
...
#define NS_DECL_NSIXPCEXCEPTION \
  ...
  NS_IMETHOD StealJSVal(jsval *_retval); \
...
#define NS_FORWARD_NSIXPCEXCEPTION(_to) \
  ...
  NS_IMETHOD StealJSVal(jsval *_retval) { return _to StealJSVal(_retval); } \
...
#define NS_FORWARD_SAFE_NSIXPCEXCEPTION(_to) \
  ...
  NS_IMETHOD StealJSVal(jsval *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->StealJSVal(_retval); } \
...
/* [noscript] xpcexJSVal stealJSVal (); */
NS_IMETHODIMP nsXPCException::StealJSVal(jsval *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
