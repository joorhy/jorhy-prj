/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/gfx/src/nsIScriptableRegion.idl
 */
...
class NS_NO_VTABLE nsIScriptableRegion : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval) = 0;
...
#define NS_DECL_NSISCRIPTABLEREGION \
  ...
  NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval); \
...
#define NS_FORWARD_NSISCRIPTABLEREGION(_to) \
  ...
  NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval) { return _to GetRects(cx, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEREGION(_to) \
  ...
  NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRects(cx, _retval); } \
...
/* [implicit_jscontext] jsval getRects (); */
NS_IMETHODIMP nsScriptableRegion::GetRects(JSContext* cx, JS::Value *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
