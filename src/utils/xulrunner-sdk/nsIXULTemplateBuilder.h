/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/content/xul/templates/public/nsIXULTemplateBuilder.idl
 */
...
class NS_NO_VTABLE nsIXULTreeBuilderObserver : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnCycleCell(int32_t row, const PRUnichar * colID) = 0;
  ...
  NS_IMETHOD OnPerformActionOnRow(const PRUnichar * action, int32_t row) = 0;

  /* void onPerformActionOnCell (in wstring action, in long row, in wstring colID); */
  NS_IMETHOD OnPerformActionOnCell(const PRUnichar * action, int32_t row, const PRUnichar * colID) = 0;
...
#define NS_DECL_NSIXULTREEBUILDEROBSERVER \
  ...
  NS_IMETHOD OnCycleCell(int32_t row, const PRUnichar * colID); \
  NS_IMETHOD OnSelectionChanged(void); \
  NS_IMETHOD OnPerformAction(const PRUnichar * action); \
  NS_IMETHOD OnPerformActionOnRow(const PRUnichar * action, int32_t row); \
  NS_IMETHOD OnPerformActionOnCell(const PRUnichar * action, int32_t row, const PRUnichar * colID); 
...
#define NS_FORWARD_NSIXULTREEBUILDEROBSERVER(_to) \
  ...
  NS_IMETHOD OnCycleCell(int32_t row, const PRUnichar * colID) { return _to OnCycleCell(row, colID); } \
  ...
  NS_IMETHOD OnPerformActionOnRow(const PRUnichar * action, int32_t row) { return _to OnPerformActionOnRow(action, row); } \
  NS_IMETHOD OnPerformActionOnCell(const PRUnichar * action, int32_t row, const PRUnichar * colID) { return _to OnPerformActionOnCell(action, row, colID); } 
...
#define NS_FORWARD_SAFE_NSIXULTREEBUILDEROBSERVER(_to) \
  ...
  NS_IMETHOD OnCycleCell(int32_t row, const PRUnichar * colID) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnCycleCell(row, colID); } \
  ...
  NS_IMETHOD OnPerformActionOnRow(const PRUnichar * action, int32_t row) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnPerformActionOnRow(action, row); } \
  NS_IMETHOD OnPerformActionOnCell(const PRUnichar * action, int32_t row, const PRUnichar * colID) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnPerformActionOnCell(action, row, colID); } 
...
/* void onCycleCell (in long row, in wstring colID); */
NS_IMETHODIMP nsXULTreeBuilderObserver::OnCycleCell(int32_t row, const PRUnichar * colID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void onPerformActionOnRow (in wstring action, in long row); */
NS_IMETHODIMP nsXULTreeBuilderObserver::OnPerformActionOnRow(const PRUnichar * action, int32_t row)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void onPerformActionOnCell (in wstring action, in long row, in wstring colID); */
NS_IMETHODIMP nsXULTreeBuilderObserver::OnPerformActionOnCell(const PRUnichar * action, int32_t row, const PRUnichar * colID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
