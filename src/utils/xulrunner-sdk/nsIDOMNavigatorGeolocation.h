/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/geolocation/nsIDOMNavigatorGeolocation.idl
 */
...
class NS_NO_VTABLE nsIDOMNavigatorGeolocation : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMNAVIGATORGEOLOCATION_IID)

  /* readonly attribute nsIDOMGeoGeolocation geolocation; */
  NS_IMETHOD GetGeolocation(nsIDOMGeoGeolocation * *aGeolocation) = 0;
...
#define NS_DECL_NSIDOMNAVIGATORGEOLOCATION \
  NS_IMETHOD GetGeolocation(nsIDOMGeoGeolocation * *aGeolocation); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNAVIGATORGEOLOCATION(_to) \
  NS_IMETHOD GetGeolocation(nsIDOMGeoGeolocation * *aGeolocation) { return _to GetGeolocation(aGeolocation); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNAVIGATORGEOLOCATION(_to) \
  NS_IMETHOD GetGeolocation(nsIDOMGeoGeolocation * *aGeolocation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGeolocation(aGeolocation); } 
