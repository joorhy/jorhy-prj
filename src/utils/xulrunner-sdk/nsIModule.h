/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpcom/components/nsIModule.idl
 */
...
#define NS_DECL_NSIMODULE \
  ...
  NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval); 
...
#define NS_FORWARD_NSIMODULE(_to) \
  ...
  NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval) { return _to CanUnload(aCompMgr, _retval); } 
...
#define NS_FORWARD_SAFE_NSIMODULE(_to) \
  ...
  NS_IMETHOD CanUnload(nsIComponentManager *aCompMgr, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanUnload(aCompMgr, _retval); } 
