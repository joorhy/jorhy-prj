/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/power/nsIPowerManagerService.idl
 */
...
class NS_NO_VTABLE nsIPowerManagerService : public nsISupports {
 public: 
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsIDOMMozWakeLock * *_retval) = 0;
...
#define NS_DECL_NSIPOWERMANAGERSERVICE \
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsIDOMMozWakeLock * *_retval); 
...
#define NS_FORWARD_NSIPOWERMANAGERSERVICE(_to) \
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsIDOMMozWakeLock * *_retval) { return _to NewWakeLock(aTopic, aWindow, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPOWERMANAGERSERVICE(_to) \
  ...
  NS_IMETHOD NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsIDOMMozWakeLock * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->NewWakeLock(aTopic, aWindow, _retval); } 
...
/* nsIDOMMozWakeLock newWakeLock (in DOMString aTopic, [optional] in nsIDOMWindow aWindow); */
NS_IMETHODIMP nsPowerManagerService::NewWakeLock(const nsAString & aTopic, nsIDOMWindow *aWindow, nsIDOMMozWakeLock * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
