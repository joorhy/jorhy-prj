/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/svg/nsIDOMGetSVGDocument.idl
 */
...
class NS_NO_VTABLE nsIDOMGetSVGDocument : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetSVGDocument(nsIDOMDocument * *_retval) = 0;
...
#define NS_DECL_NSIDOMGETSVGDOCUMENT \
  NS_IMETHOD GetSVGDocument(nsIDOMDocument * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGETSVGDOCUMENT(_to) \
  NS_IMETHOD GetSVGDocument(nsIDOMDocument * *_retval) { return _to GetSVGDocument(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGETSVGDOCUMENT(_to) \
  NS_IMETHOD GetSVGDocument(nsIDOMDocument * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSVGDocument(_retval); } 
...
/* nsIDOMDocument getSVGDocument (); */
NS_IMETHODIMP nsDOMGetSVGDocument::GetSVGDocument(nsIDOMDocument * *_retval)
{
