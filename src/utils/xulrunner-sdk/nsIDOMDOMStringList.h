/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/core/nsIDOMDOMStringList.idl
 */
...
class NS_NO_VTABLE nsIDOMDOMStringList : public nsISupports {
 public: 
  ...
  NS_IMETHOD Contains(const nsAString & str, bool *_retval) = 0;
...
#define NS_DECL_NSIDOMDOMSTRINGLIST \
  ...
  NS_IMETHOD Contains(const nsAString & str, bool *_retval); 
...
#define NS_FORWARD_NSIDOMDOMSTRINGLIST(_to) \
  ...
  NS_IMETHOD Contains(const nsAString & str, bool *_retval) { return _to Contains(str, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMDOMSTRINGLIST(_to) \
  ...
  NS_IMETHOD Contains(const nsAString & str, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Contains(str, _retval); } 
...
/* DOMString item (in unsigned long index); */
NS_IMETHODIMP nsDOMDOMStringList::Item(uint32_t index, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute unsigned long length; */
NS_IMETHODIMP nsDOMDOMStringList::GetLength(uint32_t *aLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean contains (in DOMString str); */
NS_IMETHODIMP nsDOMDOMStringList::Contains(const nsAString & str, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
