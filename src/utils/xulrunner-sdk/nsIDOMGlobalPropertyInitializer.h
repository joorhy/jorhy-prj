/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMGlobalPropertyInitializer.idl
 */
...
class NS_NO_VTABLE nsIDOMGlobalPropertyInitializer : public nsISupports {
 public: 
  ...
  NS_IMETHOD Init(nsIDOMWindow *window, JS::Value *_retval) = 0;
...
#define NS_DECL_NSIDOMGLOBALPROPERTYINITIALIZER \
  NS_IMETHOD Init(nsIDOMWindow *window, JS::Value *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGLOBALPROPERTYINITIALIZER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *window, JS::Value *_retval) { return _to Init(window, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGLOBALPROPERTYINITIALIZER(_to) \
  NS_IMETHOD Init(nsIDOMWindow *window, JS::Value *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(window, _retval); } 
...
/* jsval init (in nsIDOMWindow window); */
NS_IMETHODIMP nsDOMGlobalPropertyInitializer::Init(nsIDOMWindow *window, JS::Value *_retval)
{
