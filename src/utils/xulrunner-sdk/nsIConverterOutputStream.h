/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpcom/io/nsIConverterOutputStream.idl
 */
...
class NS_NO_VTABLE nsIConverterOutputStream : public nsIUnicharOutputStream {
 public: 
  ...
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, PRUnichar aReplacementCharacter) = 0;
...
#define NS_DECL_NSICONVERTEROUTPUTSTREAM \
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, PRUnichar aReplacementCharacter); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONVERTEROUTPUTSTREAM(_to) \
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, PRUnichar aReplacementCharacter) { return _to Init(aOutStream, aCharset, aBufferSize, aReplacementCharacter); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONVERTEROUTPUTSTREAM(_to) \
  NS_IMETHOD Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, PRUnichar aReplacementCharacter) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aOutStream, aCharset, aBufferSize, aReplacementCharacter); } 
...
/* void init (in nsIOutputStream aOutStream, in string aCharset, in unsigned long aBufferSize, in PRUnichar aReplacementCharacter); */
NS_IMETHODIMP nsConverterOutputStream::Init(nsIOutputStream *aOutStream, const char * aCharset, uint32_t aBufferSize, PRUnichar aReplacementCharacter)
{
