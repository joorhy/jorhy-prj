/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/mozapps/extensions/amIWebInstaller.idl
 */
...
class NS_NO_VTABLE amIWebInstaller : public nsISupports {
 public: 
  ...
  NS_IMETHOD InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, uint32_t aInstallCount, bool *_retval) = 0;
...
#define NS_DECL_AMIWEBINSTALLER \
  ...
  NS_IMETHOD InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, uint32_t aInstallCount, bool *_retval); 
...
#define NS_FORWARD_AMIWEBINSTALLER(_to) \
  ...
  NS_IMETHOD InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, uint32_t aInstallCount, bool *_retval) { return _to InstallAddonsFromWebpage(aMimetype, aWindow, aReferer, aUris, aHashes, aNames, aIcons, aCallback, aInstallCount, _retval); } 
...
#define NS_FORWARD_SAFE_AMIWEBINSTALLER(_to) \
  ...
  NS_IMETHOD InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, uint32_t aInstallCount, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InstallAddonsFromWebpage(aMimetype, aWindow, aReferer, aUris, aHashes, aNames, aIcons, aCallback, aInstallCount, _retval); } 
...
/* boolean installAddonsFromWebpage (in AString aMimetype, in nsIDOMWindow aWindow, in nsIURI aReferer, [array, size_is (aInstallCount)] in wstring aUris, [array, size_is (aInstallCount)] in wstring aHashes, [array, size_is (aInstallCount)] in wstring aNames, [array, size_is (aInstallCount)] in wstring aIcons, [optional] in amIInstallCallback aCallback, [optional] in uint32_t aInstallCount); */
NS_IMETHODIMP amWebInstaller::InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, uint32_t aInstallCount, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
