/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/stylesheets/nsIDOMStyleSheetList.idl
 */
...
class NS_NO_VTABLE nsIDOMStyleSheetList : public nsISupports {
 public: 
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMStyleSheet * *_retval) = 0;
...
#define NS_DECL_NSIDOMSTYLESHEETLIST \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMStyleSheet * *_retval); 
...
#define NS_FORWARD_NSIDOMSTYLESHEETLIST(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMStyleSheet * *_retval) { return _to Item(index, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMSTYLESHEETLIST(_to) \
  ...
  NS_IMETHOD Item(uint32_t index, nsIDOMStyleSheet * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Item(index, _retval); } 
...
/* nsIDOMStyleSheet item (in unsigned long index); */
NS_IMETHODIMP nsDOMStyleSheetList::Item(uint32_t index, nsIDOMStyleSheet * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
