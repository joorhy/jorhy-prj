/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/modules/libpref/public/nsIPrefLocalizedString.idl
 */
...
class NS_NO_VTABLE nsIPrefLocalizedString : public nsISupports {
 public: 
  ...
  NS_IMETHOD SetDataWithLength(uint32_t length, const PRUnichar * data) = 0;
...
#define NS_DECL_NSIPREFLOCALIZEDSTRING \
  ...
  NS_IMETHOD SetDataWithLength(uint32_t length, const PRUnichar * data); 
...
#define NS_FORWARD_NSIPREFLOCALIZEDSTRING(_to) \
  ...
  NS_IMETHOD SetDataWithLength(uint32_t length, const PRUnichar * data) { return _to SetDataWithLength(length, data); } 
...
#define NS_FORWARD_SAFE_NSIPREFLOCALIZEDSTRING(_to) \
  ...
  NS_IMETHOD SetDataWithLength(uint32_t length, const PRUnichar * data) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDataWithLength(length, data); } 
...
/* void setDataWithLength (in unsigned long length, [size_is (length)] in wstring data); */
NS_IMETHODIMP nsPrefLocalizedString::SetDataWithLength(uint32_t length, const PRUnichar * data)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
