/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/components/satchel/nsIFormFillController.idl
 */
...
class NS_NO_VTABLE nsIFormFillController : public nsISupports {
 public: 
  ...
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput) = 0;
...
#define NS_DECL_NSIFORMFILLCONTROLLER \
  ...
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput); 
...
#define NS_FORWARD_NSIFORMFILLCONTROLLER(_to) \
  ...
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput) { return _to MarkAsLoginManagerField(aInput); } 
...
#define NS_FORWARD_SAFE_NSIFORMFILLCONTROLLER(_to) \
  ...
  NS_IMETHOD MarkAsLoginManagerField(nsIDOMHTMLInputElement *aInput) { return !_to ? NS_ERROR_NULL_POINTER : _to->MarkAsLoginManagerField(aInput); } 
