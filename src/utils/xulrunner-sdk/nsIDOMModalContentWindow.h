/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMModalContentWindow.idl
 */
...
class NS_NO_VTABLE nsIDOMModalContentWindow : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetDialogArguments(nsIArray * *aDialogArguments) = 0;
...
#define NS_DECL_NSIDOMMODALCONTENTWINDOW \
  NS_IMETHOD GetDialogArguments(nsIArray * *aDialogArguments); \
...
#define NS_FORWARD_NSIDOMMODALCONTENTWINDOW(_to) \
  NS_IMETHOD GetDialogArguments(nsIArray * *aDialogArguments) { return _to GetDialogArguments(aDialogArguments); } \
...
#define NS_FORWARD_SAFE_NSIDOMMODALCONTENTWINDOW(_to) \
  NS_IMETHOD GetDialogArguments(nsIArray * *aDialogArguments) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDialogArguments(aDialogArguments); } \
