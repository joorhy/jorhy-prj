/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMBarProp.idl
 */
...
/* attribute boolean visible; */
NS_IMETHODIMP nsDOMBarProp::GetVisible(bool *aVisible)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMBarProp::SetVisible(bool aVisible)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
