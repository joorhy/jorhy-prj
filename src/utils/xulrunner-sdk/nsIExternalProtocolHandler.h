/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsIExternalProtocolHandler.idl
 */
...
class NS_NO_VTABLE nsIExternalProtocolHandler : public nsIProtocolHandler {
 public: 
  ...
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval) = 0;
...
#define NS_DECL_NSIEXTERNALPROTOCOLHANDLER \
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval) { return _to ExternalAppExistsForScheme(scheme, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEXTERNALPROTOCOLHANDLER(_to) \
  NS_IMETHOD ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ExternalAppExistsForScheme(scheme, _retval); } 
...
/* boolean externalAppExistsForScheme (in ACString scheme); */
NS_IMETHODIMP nsExternalProtocolHandler::ExternalAppExistsForScheme(const nsACString & scheme, bool *_retval)
{
