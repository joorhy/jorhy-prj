/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/components/places/nsITaggingService.idl
 */
...
class NS_NO_VTABLE nsITaggingService : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetTagsForURI(nsIURI *aURI, uint32_t *length, PRUnichar * **aTags) = 0;
...
#define NS_DECL_NSITAGGINGSERVICE \
  ...
  NS_IMETHOD GetTagsForURI(nsIURI *aURI, uint32_t *length, PRUnichar * **aTags); \
...
#define NS_FORWARD_NSITAGGINGSERVICE(_to) \
  ...
  NS_IMETHOD GetTagsForURI(nsIURI *aURI, uint32_t *length, PRUnichar * **aTags) { return _to GetTagsForURI(aURI, length, aTags); } \
...
#define NS_FORWARD_SAFE_NSITAGGINGSERVICE(_to) \
  ...
  NS_IMETHOD GetTagsForURI(nsIURI *aURI, uint32_t *length, PRUnichar * **aTags) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTagsForURI(aURI, length, aTags); } \
...
/* void getTagsForURI (in nsIURI aURI, [optional] out unsigned long length, [array, size_is (length), retval] out wstring aTags); */
NS_IMETHODIMP nsTaggingService::GetTagsForURI(nsIURI *aURI, uint32_t *length, PRUnichar * **aTags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
