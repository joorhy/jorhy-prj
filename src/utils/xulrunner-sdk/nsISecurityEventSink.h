/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsISecurityEventSink.idl
 */
...
#define NS_DECL_NSISECURITYEVENTSINK \
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, uint32_t state); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISECURITYEVENTSINK(_to) \
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, uint32_t state) { return _to OnSecurityChange(i_Context, state); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISECURITYEVENTSINK(_to) \
  NS_IMETHOD OnSecurityChange(nsISupports *i_Context, uint32_t state) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnSecurityChange(i_Context, state); } 
