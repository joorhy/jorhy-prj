/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/nsIRDFXMLSource.idl
 */
...
class NS_NO_VTABLE nsIRDFXMLSource : public nsISupports {
 public: 
...
#define NS_FORWARD_NSIRDFXMLSOURCE(_to) \
  NS_IMETHOD Serialize(nsIOutputStream *aStream) { return _to Serialize(aStream); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFXMLSOURCE(_to) \
  NS_IMETHOD Serialize(nsIOutputStream *aStream) { return !_to ? NS_ERROR_NULL_POINTER : _to->Serialize(aStream); } 
