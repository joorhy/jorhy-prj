/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/xpath/nsIDOMXPathExpression.idl
 */
...
class NS_NO_VTABLE nsIDOMXPathExpression : public nsISupports {
 public: 
  ...
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, uint16_t type, nsISupports *result, nsISupports * *_retval) = 0;
...
#define NS_DECL_NSIDOMXPATHEXPRESSION \
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, uint16_t type, nsISupports *result, nsISupports * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMXPATHEXPRESSION(_to) \
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, uint16_t type, nsISupports *result, nsISupports * *_retval) { return _to Evaluate(contextNode, type, result, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMXPATHEXPRESSION(_to) \
  NS_IMETHOD Evaluate(nsIDOMNode *contextNode, uint16_t type, nsISupports *result, nsISupports * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Evaluate(contextNode, type, result, _retval); } 
...
/* nsISupports evaluate (in nsIDOMNode contextNode, in unsigned short type, in nsISupports result) raises (XPathException,DOMException); */
NS_IMETHODIMP nsDOMXPathExpression::Evaluate(nsIDOMNode *contextNode, uint16_t type, nsISupports *result, nsISupports * *_retval)
{
