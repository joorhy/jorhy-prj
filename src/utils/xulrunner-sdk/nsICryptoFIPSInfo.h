/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsICryptoFIPSInfo.idl
 */
...
class NS_NO_VTABLE nsICryptoFIPSInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) = 0;
...
#define NS_DECL_NSICRYPTOFIPSINFO \
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICRYPTOFIPSINFO(_to) \
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) { return _to GetIsFIPSModeActive(aIsFIPSModeActive); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICRYPTOFIPSINFO(_to) \
  NS_IMETHOD GetIsFIPSModeActive(bool *aIsFIPSModeActive) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsFIPSModeActive(aIsFIPSModeActive); } 
...
/* readonly attribute boolean isFIPSModeActive; */
NS_IMETHODIMP nsCryptoFIPSInfo::GetIsFIPSModeActive(bool *aIsFIPSModeActive)
{
