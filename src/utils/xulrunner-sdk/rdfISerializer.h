/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/rdfISerializer.idl
 */
...
#define NS_DECL_RDFISERIALIZER \
  NS_IMETHOD Serialize(rdfIDataSource *aDataSource, nsIOutputStream *aOut); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_RDFISERIALIZER(_to) \
  NS_IMETHOD Serialize(rdfIDataSource *aDataSource, nsIOutputStream *aOut) { return _to Serialize(aDataSource, aOut); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_RDFISERIALIZER(_to) \
  NS_IMETHOD Serialize(rdfIDataSource *aDataSource, nsIOutputStream *aOut) { return !_to ? NS_ERROR_NULL_POINTER : _to->Serialize(aDataSource, aOut); } 
