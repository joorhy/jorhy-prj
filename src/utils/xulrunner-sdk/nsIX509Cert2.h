/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsIX509Cert2.idl
 */
...
class NS_NO_VTABLE nsIX509Cert2 : public nsIX509Cert {
 public: 
...
#define NS_DECL_NSIX509CERT2 \
  NS_IMETHOD GetCertType(uint32_t *aCertType); \
  NS_IMETHOD MarkForPermDeletion(void); \
  NS_IMETHOD_(CERTCertificate *) GetCert(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIX509CERT2(_to) \
  NS_IMETHOD GetCertType(uint32_t *aCertType) { return _to GetCertType(aCertType); } \
  NS_IMETHOD MarkForPermDeletion(void) { return _to MarkForPermDeletion(); } \
  NS_IMETHOD_(CERTCertificate *) GetCert(void) { return _to GetCert(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIX509CERT2(_to) \
  NS_IMETHOD GetCertType(uint32_t *aCertType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCertType(aCertType); } \
  NS_IMETHOD MarkForPermDeletion(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->MarkForPermDeletion(); } \
  NS_IMETHOD_(CERTCertificate *) GetCert(void); 
...
/* readonly attribute unsigned long certType; */
NS_IMETHODIMP nsX509Cert2::GetCertType(uint32_t *aCertType)
{
