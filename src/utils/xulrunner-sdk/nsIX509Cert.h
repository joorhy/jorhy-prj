/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/security/manager/ssl/public/nsIX509Cert.idl
 */
...
class NS_NO_VTABLE nsIX509Cert : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetEmailAddresses(uint32_t *length, PRUnichar * **addresses) = 0;
  ...
  NS_IMETHOD GetUsagesArray(bool localOnly, uint32_t *verified, uint32_t *count, PRUnichar * **usages) = 0;
  ...
  NS_IMETHOD VerifyForUsage(uint32_t usage, uint32_t *_retval) = 0;
...
#define NS_DECL_NSIX509CERT \
  ...
  NS_IMETHOD GetEmailAddresses(uint32_t *length, PRUnichar * **addresses); \
  ...
  NS_IMETHOD GetUsagesArray(bool localOnly, uint32_t *verified, uint32_t *count, PRUnichar * **usages); \
  NS_IMETHOD GetUsagesString(bool localOnly, uint32_t *verified, nsAString & usages); \
  NS_IMETHOD VerifyForUsage(uint32_t usage, uint32_t *_retval); \
...
#define NS_FORWARD_NSIX509CERT(_to) \
  ...
  NS_IMETHOD GetEmailAddresses(uint32_t *length, PRUnichar * **addresses) { return _to GetEmailAddresses(length, addresses); } \
  ...
  NS_IMETHOD GetUsagesArray(bool localOnly, uint32_t *verified, uint32_t *count, PRUnichar * **usages) { return _to GetUsagesArray(localOnly, verified, count, usages); } \
  ...
  NS_IMETHOD VerifyForUsage(uint32_t usage, uint32_t *_retval) { return _to VerifyForUsage(usage, _retval); } \
...
#define NS_FORWARD_SAFE_NSIX509CERT(_to) \
  ...
  NS_IMETHOD GetEmailAddresses(uint32_t *length, PRUnichar * **addresses) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEmailAddresses(length, addresses); } \
  ...
  NS_IMETHOD GetUsagesArray(bool localOnly, uint32_t *verified, uint32_t *count, PRUnichar * **usages) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUsagesArray(localOnly, verified, count, usages); } \
  ...
  NS_IMETHOD VerifyForUsage(uint32_t usage, uint32_t *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->VerifyForUsage(usage, _retval); } \
...
/* void getEmailAddresses (out unsigned long length, [array, size_is (length), retval] out wstring addresses); */
NS_IMETHODIMP nsX509Cert::GetEmailAddresses(uint32_t *length, PRUnichar * **addresses)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getUsagesArray (in boolean localOnly, out uint32_t verified, out uint32_t count, [array, size_is (count)] out wstring usages); */
NS_IMETHODIMP nsX509Cert::GetUsagesArray(bool localOnly, uint32_t *verified, uint32_t *count, PRUnichar * **usages)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* unsigned long verifyForUsage (in unsigned long usage); */
NS_IMETHODIMP nsX509Cert::VerifyForUsage(uint32_t usage, uint32_t *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
