/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/intl/unicharutil/idl/nsIUnicodeNormalizer.idl
 */
...
#define NS_FORWARD_NSIUNICODENORMALIZER(_to) \
  NS_IMETHOD NormalizeUnicodeNFD(const nsAString & aSrc, nsAString & aDest) { return _to NormalizeUnicodeNFD(aSrc, aDest); } \
  NS_IMETHOD NormalizeUnicodeNFC(const nsAString & aSrc, nsAString & aDest) { return _to NormalizeUnicodeNFC(aSrc, aDest); } \
  NS_IMETHOD NormalizeUnicodeNFKD(const nsAString & aSrc, nsAString & aDest) { return _to NormalizeUnicodeNFKD(aSrc, aDest); } \
  NS_IMETHOD NormalizeUnicodeNFKC(const nsAString & aSrc, nsAString & aDest) { return _to NormalizeUnicodeNFKC(aSrc, aDest); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUNICODENORMALIZER(_to) \
  NS_IMETHOD NormalizeUnicodeNFD(const nsAString & aSrc, nsAString & aDest) { return !_to ? NS_ERROR_NULL_POINTER : _to->NormalizeUnicodeNFD(aSrc, aDest); } \
  NS_IMETHOD NormalizeUnicodeNFC(const nsAString & aSrc, nsAString & aDest) { return !_to ? NS_ERROR_NULL_POINTER : _to->NormalizeUnicodeNFC(aSrc, aDest); } \
  NS_IMETHOD NormalizeUnicodeNFKD(const nsAString & aSrc, nsAString & aDest) { return !_to ? NS_ERROR_NULL_POINTER : _to->NormalizeUnicodeNFKD(aSrc, aDest); } \
  NS_IMETHOD NormalizeUnicodeNFKC(const nsAString & aSrc, nsAString & aDest) { return !_to ? NS_ERROR_NULL_POINTER : _to->NormalizeUnicodeNFKC(aSrc, aDest); } 
