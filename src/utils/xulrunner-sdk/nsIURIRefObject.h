/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/editor/idl/nsIURIRefObject.idl
 */
...
#define NS_DECL_NSIURIREFOBJECT \
  ...
  NS_IMETHOD GetNextURI(nsAString & _retval); \
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel); 
...
#define NS_FORWARD_NSIURIREFOBJECT(_to) \
  ...
  NS_IMETHOD GetNextURI(nsAString & _retval) { return _to GetNextURI(_retval); } \
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel) { return _to RewriteAllURIs(aOldPat, aNewPat, aMakeRel); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIURIREFOBJECT(_to) \
  NS_IMETHOD GetNode(nsIDOMNode * *aNode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNode(aNode); } \
  ...
  NS_IMETHOD GetNextURI(nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNextURI(_retval); } \
  NS_IMETHOD RewriteAllURIs(const nsAString & aOldPat, const nsAString & aNewPat, bool aMakeRel) { return !_to ? NS_ERROR_NULL_POINTER : _to->RewriteAllURIs(aOldPat, aNewPat, aMakeRel); } 
