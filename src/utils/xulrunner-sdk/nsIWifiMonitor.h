/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/wifi/nsIWifiMonitor.idl
 */
...
#define NS_DECL_NSIWIFIMONITOR \
  NS_IMETHOD StartWatching(nsIWifiListener *aListener); \
  NS_IMETHOD StopWatching(nsIWifiListener *aListener); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWIFIMONITOR(_to) \
  NS_IMETHOD StartWatching(nsIWifiListener *aListener) { return _to StartWatching(aListener); } \
  NS_IMETHOD StopWatching(nsIWifiListener *aListener) { return _to StopWatching(aListener); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWIFIMONITOR(_to) \
  NS_IMETHOD StartWatching(nsIWifiListener *aListener) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartWatching(aListener); } \
  NS_IMETHOD StopWatching(nsIWifiListener *aListener) { return !_to ? NS_ERROR_NULL_POINTER : _to->StopWatching(aListener); } 
