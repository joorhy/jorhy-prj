/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpcom/base/nsITraceRefcnt.idl
 */
...
class NS_NO_VTABLE nsITraceRefcnt : public nsISupports {
 public: 
  ...
  NS_IMETHOD LogAddRef(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName, uint32_t aInstanceSize) = 0;
  ...
  NS_IMETHOD LogCtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize) = 0;

  /* void logDtor (in voidPtr aPtr, in string aTypeName, in unsigned long aInstanceSize); */
  NS_IMETHOD LogDtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize) = 0;
...
#define NS_DECL_NSITRACEREFCNT \
  NS_IMETHOD LogAddRef(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName, uint32_t aInstanceSize); \
  NS_IMETHOD LogRelease(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName); \
  NS_IMETHOD LogCtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize); \
  NS_IMETHOD LogDtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize); \
...
#define NS_FORWARD_NSITRACEREFCNT(_to) \
  NS_IMETHOD LogAddRef(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName, uint32_t aInstanceSize) { return _to LogAddRef(aPtr, aNewRefcnt, aTypeName, aInstanceSize); } \
  NS_IMETHOD LogRelease(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName) { return _to LogRelease(aPtr, aNewRefcnt, aTypeName); } \
  NS_IMETHOD LogCtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize) { return _to LogCtor(aPtr, aTypeName, aInstanceSize); } \
  NS_IMETHOD LogDtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize) { return _to LogDtor(aPtr, aTypeName, aInstanceSize); } \
...
#define NS_FORWARD_SAFE_NSITRACEREFCNT(_to) \
  NS_IMETHOD LogAddRef(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName, uint32_t aInstanceSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->LogAddRef(aPtr, aNewRefcnt, aTypeName, aInstanceSize); } \
  ...
  NS_IMETHOD LogCtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->LogCtor(aPtr, aTypeName, aInstanceSize); } \
  NS_IMETHOD LogDtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->LogDtor(aPtr, aTypeName, aInstanceSize); } \
...
/* void logAddRef (in voidPtr aPtr, in nsrefcnt aNewRefcnt, in string aTypeName, in unsigned long aInstanceSize); */
NS_IMETHODIMP nsTraceRefcnt::LogAddRef(void *aPtr, nsrefcnt aNewRefcnt, const char * aTypeName, uint32_t aInstanceSize)
{
...
/* void logCtor (in voidPtr aPtr, in string aTypeName, in unsigned long aInstanceSize); */
NS_IMETHODIMP nsTraceRefcnt::LogCtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void logDtor (in voidPtr aPtr, in string aTypeName, in unsigned long aInstanceSize); */
NS_IMETHODIMP nsTraceRefcnt::LogDtor(void *aPtr, const char * aTypeName, uint32_t aInstanceSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
