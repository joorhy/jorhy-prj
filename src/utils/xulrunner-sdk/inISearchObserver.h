/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/layout/inspector/public/inISearchObserver.idl
 */
...
#define NS_DECL_INISEARCHOBSERVER \
  NS_IMETHOD OnSearchStart(inISearchProcess *aModule); \
  NS_IMETHOD OnSearchResult(inISearchProcess *aModule); \
  NS_IMETHOD OnSearchEnd(inISearchProcess *aModule, int16_t aResult); \
  NS_IMETHOD OnSearchError(inISearchProcess *aModule, const nsAString & aMessage); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_INISEARCHOBSERVER(_to) \
  NS_IMETHOD OnSearchStart(inISearchProcess *aModule) { return _to OnSearchStart(aModule); } \
  NS_IMETHOD OnSearchResult(inISearchProcess *aModule) { return _to OnSearchResult(aModule); } \
  NS_IMETHOD OnSearchEnd(inISearchProcess *aModule, int16_t aResult) { return _to OnSearchEnd(aModule, aResult); } \
  NS_IMETHOD OnSearchError(inISearchProcess *aModule, const nsAString & aMessage) { return _to OnSearchError(aModule, aMessage); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_INISEARCHOBSERVER(_to) \
  NS_IMETHOD OnSearchStart(inISearchProcess *aModule) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnSearchStart(aModule); } \
  NS_IMETHOD OnSearchResult(inISearchProcess *aModule) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnSearchResult(aModule); } \
  NS_IMETHOD OnSearchEnd(inISearchProcess *aModule, int16_t aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnSearchEnd(aModule, aResult); } \
  NS_IMETHOD OnSearchError(inISearchProcess *aModule, const nsAString & aMessage) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnSearchError(aModule, aMessage); } 
