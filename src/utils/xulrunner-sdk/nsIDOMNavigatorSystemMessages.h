/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/messages/interfaces/nsIDOMNavigatorSystemMessages.idl
 */
...
class NS_NO_VTABLE nsIDOMSystemMessageCallback : public nsISupports {
 public: 
  ...
  NS_IMETHOD HandleMessage(const JS::Value & message) = 0;
...
#define NS_DECL_NSIDOMSYSTEMMESSAGECALLBACK \
  NS_IMETHOD HandleMessage(const JS::Value & message); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSYSTEMMESSAGECALLBACK(_to) \
  NS_IMETHOD HandleMessage(const JS::Value & message) { return _to HandleMessage(message); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSYSTEMMESSAGECALLBACK(_to) \
  NS_IMETHOD HandleMessage(const JS::Value & message) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleMessage(message); } 
...
/* void handleMessage (in jsval message); */
NS_IMETHODIMP nsDOMSystemMessageCallback::HandleMessage(const JS::Value & message)
{
