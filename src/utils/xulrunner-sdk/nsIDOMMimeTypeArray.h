/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIDOMMimeTypeArray.idl
 */
...
/* readonly attribute unsigned long length; */
NS_IMETHODIMP nsDOMMimeTypeArray::GetLength(uint32_t *aLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMMimeType item (in unsigned long index); */
NS_IMETHODIMP nsDOMMimeTypeArray::Item(uint32_t index, nsIDOMMimeType * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
