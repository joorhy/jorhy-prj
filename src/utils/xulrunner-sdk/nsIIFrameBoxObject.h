/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/layout/xul/base/public/nsIIFrameBoxObject.idl
 */
...
class NS_NO_VTABLE nsIIFrameBoxObject : public nsIContainerBoxObject {
 public: 
