/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/interfaces/base/nsIContentURIGrouper.idl
 */
...
#define NS_DECL_NSICONTENTURIGROUPER \
  NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTENTURIGROUPER(_to) \
  NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval) { return _to Group(aURI, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTENTURIGROUPER(_to) \
  NS_IMETHOD Group(nsIURI *aURI, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Group(aURI, _retval); } 
