/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/toolkit/components/feeds/nsIFeedElementBase.idl
 */
...
#define NS_DECL_NSIFEEDELEMENTBASE \
  NS_IMETHOD GetAttributes(nsISAXAttributes * *aAttributes); \
  NS_IMETHOD SetAttributes(nsISAXAttributes *aAttributes); \
...
#define NS_FORWARD_NSIFEEDELEMENTBASE(_to) \
  NS_IMETHOD GetAttributes(nsISAXAttributes * *aAttributes) { return _to GetAttributes(aAttributes); } \
  NS_IMETHOD SetAttributes(nsISAXAttributes *aAttributes) { return _to SetAttributes(aAttributes); } \
...
#define NS_FORWARD_SAFE_NSIFEEDELEMENTBASE(_to) \
  NS_IMETHOD GetAttributes(nsISAXAttributes * *aAttributes) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAttributes(aAttributes); } \
  NS_IMETHOD SetAttributes(nsISAXAttributes *aAttributes) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAttributes(aAttributes); } \
