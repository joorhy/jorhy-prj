/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/nsIRDFNode.idl
 */
...
#define NS_DECL_NSIRDFNODE \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFNODE(_to) \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval) { return _to EqualsNode(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFNODE(_to) \
  NS_IMETHOD EqualsNode(nsIRDFNode *aNode, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->EqualsNode(aNode, _retval); } 
