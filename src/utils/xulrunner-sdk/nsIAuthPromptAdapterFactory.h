/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsIAuthPromptAdapterFactory.idl
 */
...
class NS_NO_VTABLE nsIAuthPromptAdapterFactory : public nsISupports {
 public: 
  ...
  NS_IMETHOD CreateAdapter(nsIAuthPrompt *aPrompt, nsIAuthPrompt2 * *_retval) = 0;
...
#define NS_DECL_NSIAUTHPROMPTADAPTERFACTORY \
  NS_IMETHOD CreateAdapter(nsIAuthPrompt *aPrompt, nsIAuthPrompt2 * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAUTHPROMPTADAPTERFACTORY(_to) \
  NS_IMETHOD CreateAdapter(nsIAuthPrompt *aPrompt, nsIAuthPrompt2 * *_retval) { return _to CreateAdapter(aPrompt, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAUTHPROMPTADAPTERFACTORY(_to) \
  NS_IMETHOD CreateAdapter(nsIAuthPrompt *aPrompt, nsIAuthPrompt2 * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateAdapter(aPrompt, _retval); } 
