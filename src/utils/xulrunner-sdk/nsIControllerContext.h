/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/embedding/components/commandhandler/public/nsIControllerContext.idl
 */
...
#define NS_DECL_NSICONTROLLERCONTEXT \
  NS_IMETHOD Init(nsIControllerCommandTable *aCommandTable); \
  NS_IMETHOD SetCommandContext(nsISupports *aCommandContext); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICONTROLLERCONTEXT(_to) \
  NS_IMETHOD Init(nsIControllerCommandTable *aCommandTable) { return _to Init(aCommandTable); } \
  NS_IMETHOD SetCommandContext(nsISupports *aCommandContext) { return _to SetCommandContext(aCommandContext); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICONTROLLERCONTEXT(_to) \
  NS_IMETHOD Init(nsIControllerCommandTable *aCommandTable) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aCommandTable); } \
  NS_IMETHOD SetCommandContext(nsISupports *aCommandContext) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCommandContext(aCommandContext); } 
