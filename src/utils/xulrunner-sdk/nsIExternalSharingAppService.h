/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/uriloader/exthandler/nsIExternalSharingAppService.idl
 */
...
#define NS_DECL_NSISHARINGHANDLERAPP \
  NS_IMETHOD Share(const nsAString & data, const nsAString & title); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISHARINGHANDLERAPP(_to) \
  NS_IMETHOD Share(const nsAString & data, const nsAString & title) { return _to Share(data, title); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISHARINGHANDLERAPP(_to) \
  NS_IMETHOD Share(const nsAString & data, const nsAString & title) { return !_to ? NS_ERROR_NULL_POINTER : _to->Share(data, title); } 
...
#define NS_DECL_NSIEXTERNALSHARINGAPPSERVICE \
  NS_IMETHOD ShareWithDefault(const nsAString & data, const nsAString & mime, const nsAString & title); \
  NS_IMETHOD GetSharingApps(const nsAString & aMIMEType, uint32_t *aLen, nsISharingHandlerApp * **handlerApps); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEXTERNALSHARINGAPPSERVICE(_to) \
  NS_IMETHOD ShareWithDefault(const nsAString & data, const nsAString & mime, const nsAString & title) { return _to ShareWithDefault(data, mime, title); } \
  NS_IMETHOD GetSharingApps(const nsAString & aMIMEType, uint32_t *aLen, nsISharingHandlerApp * **handlerApps) { return _to GetSharingApps(aMIMEType, aLen, handlerApps); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEXTERNALSHARINGAPPSERVICE(_to) \
  NS_IMETHOD ShareWithDefault(const nsAString & data, const nsAString & mime, const nsAString & title) { return !_to ? NS_ERROR_NULL_POINTER : _to->ShareWithDefault(data, mime, title); } \
  NS_IMETHOD GetSharingApps(const nsAString & aMIMEType, uint32_t *aLen, nsISharingHandlerApp * **handlerApps) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSharingApps(aMIMEType, aLen, handlerApps); } 
