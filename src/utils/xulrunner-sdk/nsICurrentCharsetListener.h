/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/intl/uconv/idl/nsICurrentCharsetListener.idl
 */
...
class NS_NO_VTABLE nsICurrentCharsetListener : public nsISupports {
 public: 
  ...
  NS_IMETHOD SetCurrentCharset(const PRUnichar * charset) = 0;

  /* void SetCurrentMailCharset (in wstring charset); */
  NS_IMETHOD SetCurrentMailCharset(const PRUnichar * charset) = 0;

  /* void SetCurrentComposerCharset (in wstring charset); */
  NS_IMETHOD SetCurrentComposerCharset(const PRUnichar * charset) = 0;
...
#define NS_DECL_NSICURRENTCHARSETLISTENER \
  NS_IMETHOD SetCurrentCharset(const PRUnichar * charset); \
  NS_IMETHOD SetCurrentMailCharset(const PRUnichar * charset); \
  NS_IMETHOD SetCurrentComposerCharset(const PRUnichar * charset); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICURRENTCHARSETLISTENER(_to) \
  NS_IMETHOD SetCurrentCharset(const PRUnichar * charset) { return _to SetCurrentCharset(charset); } \
  NS_IMETHOD SetCurrentMailCharset(const PRUnichar * charset) { return _to SetCurrentMailCharset(charset); } \
  NS_IMETHOD SetCurrentComposerCharset(const PRUnichar * charset) { return _to SetCurrentComposerCharset(charset); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICURRENTCHARSETLISTENER(_to) \
  NS_IMETHOD SetCurrentCharset(const PRUnichar * charset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentCharset(charset); } \
  NS_IMETHOD SetCurrentMailCharset(const PRUnichar * charset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentMailCharset(charset); } \
  NS_IMETHOD SetCurrentComposerCharset(const PRUnichar * charset) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCurrentComposerCharset(charset); } 
