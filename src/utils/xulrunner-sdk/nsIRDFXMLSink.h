/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/nsIRDFXMLSink.idl
 */
...
class NS_NO_VTABLE nsIRDFXMLSinkObserver : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnError(nsIRDFXMLSink *aSink, nsresult aStatus, const PRUnichar * aErrorMsg) = 0;
...
#define NS_DECL_NSIRDFXMLSINKOBSERVER \
  ...
  NS_IMETHOD OnError(nsIRDFXMLSink *aSink, nsresult aStatus, const PRUnichar * aErrorMsg); 
...
#define NS_FORWARD_NSIRDFXMLSINKOBSERVER(_to) \
  ...
  NS_IMETHOD OnError(nsIRDFXMLSink *aSink, nsresult aStatus, const PRUnichar * aErrorMsg) { return _to OnError(aSink, aStatus, aErrorMsg); } 
...
#define NS_FORWARD_SAFE_NSIRDFXMLSINKOBSERVER(_to) \
  ...
  NS_IMETHOD OnError(nsIRDFXMLSink *aSink, nsresult aStatus, const PRUnichar * aErrorMsg) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnError(aSink, aStatus, aErrorMsg); } 
