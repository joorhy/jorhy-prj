/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/editor/txtsvc/public/nsITextServicesFilter.idl
 */
...
class NS_NO_VTABLE nsITextServicesFilter : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ITEXTSERVICESFILTER_IID)

  /* boolean skip (in nsIDOMNode aNode); */
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval) = 0;
...
#define NS_DECL_NSITEXTSERVICESFILTER \
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITEXTSERVICESFILTER(_to) \
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval) { return _to Skip(aNode, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITEXTSERVICESFILTER(_to) \
  NS_IMETHOD Skip(nsIDOMNode *aNode, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Skip(aNode, _retval); } 
...
/* boolean skip (in nsIDOMNode aNode); */
NS_IMETHODIMP nsTextServicesFilter::Skip(nsIDOMNode *aNode, bool *_retval)
{
