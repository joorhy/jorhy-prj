/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpfe/appshell/public/nsIWindowMediatorListener.idl
 */
...
class NS_NO_VTABLE nsIWindowMediatorListener : public nsISupports {
 public: 
  ...
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const PRUnichar * newTitle) = 0;
...
#define NS_DECL_NSIWINDOWMEDIATORLISTENER \
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const PRUnichar * newTitle); \
  NS_IMETHOD OnOpenWindow(nsIXULWindow *window); \
  NS_IMETHOD OnCloseWindow(nsIXULWindow *window); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINDOWMEDIATORLISTENER(_to) \
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const PRUnichar * newTitle) { return _to OnWindowTitleChange(window, newTitle); } \
  NS_IMETHOD OnOpenWindow(nsIXULWindow *window) { return _to OnOpenWindow(window); } \
  NS_IMETHOD OnCloseWindow(nsIXULWindow *window) { return _to OnCloseWindow(window); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINDOWMEDIATORLISTENER(_to) \
  NS_IMETHOD OnWindowTitleChange(nsIXULWindow *window, const PRUnichar * newTitle) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWindowTitleChange(window, newTitle); } \
  NS_IMETHOD OnOpenWindow(nsIXULWindow *window) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnOpenWindow(window); } \
  NS_IMETHOD OnCloseWindow(nsIXULWindow *window) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnCloseWindow(window); } 
