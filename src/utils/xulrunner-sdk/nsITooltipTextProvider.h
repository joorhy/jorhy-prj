/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/embedding/browser/webBrowser/nsITooltipTextProvider.idl
 */
...
class NS_NO_VTABLE nsITooltipTextProvider : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, PRUnichar * *aText, bool *_retval) = 0;
...
#define NS_DECL_NSITOOLTIPTEXTPROVIDER \
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, PRUnichar * *aText, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITOOLTIPTEXTPROVIDER(_to) \
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, PRUnichar * *aText, bool *_retval) { return _to GetNodeText(aNode, aText, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITOOLTIPTEXTPROVIDER(_to) \
  NS_IMETHOD GetNodeText(nsIDOMNode *aNode, PRUnichar * *aText, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNodeText(aNode, aText, _retval); } 
...
/* boolean getNodeText (in nsIDOMNode aNode, out wstring aText); */
NS_IMETHODIMP nsTooltipTextProvider::GetNodeText(nsIDOMNode *aNode, PRUnichar * *aText, bool *_retval)
{
