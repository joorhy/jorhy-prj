...
#ifndef mozilla_dom_ScreenBinding_h__
#define mozilla_dom_ScreenBinding_h__
...
template <>
struct PrototypeIDMap<nsScreen>
{
  enum
  {
    PrototypeID = prototypes::id::Screen
  };
};
} // namespace dom
} // namespace mozilla
...
namespace ScreenBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::Screen];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::Screen];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::Screen];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::Screen];
    }
...
#endif // mozilla_dom_ScreenBinding_h__
