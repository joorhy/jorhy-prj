...
#ifndef mozilla_dom_HTMLOptionsCollectionBinding_h__
#define mozilla_dom_HTMLOptionsCollectionBinding_h__
...
struct PrototypeTraits<prototypes::id::HTMLOptionsCollection>
{
  ...
  typedef nsHTMLOptionCollection NativeType;
};
template <>
struct PrototypeIDMap<nsHTMLOptionCollection>
{
  enum
  {
    PrototypeID = prototypes::id::HTMLOptionsCollection
  };
};
} // namespace dom
} // namespace mozilla
...
namespace HTMLOptionsCollectionBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::HTMLOptionsCollection];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::HTMLOptionsCollection];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::HTMLOptionsCollection];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::HTMLOptionsCollection];
    }
...
#endif // mozilla_dom_HTMLOptionsCollectionBinding_h__
