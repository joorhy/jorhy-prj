...
#ifndef mozilla_dom_SVGPointListBinding_h__
#define mozilla_dom_SVGPointListBinding_h__
...
struct PrototypeTraits<prototypes::id::SVGPointList>
{
  ...
  typedef mozilla::DOMSVGPointList NativeType;
};
template <>
struct PrototypeIDMap<mozilla::DOMSVGPointList>
{
  enum
  {
    PrototypeID = prototypes::id::SVGPointList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SVGPointListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SVGPointList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SVGPointList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SVGPointList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SVGPointList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::DOMSVGPointList* aObject, nsWrapperCache* aCache, bool* aTriedToWrap);
...
#endif // mozilla_dom_SVGPointListBinding_h__
