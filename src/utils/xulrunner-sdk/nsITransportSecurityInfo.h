/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/socket/nsITransportSecurityInfo.idl
 */
...
class NS_NO_VTABLE nsITransportSecurityInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetErrorMessage(PRUnichar * *aErrorMessage) = 0;
...
#define NS_DECL_NSITRANSPORTSECURITYINFO \
  ...
  NS_IMETHOD GetErrorMessage(PRUnichar * *aErrorMessage); 
...
#define NS_FORWARD_NSITRANSPORTSECURITYINFO(_to) \
  ...
  NS_IMETHOD GetErrorMessage(PRUnichar * *aErrorMessage) { return _to GetErrorMessage(aErrorMessage); } 
...
#define NS_FORWARD_SAFE_NSITRANSPORTSECURITYINFO(_to) \
  ...
  NS_IMETHOD GetErrorMessage(PRUnichar * *aErrorMessage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetErrorMessage(aErrorMessage); } 
