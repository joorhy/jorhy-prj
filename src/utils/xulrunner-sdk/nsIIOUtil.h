/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/xpcom/io/nsIIOUtil.idl
 */
...
#define NS_DECL_NSIIOUTIL \
  NS_IMETHOD InputStreamIsBuffered(nsIInputStream *aStream, bool *_retval); \
  NS_IMETHOD OutputStreamIsBuffered(nsIOutputStream *aStream, bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIOUTIL(_to) \
  NS_IMETHOD InputStreamIsBuffered(nsIInputStream *aStream, bool *_retval) { return _to InputStreamIsBuffered(aStream, _retval); } \
  NS_IMETHOD OutputStreamIsBuffered(nsIOutputStream *aStream, bool *_retval) { return _to OutputStreamIsBuffered(aStream, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIIOUTIL(_to) \
  NS_IMETHOD InputStreamIsBuffered(nsIInputStream *aStream, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InputStreamIsBuffered(aStream, _retval); } \
  NS_IMETHOD OutputStreamIsBuffered(nsIOutputStream *aStream, bool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->OutputStreamIsBuffered(aStream, _retval); } 
