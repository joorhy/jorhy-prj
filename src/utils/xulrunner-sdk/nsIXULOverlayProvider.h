/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/content/xul/document/public/nsIXULOverlayProvider.idl
 */
...
#define NS_DECL_NSIXULOVERLAYPROVIDER \
  NS_IMETHOD GetXULOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval); \
  NS_IMETHOD GetStyleOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXULOVERLAYPROVIDER(_to) \
  NS_IMETHOD GetXULOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval) { return _to GetXULOverlays(aURI, _retval); } \
  NS_IMETHOD GetStyleOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval) { return _to GetStyleOverlays(aURI, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXULOVERLAYPROVIDER(_to) \
  NS_IMETHOD GetXULOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetXULOverlays(aURI, _retval); } \
  NS_IMETHOD GetStyleOverlays(nsIURI *aURI, nsISimpleEnumerator * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStyleOverlays(aURI, _retval); } 
