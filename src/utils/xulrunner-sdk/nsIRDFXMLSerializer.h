/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/rdf/base/idl/nsIRDFXMLSerializer.idl
 */
...
#define NS_DECL_NSIRDFXMLSERIALIZER \
  NS_IMETHOD Init(nsIRDFDataSource *aDataSource); \
  NS_IMETHOD AddNameSpace(nsIAtom *aPrefix, const nsAString & aURI); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIRDFXMLSERIALIZER(_to) \
  NS_IMETHOD Init(nsIRDFDataSource *aDataSource) { return _to Init(aDataSource); } \
  NS_IMETHOD AddNameSpace(nsIAtom *aPrefix, const nsAString & aURI) { return _to AddNameSpace(aPrefix, aURI); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIRDFXMLSERIALIZER(_to) \
  NS_IMETHOD Init(nsIRDFDataSource *aDataSource) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aDataSource); } \
  NS_IMETHOD AddNameSpace(nsIAtom *aPrefix, const nsAString & aURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddNameSpace(aPrefix, aURI); } 
