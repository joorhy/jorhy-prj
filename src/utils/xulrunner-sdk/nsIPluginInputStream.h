/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/dom/plugins/base/nsIPluginInputStream.idl
 */
...
#define NS_DECL_NSIPLUGININPUTSTREAM \
  NS_IMETHOD GetLastModified(uint32_t *aResult); \
  NS_IMETHOD RequestRead(NPByteRange *aRangeList); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPLUGININPUTSTREAM(_to) \
  NS_IMETHOD GetLastModified(uint32_t *aResult) { return _to GetLastModified(aResult); } \
...
#define NS_FORWARD_SAFE_NSIPLUGININPUTSTREAM(_to) \
  NS_IMETHOD GetLastModified(uint32_t *aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastModified(aResult); } \
