/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/netwerk/base/public/nsITraceableChannel.idl
 */
...
class NS_NO_VTABLE nsITraceableChannel : public nsISupports {
 public: 
  ...
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval) = 0;
...
#define NS_DECL_NSITRACEABLECHANNEL \
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITRACEABLECHANNEL(_to) \
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval) { return _to SetNewListener(aListener, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITRACEABLECHANNEL(_to) \
  NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNewListener(aListener, _retval); } 
