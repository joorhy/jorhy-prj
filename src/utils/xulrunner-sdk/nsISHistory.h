/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr_w32_bld-000000000/build/docshell/shistory/public/nsISHistory.idl
 */
...
#define NS_ISHISTORY_IID_STR "ef2c9bcb-96b8-4095-933a-cb1c506f2c58"

#define NS_ISHISTORY_IID \
  {0xef2c9bcb, 0x96b8, 0x4095, \
    { 0x93, 0x3a, 0xcb, 0x1c, 0x50, 0x6f, 0x2c, 0x58 }}
...
class NS_NO_VTABLE nsISHistory : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetEntryAtIndex(int32_t index, bool modifyIndex, nsIHistoryEntry * *_retval) = 0;
...
#define NS_DECL_NSISHISTORY \
  ...
  NS_IMETHOD GetEntryAtIndex(int32_t index, bool modifyIndex, nsIHistoryEntry * *_retval); \
...
#define NS_FORWARD_NSISHISTORY(_to) \
  ...
  NS_IMETHOD GetEntryAtIndex(int32_t index, bool modifyIndex, nsIHistoryEntry * *_retval) { return _to GetEntryAtIndex(index, modifyIndex, _retval); } \
...
#define NS_FORWARD_SAFE_NSISHISTORY(_to) \
  ...
  NS_IMETHOD GetEntryAtIndex(int32_t index, bool modifyIndex, nsIHistoryEntry * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEntryAtIndex(index, modifyIndex, _retval); } \
...
/* nsIHistoryEntry getEntryAtIndex (in long index, in boolean modifyIndex); */
NS_IMETHODIMP nsSHistory::GetEntryAtIndex(int32_t index, bool modifyIndex, nsIHistoryEntry * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
