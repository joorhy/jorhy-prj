...
public:
	...
	///@return 		参考x_error_type.h
	J_Obj *CreateInstance(const char *pResId, int nStreamType, OBJ_TYPE nType);
	...
	J_Obj *GetInstance(const char *pResId, OBJ_TYPE nType, int nStreamType);
	...
	///@return 		参考x_error_type.h
	j_result_t RemoveInstance(const char *pResId, OBJ_TYPE nType, int nStreamType);
