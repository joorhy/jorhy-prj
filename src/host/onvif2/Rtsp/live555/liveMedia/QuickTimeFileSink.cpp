...
#define addEdit1(m_duration,trackPosition) do { \
      unsigned trackDuration \
        = (unsigned) ((2*(m_duration)*movieTimeScale()+1)/2); \
            /* in movie time units */ \
...
#define addEdit(m_duration) addEdit1((m_duration),editTrackPosition)
#define addEmptyEdit(m_duration) addEdit1((m_duration),(~0))
