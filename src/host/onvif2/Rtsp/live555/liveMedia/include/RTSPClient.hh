...
public:
  ...
  typedef void (responseHandler)(RTSPClient* rtspClient,
				 int resultCode, char* resultString, void * pTargetActionClient);
  ...
  /*Lyc*/
  void * pActionRtspClient;

  /*Lyc*/
  void InitActionRtspClient(void * ActionRtspClient)
  {
	  pActionRtspClient = ActionRtspClient;
  }
...
private:
  ...
  static void responseHandlerForHTTP_GET(RTSPClient* rtspClient, int responseCode, char* responseString, void * ActionRtspClient);
