...
static void continueAfterDESCRIBE(RTSPClient* rtspClient, int resultCode, char* resultString, void * ActionRtspClient) {
  char const* res;
...
static void continueAfterSETUP(RTSPClient* rtspClient, int resultCode, char* resultString, void * ActionRtspClient) {
  if (resultCode == 0) {
...
static void continueAfterOPTIONS(RTSPClient* rtspClient, int resultCode, char* resultString, void * ActionRtspClient) {
