/* soapSubscriptionManagerBindingObject.h
...
#ifndef soapSubscriptionManagerBindingObject_H
#define soapSubscriptionManagerBindingObject_H
#include "soapH.h"
...
class SubscriptionManagerBindingService : public soap
{    public:
