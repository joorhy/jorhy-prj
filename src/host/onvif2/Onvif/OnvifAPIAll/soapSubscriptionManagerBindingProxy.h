...
#include "soapH.h"
class SubscriptionManagerBinding
{   public:
	/// Runtime engine context allocated in constructor
	struct soap *soap;
	/// Endpoint URL of service 'SubscriptionManagerBinding' (change as needed)
	const char *endpoint;
	...
	{ soap = soap_new(); endpoint = "http://localhost:80"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual ~SubscriptionManagerBinding() { if (soap) { soap_destroy(soap); soap_end(soap); soap_free(soap); } };
	/// Invoke 'Renew' of service 'SubscriptionManagerBinding' and return error code (or SOAP_OK)
	virtual int __ns12__Renew(_ns1__Renew *ns1__Renew, _ns1__RenewResponse *ns1__RenewResponse) { return soap ? soap_call___ns12__Renew(soap, endpoint, NULL, ns1__Renew, ns1__RenewResponse) : SOAP_EOM; };
	/// Invoke 'Unsubscribe' of service 'SubscriptionManagerBinding' and return error code (or SOAP_OK)
	virtual int __ns12__Unsubscribe(_ns1__Unsubscribe *ns1__Unsubscribe, _ns1__UnsubscribeResponse *ns1__UnsubscribeResponse) { return soap ? soap_call___ns12__Unsubscribe(soap, endpoint, NULL, ns1__Unsubscribe, ns1__UnsubscribeResponse) : SOAP_EOM; };
};
#endif
