/* soapRemoteDiscoveryBindingObject.h
...
#ifndef soapRemoteDiscoveryBindingObject_H
#define soapRemoteDiscoveryBindingObject_H
#include "soapH.h"
...
class RemoteDiscoveryBindingService : public soap
{    public:
