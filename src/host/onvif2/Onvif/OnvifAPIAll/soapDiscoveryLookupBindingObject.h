/* soapDiscoveryLookupBindingObject.h
...
#ifndef soapDiscoveryLookupBindingObject_H
#define soapDiscoveryLookupBindingObject_H
#include "soapH.h"
...
class DiscoveryLookupBindingService : public soap
{    public:
