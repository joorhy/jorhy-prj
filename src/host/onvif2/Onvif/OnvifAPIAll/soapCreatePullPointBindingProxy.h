...
#include "soapH.h"
class CreatePullPointBinding
{   public:
	/// Runtime engine context allocated in constructor
	struct soap *soap;
	/// Endpoint URL of service 'CreatePullPointBinding' (change as needed)
	const char *endpoint;
	...
	{ soap = soap_new(); endpoint = "http://localhost:80"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual ~CreatePullPointBinding() { if (soap) { soap_destroy(soap); soap_end(soap); soap_free(soap); } };
	/// Invoke 'CreatePullPoint' of service 'CreatePullPointBinding' and return error code (or SOAP_OK)
	virtual int __ns16__CreatePullPoint(_ns1__CreatePullPoint *ns1__CreatePullPoint, _ns1__CreatePullPointResponse *ns1__CreatePullPointResponse) { return soap ? soap_call___ns16__CreatePullPoint(soap, endpoint, NULL, ns1__CreatePullPoint, ns1__CreatePullPointResponse) : SOAP_EOM; };
};
#endif
