...
#include "soapH.h"
class NotificationProducerBinding
{   public:
	/// Runtime engine context allocated in constructor
	struct soap *soap;
	/// Endpoint URL of service 'NotificationProducerBinding' (change as needed)
	const char *endpoint;
	...
	{ soap = soap_new(); endpoint = "http://localhost:80"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual ~NotificationProducerBinding() { if (soap) { soap_destroy(soap); soap_end(soap); soap_free(soap); } };
	/// Invoke 'Subscribe' of service 'NotificationProducerBinding' and return error code (or SOAP_OK)
	virtual int __ns13__Subscribe(_ns1__Subscribe *ns1__Subscribe, _ns1__SubscribeResponse *ns1__SubscribeResponse) { return soap ? soap_call___ns13__Subscribe(soap, endpoint, NULL, ns1__Subscribe, ns1__SubscribeResponse) : SOAP_EOM; };
	/// Invoke 'GetCurrentMessage' of service 'NotificationProducerBinding' and return error code (or SOAP_OK)
	virtual int __ns13__GetCurrentMessage(_ns1__GetCurrentMessage *ns1__GetCurrentMessage, _ns1__GetCurrentMessageResponse *ns1__GetCurrentMessageResponse) { return soap ? soap_call___ns13__GetCurrentMessage(soap, endpoint, NULL, ns1__GetCurrentMessage, ns1__GetCurrentMessageResponse) : SOAP_EOM; };
};
#endif
