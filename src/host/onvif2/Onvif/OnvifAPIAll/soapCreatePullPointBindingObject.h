/* soapCreatePullPointBindingObject.h
...
#ifndef soapCreatePullPointBindingObject_H
#define soapCreatePullPointBindingObject_H
#include "soapH.h"
...
class CreatePullPointBindingService : public soap
{    public:
