...
int CHikParser::Init(int nDataType)
{
	if (m_pDataBuff == NULL)
...
int CHikParser::InputData(const char *pData, int nLen)
{
	//WLock(m_rwLocker);
	//static FILE *fp = NULL;
	//if (fp == NULL)
...
int CHikParser::GetOnePacket(char *pData, J_StreamHeader &streamHeader)
{
	//WLock(m_rwLocker);
